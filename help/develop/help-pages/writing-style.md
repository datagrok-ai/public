...
## Using AI for documentation improvement

We suggest using ChatGPT to improve the readability of the help documentation.
To do this, just write the initial version of documentation and ask ChatGPT to improve it.

We suggest using the query similar to the following:

    Please pretend that you are a technical writer developing     
    a user documentation for software product "Datagrok":
    a new data mining, analysis, and visualization tool.
    In the following messages I'll provide you parts 
    of markdown documentation describing 
    different Datagrok capabilities.
    Rewrite it for better readability and clarity.
    Please keep it simple, avoid passive voice 
    and other complicated language constructions.
    If you have any questions, ask them first.

Please check the text generated by ChatGPT for
complicated language constructions
and explanation of obvious things.
Remove it all manually or rephrase query to ChatGPT.
