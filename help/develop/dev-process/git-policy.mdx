---
title: "Git policy"
description: Datagrok's Git workflow, branch naming, codeowners flow, release flow, and commit message rules.
keywords:
  - git flow
  - codeowners
