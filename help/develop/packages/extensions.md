...
, [how-to's](../how-to/viewers/develop-custom-viewer.md), and [exercises](../onboarding/exercises.md).
...
* [file viewers](../how-to/files/create-custom-file-viewers.md) — to support new data formats in addition to many we already recognize
...
* [info panels](../how-to/ui/add-info-panel.md), to augment data with additional information retrieved or calculated
  on-the-fly
