...
Most applications built on Datagrok start with a Datagrok's [view](../views/custom-views.md). A view is a set of visualizations
and controls grouped together. Typically, the view is associated with a particular [dataframe](#dataframes), in this
case it's called a [table view](../../../visualize/table-view-1.md). However, essentially a view can contain pretty much
anything.
...
Read more on creating custom views [here](../views/custom-views.md).
...
* Arbitrary REST APIs (including these outside host's domain) ([link](../db/access-data.md#rest-endpoints))
* Access a file from the Datagrok server space (either shared or Home) ([link](../db/access-data.md#file-shares))
* Reading from databases: Datagrok supports more than 30 connectors ([link](../../../access/databases/connectors/connectors.md))
* Access a file from a network file share (Windows Shares, SAMBA and the like) ([link](../db/access-data.md#file-shares))
...
[here](../db/access-data.md#rest-endpoints)
in detail.
...
* [Access Data](../db/access-data.md)

#### Working with databases

A comprehensive overview of programmatic database access is given [here](../db/access-data.md), we highly recommend you to go
through this text.

A short action list for accessing a database from your application:

* [Add a connection](../db/access-data.md#creating-a-connection) to the package's `connection` folder
* Prepare database [queries](../db/access-data.md#querying-data) in one or several files in package's `queries`
...
* After the package is deployed, verify you've delivered database [credentials](../db/access-data.md#creating-a-connection)
* [Invoke](../db/access-data.md#running-queries) the query in JavaScript code
...
methods [here](../data/user-settings-storage.md), also check a complete example
...
* User settings storage [reference](../data/user-settings-storage.md)
* User data
...
You could notice in ["Scripting"](../../../compute/scripting/scripting.mdx) and ["Accessing databases"](../db/access-data.md) that many
...
* [Database connection credentials](../packages/manage-credentials.md#database-connection-credentials)
...
* [Package credentials](../packages/manage-credentials.md#package-credentials)
* [Managing credentials](../packages/manage-credentials.md)
...
* [Developing Datagrok applications](build-an-app.md)
