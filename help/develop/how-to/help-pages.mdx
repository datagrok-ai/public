...
5. To run docusaurus locally with ignoring broken links errors, run the following command:
...
6. Docusaurus will be available at [http://localhost:3000](http://localhost:3000). If you don't see your changes immediately, reload the page.
7. When you think the development is over and you want to commit the code, run the following command to check that the project builds without errors. Note that the build step will take some time.
...
8. Now you can commit and push your changes to the repository.
