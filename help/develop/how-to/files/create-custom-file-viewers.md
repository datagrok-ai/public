...
special way. It should take a single argument of type `file`, return a `view`, and have at least the `fileViewer` role, and declare supported file extensions via `meta.fileViewer`.
This is it!
