...
3. Keep your local branch up to date by frequently fetching changes from the remote server. It will prevent bugs,
   ...
   more information on how to work with git, check the detailed instructions in [codeowners flow](#codeowners-flow).
...
All the procedures are performed automatically by [CI/CD tool](../admin/releases/ci-flow.mdx).
