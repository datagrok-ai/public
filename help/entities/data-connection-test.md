...
[Data connection](../entities/data-connection.md) defines a way to connect to a particular [Data Source](../entities/data-source.md)
...
1. Apply "Created by me" filter from "Filters" tab on [Toolbox](../features/toolbox.md)
   * Only connections created current user are displayed in browser, including those created in previous paragraph

1. Open *"Add new connection"* dialog from "Actions" tab tab on [Toolbox](../features/toolbox.md)
...
1. Open a list of [Projects](../entities/project.md) on [Property Panel](../features/property-panel.md)
   * Projects that include "northwind" connection are displayed

1. Delete all test [connections](../entities/data-connection.md) created in previous steps from their context menu
