...
Custom models can be configured in two ways:  
...
For examples and a detailed setup, see the [Samples package](../../packages/Samples/dockerfiles/) and the [Celery Python functions documentation](https://datagrok.ai/help/develop/how-to/packages/python-functions).
