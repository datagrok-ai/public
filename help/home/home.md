...
**Flexible.** The platform has an open architecture and component-based design. You can rapidly develop and deploy new functionality as plugins or cherry-pick and combine data transformations, statistical computations, predictive models, [packages](https://github.com/datagrok-ai/public/tree/master/packages), and custom applications into your fit-for-purpose solution. <!--link TBU. I think we need a topic describing this in greater detail -->Of course, you can also use it out-of-the-box as a self-service analytical tool or a BI application.
...
* Drag-and-drop files to open ([10+ formats](../access/importing-data.md)), or
  browse [file shares](../access/file-browser-and-file-shares.md)
...
* [Aggregate, join, filter and edit data](../transform/data-wrangling.md) in the browser
...
## Deploy, integrate, manage

* Multiple [deployment options](../develop/admin/hosting-options.md)
...
* Learning resources: [interactive help](../overview/navigation.md#help), documentation<!--create a section and link to it-->, [community forum](https://community.datagrok.ai/), and more
...
* Built-in [data provenance](../govern/data-provenance.md), data lineage, [usage analysis](../govern/usage-analysis.md), and [audit](../govern/audit.md) tools
