...
It has all the features of the [basic scripting](<../Scripting features>). In addition, it allows you to:

Enhance inputs & outputs:
- [Fold input categories](./folded-categories.mdx)
- [Add complex validations](./validating-inputs.mdx)
- [Use custom inputs](./using-custom-inputs.mdx)
- [Visualize input dataframes](./adding-input-dataframe-viewers.mdx)
- [Group outputs](./grouping-outputs.mdx)

Review historical script runs:
- [Save and access run history](./history.mdx)
- [Compare historical runs](./runs-comparison.mdx)
...
- [Export results](./exporting-to-a-file.mdx) of script results.
