...
<img src={require('../_pics/Scripting-FileIO-load.png').default} style={{'box-shadow': '#4D5261 0px 0px 5px', 'border': '1px solid #F2F2F5'}}/>
...
<img src={require('../_pics/Scripting-FileIO-connectors.png').default} style={{'box-shadow': '#4D5261 0px 0px 5px', 'border': '1px solid #F2F2F5'}}/>
