...
sidebar_position: 7
description: Share Conda and Renv environments across scripts and users for consistent, efficient dependency management.
keywords:
  - conda environment
  - renv environment
...
You can share Conda environments by referencing them in your scripts.
A shared Conda environment is re-used by many users, which is more space- and time-efficient.
...
You can specify your own package repositories in the environment specification.
