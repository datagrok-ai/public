...
<img src={require('../_pics/Scripting-Semtypes-support-UI.png').default} style={{'box-shadow': '#4D5261 0px 0px 5px', 'border': '1px solid #F2F2F5'}}/>
