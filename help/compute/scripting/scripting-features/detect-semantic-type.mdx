...
sidebar_position: 4
description: Annotate script parameters and columns with semantic types like Molecule to enable smart UI rendering.
keywords:
...
Datagrok [semantic types](../../../govern/catalog/semantic-types) are a powerful concept
that lets you define the *meaning* of your data.
...
Datagrok recognized the `Molecule` semantic type and created a custom UI displaying the molecule formula.
Click on it to open
...
The semantic type annotation has no benefit for simple scalar output,
