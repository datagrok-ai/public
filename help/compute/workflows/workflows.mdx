...
workflow. For each script the platform already has a generated UI
provided to workflows via
[RichFunctionView](../scripting/advanced-scripting/rich-function-view).


For example, passing an output of one script to another script input
is a workflow.
