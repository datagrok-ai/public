...
__TODO: ui consistency examples gifs__
...
Also an input annotation (__TODO: link to annotation doc__) should
include `optional: true`

For choice inputs (__TODO: link to doc__) it is possible to update an
items list:
