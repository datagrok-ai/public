...
The `<stepId>` refers to the id you assigned in the pipeline configuration, not
...
The walkthrough above covers a static pipeline with plain data links. For
...
| File | Demonstrates |
|------|--------------|
| [`minimal-static.ts`](https://github.com/datagrok-ai/public/blob/master/.claude/skills/create-workflow/examples/minimal-static.ts) | A static pipeline with no links — the smallest configuration that works. |
