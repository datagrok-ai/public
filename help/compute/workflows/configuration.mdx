...
The following fields are available for `PipelineConfiguration`
regardless of its [type](#type).
...
This is a full name (__TODO__ link to docs) of the corresponding
...
dynamic workflow steps state has issues.
...
`nqName` of the provider function (__TODO__ link to docs).
