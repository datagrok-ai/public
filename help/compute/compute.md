...
[machine learning](../home.md#learn), and [enterprise features](../home.md#deploy-and-integrate)
...
4. [Model life cycle](#model-life-cycle) ([create](#creating), [deploy](#deployment),
   define [environments](#environment), [version](#versioning), [share](#sharing), use, validate, update)
6. [Data access](#data-access)
7. [Metadata](#metadata) used by the [model browser](#model-browser)
8. [Integration](#integration) options: [REST API](#rest-api), [JS API](#js-api)
...
. You will see a dialog with the HTML code on top that you can use to embed this into external website. Note that you
can change parameter values right in the URL.
