...
[files](../access/file-shares.md) (either on network shares on in S3). To make a model retrieve the
input data from the data source, annotate the input parameter with the
corresponding [parameterized query](../access/databases.md#parameterized-queries). Since both queries and models are functions,
...
[creating a parameterized query](../access/databases.md#parameterized-queries), and creating a computation script. Here are the
...
consider [caching](../access/databases.md#caching-data) the results.
...
* [Result caching](../access/databases.md#caching-data) (very useful when working with data that changes overnight)
* [Visual table query builder](../access/databases.md#query-editor)
* [Visual schema query builder](../access/databases.md#join-tables)
* [DB explorer](../access/databases.md#database-manager)
