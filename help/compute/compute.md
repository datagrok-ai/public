...
4. [Model lifecycle](#model-life-cycle) ([create](#creating), [deploy](#deployment),
...
. You will see a dialog with the HTML code on top that you can use to embed this into external site. Note that you
