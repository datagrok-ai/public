...
7. [Integration](scripting/advanced-scripting/advanced-scripting.mdx#integration) options: [REST API](scripting/advanced-scripting/advanced-scripting.mdx#rest-api), 
   [JS API](scripting/advanced-scripting/advanced-scripting.mdx#js-api),
   [embedding as iframe](scripting/advanced-scripting/advanced-scripting.mdx#embedding-as-iframe)
...
The [RichFunctionView](scripting/advanced-scripting/advanced-scripting.mdx#using-richfunctionview-input-control)
...
Model scripts could specify the required [environment](scripting/advanced-scripting/advanced-scripting.mdx#environments), 
such as libraries used, their
versions, versions of the language interpreter, etc. We use
[Conda environments](scripting/advanced-scripting/advanced-scripting.mdx#conda-environments) for `Python`, and
[Renv environments](scripting/advanced-scripting/advanced-scripting.mdx#renv-environments) for `R`.
...
Sensitivity Analysis can be applied to any function with the [RichFunctionView](scripting/advanced-scripting/advanced-scripting.mdx#running-scripts-with-richfunctionview) editor. Add `meta.features: {"sens-analysis": true}` to enable it:
