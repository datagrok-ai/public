...
Sensitivity Analysis can be applied to any function with the [RichFunctionView](https://datagrok.ai/help/compute/scripting/advanced-scripting/) editor. Add `meta.features: {"sens-analysis": true}` to enable it:
