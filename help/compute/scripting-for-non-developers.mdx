...
Datagrok automatically creates a graphical user interface for your scripts. It uses [script header](../datagrok/functions/func-params-annotation.mdx) to create an input form and properly show the outputs.
You may specify different [options](../datagrok/functions/func-params-annotation.mdx#options) in header.
