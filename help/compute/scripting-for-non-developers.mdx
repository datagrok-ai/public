...
Datagrok automatically creates a graphical user interface for your scripts. It uses [script header](../datagrok/concepts/functions/func-params-annotation.md) to create an input form and properly show the outputs.
