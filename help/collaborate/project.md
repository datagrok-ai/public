...
Browse projects that are available to you. Use [Smart search](../datagrok/navigation/smart-search.md) for powerful filtering capabilities.
...
The following fields could be used to filter projects with [smart search](../datagrok/navigation/smart-search.md):
