...
| `docker/localhost.bleeding-edge-separate-data.docker-compose.yaml` | Bleeding-edge next to another stack: own project name `datagrok_dev`, `_dev` names, host ports +10 (Datagrok on 8090) |
| `docker/localhost.docker-compose-old.yaml`               | Last 1.27.x release (`1.27.9`) with the pre-1.28 config body      |
