...
is stored together with the table as its "creation script". This serves
several purposes:
...
[privilege](../../../govern/access-control/access-control.md#permissions) (**View and use** or **Full access**) to others.
...
1. Optional. Add a description. Recipients are notified in the app and by
   email, and the notification includes a link to the shared entity and the
   description. To skip notifications, clear the **Send notifications**
   checkbox.
1. Click **OK** to share.
