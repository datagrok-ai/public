...
|Info pane |Input |Required plugin  <div style={{ width:100 }}></div>|
|---|---|---|
|<h5>**Actions**</h5>Lists available actions (subject to permissions) | `table`, `column`, `row`, selection, current object|--|

### Table

|Info pane |Required plugin  <div style={{ width:100 }}></div>|
|---|---|
...
| Info pane <div style={{ width:400 }}></div> |Semantic type <div style={{ width:120 }}></div>|Required plugin |
|-----|-----------|---|
...
| Info pane <div style={{ width:500 }}></div> |Semantic type <div style={{ width:120 }}></div>|Required plugin |
|-----|-----------|---|
