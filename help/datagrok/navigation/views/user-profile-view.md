...
![](../../navigation/views/img/user-profile-view.png)
...
1. **Favorites**: Shows your favorite [objects](../../concepts/objects.md).
   [Learn how to add an object to favorites](../../navigation/basic-tasks/basic-tasks.md#add-to-favorites).
1. **Activity**: Lists user actions on the platform, with the most recent
   ...
   with, click it and explore the details in the [Context Panel](../../navigation/panels/panels.md#context-panel).
...
Panel** updates with user-specific [info panes](../../navigation/panels/info-panels.md):
