...
For saved dashboards, you can embed a view into an external site as an
iframe. Embedded views remain fully interactive and maintain the connection with
the data from which it was created inside Datagrok.
