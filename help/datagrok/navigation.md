...
of [importing data](../access/file-shares.md).
...
[File shares](../access/file-shares.md) are arguably an even more popular choice for working with data. Files
...
and, if available, [tables](../access/databases.md#working-with-queries) from the database.
