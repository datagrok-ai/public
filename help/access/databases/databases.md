...
The **DB-explorer library** enables Datagrok to automatically detect and explore company-specific identifiers within relational databases. By linking identifier patterns to database columns, this library creates an intelligent exploration system that allows users to drill down through database relationships and discover all related data with a single click.
...
3. For detailed instructions on plugin creation and publishing, see [Develop](../../develop/develop.md).
