...
<img alt="Add new database connection" src={require('./img/database-connection.gif').default} width="800px"/>
...
[Context Panel](../../datagrok/navigation/navigation.md#context-panel).
...
<img alt="DB Hierarchy Browser" src={require('./img/features/db-hierarchy-browser.gif').default} width="800px"/>
...
<img alt="Schema browser" src={require('./img/browse-schema.gif').default} width="800px"/>
...
<img alt="Create a database query" src={require('./img/query-add.gif').default} width="800px"/>
...
<img alt="Query transformations" src={require('./img/transformations.gif').default} width="800px"/>
...
language. See [Scripting](../../compute/scripting.md).
...
<img alt="Aggregation query" src={require('./img/aggr-query.gif').default} width="800px"/>
...
`strings` type only). [Additional options](../../datagrok/concepts/functions/func-params-annotation#options) are
...
<img alt="Share a database connection" src={require('./img/sharing-database-connections.gif').default} width="800px"/>
