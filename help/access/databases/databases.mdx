...
Query debugger lets you find common problems, and optimize query performance.
**To open query debugger**, right-click on the query and select "Debug", or click on the "bug" icon on
top of the query editor.
