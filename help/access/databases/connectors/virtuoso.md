...
| Type                                                     | Supported              |
|----------------------------------------------------------|------------------------|
| CHAR, VARCHAR, LONG VARCHAR, NCHAR, NVARCHAR             | :white_check_mark:     |
| NUMERIC, DECIMAL, SMALLINT, INTEGER, FLOAT, DOUBLE, REAL | :white_check_mark:     |
| DATE, TIME, TIMESTAMP, TIME, DATETIME                    | :white_check_mark:     |
| XML                                                      | limited support    (1) |
| BINARY, VARBINARY, LONG VARBINARY                        | limited support    (2) |
