...
1. Switch to list of actions categories on Toolbox

1. Choose "Enrich" actions category

1. Switch back to list of actions on Toolbox
...
1. Select *stores in @state* query. (*PostgreSQL* provider, *starbucks* connection)
   in [Context Panel](../../datagrok/navigation/panels/panels.md#context-panel)

* "transformation" tab of [Context Panel](../../datagrok/navigation/panels/panels.md#context-panel) shows the script created earlier (**)
