...
[headers](../features/scripting.md#header) get registered as Grok [functions](../entities/function.md). By annotating
...
[privileges](../features/security.md#privileges), which allows a fine-grained control over the
platform's content.  

## Applications

Applications are [functions](../entities/function.md) tagged with the `#app` tag. A package might contain zero, one, or more apps. 
