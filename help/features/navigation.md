...
**Useful Links:** [Tutorials](../help/tutorials/tutorials.md) · [Scripting Tutorials](../help/tutorials/scripting.md) · [Function Parameters](../help/tutorials/func-params-enhancement.md) · [Use Case: Navigation](../help/tutorials/platform-navigation.md)
...
**Useful Links:** [Workspace](../help/features/workspace.md) · [Navigation](../help/features/navigation.md) · [Toolbox](../help/features/toolbox.md)
#### Main Menus
...
**Useful Links:** [Navigation](../help/features/navigation.md) · [Toolbox](../help/features/toolbox.md)
...
For more information check [Toolbox](../help/features/toolbox.md). Below, you can find a review of the toolbox features.
#### Search
When data is imported, you can quickly filter and select rows using this feature of the toolbox. 
For more information, see: [Search Data](../help/features/data-search.md) · [Search Patterns](../help/features/data-search-patterns.md) · [Smart Search](../help/features/data-search-patterns.md)
#### Viewers 
...
For more info on viewers, see [Viewers](../help/viewers/viewers.md). For detailed info on each viewer, check these entries:
*   [3D Scatter Plot](../help/viewers/3d-scatter-plot.md)
*   [Bar Chart](../help/viewers/bar-chart.md)
*   [Calendar](../help/viewers/calendar.md)
*   [Filters](../help/viewers/filters.md)
*   [Histogram](../help/viewers/histogram.md)
*   [Pie Chart](../help/viewers/pie-chart.md)
*   [Statistics](../help/viewers/statistics.md)
*   [Viewers Host](../help/viewers/viewer-host.md)

<!-- Note: need to add more info in the viewer posts. -->

#### Columns
Use this feature to browse within the columns of the imported data quickly. For more information, see [Column Manager](../help/features/column-manager.md).
#### Layouts 
...
Whenever you save a view layout, you will be able to repeat the representations for the same data or a new dataset easily. You can also use this feature to browse within your saved layouts to try different views for the data in seconds. For more information, see [View Layout](../help/entities/view-layout.md).
#### Actions
...
**Useful Links:** [Cheminformatics Predictive Modeling](../help/domains/chem/chem-predictive-modeling.md) · [Use Case Predictive Modeling](../help/tutorials/predictive-modeling.md) · [Predictive Modeling Info](../help/plugins/predictive-modeling-info.md)
#### Tutorials
* [Use Case: Predictive Modelling](../help/tutorials/predictive-modeling.md)
### Algorithms
When available, this feature serves to train an algorithm on the dataset to get valuable insight or calculations done. An example is applied in the missing values imputation, for more info see [Missing Values Imputation](../help/dialogs/missing-values-imputation.md) and [Sample Script](https://public.datagrok.ai/js/samples/domains/data-science/missing-values-imputation) on the topic.
...
For more information, see [Viewers](../help/viewers/viewers.md).
#### Workspace
...
For more information, see: [Property Panel](../help/features/property-panel.md).
...
See also:
 * [Workspace](../help/features/workspace.md) 
 * [Smart Search](../help/features/smart-search.md) 
 * [Toolbox](../help/features/toolbox.md) 
