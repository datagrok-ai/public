...
> **End-to-end example:** typed arrays in `../examples/lotka-volterra-spec/code/src/lotka-volterra/core.ts` (`Float64Array` results) and `../examples/lotka-volterra-spec/code/src/lotka-volterra/workers/optimize-worker.ts`.
