...
> **End-to-end example:** function `runOptimization()` in `../examples/lotka-volterra-spec/code/src/lotka-volterra/app.ts` — worker pool with task queue, progress bar, partial error handling.
