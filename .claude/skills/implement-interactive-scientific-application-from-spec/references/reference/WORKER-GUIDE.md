...
> **End-to-end example:** optimization worker `../examples/lotka-volterra-spec/code/src/lotka-volterra/workers/optimize-worker.ts`.
> For architectural context (ports, adapters, coordinator) see `../guide.md` (sections 1.2–1.3).
