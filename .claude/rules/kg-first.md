...
Format: one tab-separated line per fact: `subject_id  PREDICATE  object_id  reason: ...`. These notes are folded into the
next enrichment cycle so subsequent agents see the new facts.
