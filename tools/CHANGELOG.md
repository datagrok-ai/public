...
* grok kg: A package.json is its package's or library's record — the author's email resolves through the people the process layer knows (a person home or the autofix roster, else the local part as the handle) and becomes the owner, a generic author (Datagrok, info@datagrok.ai) owns nothing, and a file no feature owns reaches that owner in impact, tests-for and report orphans
