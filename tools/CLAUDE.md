...
- `schema.ts` - Seal, check, diff, migrate and squash entity schema manifests (`databases/<schema>/schema.json`); the pure snapshot/diff/scaffold library is `utils/domain-snapshot.ts`
