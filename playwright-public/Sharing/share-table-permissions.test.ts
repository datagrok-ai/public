/* ---
sub_features_covered: [sharing.advanced-editor, sharing.browse-shared-with-me, sharing.context-panel-pane, sharing.entity-types.table, sharing.notification, sharing.permissions-editor, sharing.share-dialog]
--- */
