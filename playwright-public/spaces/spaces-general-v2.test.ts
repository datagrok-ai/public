...
test.describe('Content view: click, open, search, breadcrumb', () => {
  ...
  test('11. Click file in space shows info in right panel', async () => {
  ...
  test('13. Double-click file opens table view; eye icon shows preview', async () => {
  ...
  test('15. Breadcrumb navigation: multi-level back, content preserved', async () => {
    test.setTimeout(120_000);
