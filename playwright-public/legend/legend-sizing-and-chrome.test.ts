/* ---
sub_features_covered: [legend.placement.markers-no-flap, legend.sizing.whole-rows,
  legend.header.column-priority, legend.mini-icon.axis-offsets, legend.tooltip.outside-viewer,
  legend.sections.splitter-scroll]
--- */
