...
public enum EventType {
    ...
    RESULT_SET_PROCESSING_WITH_COLUMN_FILL("RESULT_SET_PROCESSING_WITH_COLUMN_FILL"),
    RESULT_SET_PROCESSING_WITHOUT_COLUMN_FILL("RESULT_SET_PROCESSING_WITHOUT_COLUMN_FILL"),
    DRY_RUN("DRY_RUN"),
    DATA_SEND("DATA_SEND"),
