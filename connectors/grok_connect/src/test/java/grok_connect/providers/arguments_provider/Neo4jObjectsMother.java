    ...
    public static Stream<Arguments> checkAllTypesSupport_ok() {
        DataFrame expected1 = DataFrameBuilder.getBuilder()
                ...
                .setColumn(new BigIntColumn(new String[]{"99999999999999", "-132442423112", "-3453463646"}),
                        "integer")
                .setColumn(new StringColumn(new String[]{"{crs=wgs-84, latitude=13.43, x=56.21, y=13.43, srid=4326, longitude=56.21}",
                "{crs=cartesian-3d, x=0.0, y=4.0, z=1.0, srid=9157}", "{crs=cartesian, x=15.0, y=6.0, srid=7203}"}), "point")
                .build();
