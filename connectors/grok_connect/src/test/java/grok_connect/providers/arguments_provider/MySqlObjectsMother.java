...
public class MySqlObjectsMother {
    ...
    public static Stream<Arguments> getSchemas_ok() {
        DataFrame expected = DataFrame.fromColumns(
                new StringColumn("table_schema", new String[] {"datagrok", "information_schema", "performance_schema"}));
    ...
    public static Stream<Arguments> checkOutputDataFrame_bitType_ok() {
        DataFrame expected = DataFrame.fromColumns(
                new StringColumn("bit_type1", new String[]{"10000000", "1"}),
                new BoolColumn("bit_type2", new Boolean[]{true, false}));
    ...
    public static Stream<Arguments> checkOutputDataFrame_dateTypes_ok() {
        DataFrame expected = DataFrame.fromColumns(
                ...
                new DateTimeColumn("time_type", new Double[]{parser.parseDateToDouble("hh:mm:ss.SSS" ,
                        "18:59:59.000000")}),
                new DateTimeColumn("timestamp_type", new Double[]{parser.parseDateToDouble("yyyy-MM-dd HH:mm:ss.SSS",
                        "1970-01-01 00:00:01.000000")}),
                new DateTimeColumn("datetime_type", new Double[]{parser.parseDateToDouble("yyyy-MM-dd HH:mm:ss.SSS",
                                "1000-01-01 00:00:00.000000")}),
                new DateTimeColumn("year_type", new Double[]{parser.parseDateToDouble("yyyy-MM-dd",
                        "2023-01-01")}));
    ...
    public static Stream<Arguments> checkOutputDataFrame_spatialTypes_ok() {
        DataFrame expected = DataFrame.fromColumns(
                new StringColumn("geometry_type", new String[]{"POLYGON((0 0,10 0,10 10,0 10,0 0),(5 5,7 5,7 7,5 7,5 5))",
                "GEOMETRYCOLLECTION(POINT(1 1),LINESTRING(0 0,1 1,2 2,3 3,4 4))"}),
                new StringColumn("point_type", new String[]{"POINT(1 1)", "POINT(1 0)"}));
    ...
    public static Stream<Arguments> checkOutputDataFrame_integerTypes_ok() {
        DataFrame expected = DataFrame.fromColumns(
                ...
                new IntColumn("smallint_type", new Integer[]{32000, 1212}),
                new IntColumn("mediumint_type", new Integer[]{167772, -1000}),
    ...
    public static Stream<Arguments> checkOutputDataFrame_floatTypes_ok() {
        DataFrame expected = DataFrame.fromColumns(
                new FloatColumn("float_type", new Float[]{-3.40282E+38f, 3.40282E+38f, -4.54654f,
                        -0.000124f}),
                new FloatColumn("double_type", new Float[]{Float.POSITIVE_INFINITY, Float.NEGATIVE_INFINITY,
                        4.457745745745457f, 0.002f}),
                new FloatColumn("decimal_type", new Float[]{999.9999f, 0.9999f, 23542363246234234234.46456456f, 0.00001f}));
    ...
    public static Stream<Arguments> checkOutputDataFrame_characterTypes_ok() {
        DataFrame expected = DataFrame.fromColumns(
                new StringColumn("char_type1", new String[]{"datagrok"}),
                new StringColumn("char_type2", new String[]{"A"}),
                new StringColumn("varchar_type", new String[]{"Hello World"}),
                new StringColumn("text_type", new String[]{"Hello Datagrok"}),
                new StringColumn("mediumtext_type", new String[]{"HelloolleH"}),
                new StringColumn("longtext_type", new String[]{"Datagrok"}));
    ...
    public static Stream<Arguments> checkOutputDataFrame_binaryTypes_ok() {
        DataFrame expected = DataFrame.fromColumns(
                new StringColumn("binary_type", new String[]{"Hello"}),
                new StringColumn("varbinary_type", new String[]{"datagrok"}));
