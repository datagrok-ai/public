...
CREATE TABLE INTEGER_TYPES(bigint_type BIGINT, int_type INT, smallint_type SMALLINT, tinyint_type TINYINT);
INSERT INTO INTEGER_TYPES(bigint_type, int_type, smallint_type, tinyint_type) VALUES (9223372036854775807, 2147483647, 32767, 127);
INSERT INTO INTEGER_TYPES(bigint_type, int_type, smallint_type, tinyint_type) VALUES (-9223372036854775808, -2147483648, -32768, -128);
INSERT INTO INTEGER_TYPES(bigint_type, int_type, smallint_type, tinyint_type) VALUES (-10, 0, -100, 1);

CREATE TABLE FLOAT_TYPES(double_type DOUBLE, float_type FLOAT, decimal_type DECIMAL(38, 20));
INSERT INTO FLOAT_TYPES(double_type, float_type, decimal_type) VALUES (-1/0, CAST(1/0 AS FLOAT), 99999.999002);
INSERT INTO FLOAT_TYPES(double_type, float_type, decimal_type) VALUES (0/0, CAST(1.40129846432481e-42 AS FLOAT), -0.000120001);

CREATE TABLE DATE_TYPES(date_type DATE, stamp_type TIMESTAMP);
