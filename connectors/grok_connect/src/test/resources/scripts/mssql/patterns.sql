...
--name: MSSQLStringTypePatternStringOpRegex
--connection: MSSQLApiTests
--input: string email = "regex ^([A-Za-z0-9_]+@google.com.au)$" {pattern: string}
--test: ApiTests:expectTable(MSSQLStringTypePatternStringOpRegex(), OpenFile('System:AppData/ApiTests/datasets/tests/MSSQL/data9.d42'))
