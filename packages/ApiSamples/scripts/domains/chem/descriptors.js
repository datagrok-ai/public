...
let table = await grok.chem.descriptors(grok.data.testData('molecules', 100), 'smiles', ['MolWt', 'Lipinski']);
grok.shell.addTableView(table);

// In 'descriptors' parameter groups or descriptors can be specified.
//
// List of available descriptors and descriptor groups:
//
// EState.EState_VSA - Hybrid EState-VSA descriptors (like the MOE VSA descriptors)
//
...
//
//
// QED - QED stands for quantitative estimation of drug-likeness
//
//   qed - Weighted sum of ADS mapped properties
//
//
// GraphDescriptors - Topological/topochemical descriptors
//
...
//
//
// MolSurf - MOE-like approximate molecular surface area descriptors
//
...
//
//
// Descriptors3D - Descriptors derived from a molecule's 3D structure
//
...
//
//
// EState.EState - Basic EState descriptors
//
...
//
//
// Fragments - Bunch of fragment descriptors from a file
//
...
//
//
// Lipinski - Lipinski parameters for molecules
//
