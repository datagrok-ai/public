...
export function trackOverview() {
  return PackageFunctions.trackOverview();
}
...
export function tutorialsInit() {
  return PackageFunctions.tutorialsInit();
}
...
export function demoApp(path?: string, filter?: string) {
  return PackageFunctions.demoApp(path, filter);
}

//name: demoAppTreeBrowser
//input: dynamic treeNode 
//input: view browseView 
export async function demoAppTreeBrowser(treeNode: any, browseView: any) {
  return PackageFunctions.demoAppTreeBrowser(treeNode, browseView);
}

//name: demoAppWidget
//output: widget result
export function demoAppWidget() {
...
export function _filesDemo() {
  return PackageFunctions._filesDemo();
}
...
export async function _databasesDemo() {
  return PackageFunctions._databasesDemo();
}
...
export async function _scatterPlotDemo() {
  return PackageFunctions._scatterPlotDemo();
}
...
export async function _histogramDemo() {
  return PackageFunctions._histogramDemo();
}
...
export async function _lineChartDemo() {
  return PackageFunctions._lineChartDemo();
}
...
export async function _barChartDemo() {
  return PackageFunctions._barChartDemo();
}
...
export async function _pieChartDemo() {
  return PackageFunctions._pieChartDemo();
}
...
export async function _trellisPlotDemo() {
  return PackageFunctions._trellisPlotDemo();
}
...
export async function _matrixPlotDemo() {
  return PackageFunctions._matrixPlotDemo();
}
...
export async function _scatterPlot3DDemo() {
  return PackageFunctions._scatterPlot3DDemo();
}
...
export async function _densityPlotDemo() {
  return PackageFunctions._densityPlotDemo();
}
...
export async function _pcPlotDemo() {
  return PackageFunctions._pcPlotDemo();
}
...
export async function _networkDiagramDemo() {
  return PackageFunctions._networkDiagramDemo();
}
...
export async function _boxPlotDemo() {
  return PackageFunctions._boxPlotDemo();
}
...
export async function _treeMapDemo() {
  return PackageFunctions._treeMapDemo();
}
...
export async function _statisticsDemo() {
  return PackageFunctions._statisticsDemo();
}
...
export async function _correlationPlotDemo() {
  return PackageFunctions._correlationPlotDemo();
}
...
export async function calendarDemo() {
  return PackageFunctions.calendarDemo();
}
...
export async function _gridDemo() {
  return PackageFunctions._gridDemo();
}
...
export async function _markupDemo() {
  return PackageFunctions._markupDemo();
}
...
export async function _tileViewerDemo() {
  return PackageFunctions._tileViewerDemo();
}
...
export async function _formDemo() {
  return PackageFunctions._formDemo();
}
...
export async function _pivotTableDemo() {
  return PackageFunctions._pivotTableDemo();
}
...
export async function _filtersDemo() {
  return PackageFunctions._filtersDemo();
}
...
export async function _tableLinkingDemo() {
  return PackageFunctions._tableLinkingDemo();
}
