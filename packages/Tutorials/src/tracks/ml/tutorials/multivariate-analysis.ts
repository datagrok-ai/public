...
export class MultivariateAnalysisTutorial extends Tutorial {
  ...
  protected async _run() {
    ...
    const dlg = await this.openDialog('From the Tools menu, choose "Data Science | Multivariate Analysis (PLS)..."',
      'Multivariate Analysis (PLS)', this.getMenuItem('Tools | Data Science'));
