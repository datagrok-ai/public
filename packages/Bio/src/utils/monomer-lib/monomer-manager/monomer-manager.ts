...
import {IMonomerManager, INewMonomerForm} from '@datagrok-libraries/bio/src/monomer-works/monomer-utils';
import {IMonomerLib, Monomer, MonomerType, PolymerType, RGroup} from '@datagrok-libraries/bio/src/types';
