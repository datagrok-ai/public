...
export async function _testSequenceSpaceReturnsResult(
  ...
  await api.funcs.sequenceSpaceTopMenu(df, df.col(colName)!, algorithm, MmDistanceFunctionsNames.LEVENSHTEIN, true, preprocessingFunc, {[BYPASS_LARGE_DATA_WARNING]: true});
