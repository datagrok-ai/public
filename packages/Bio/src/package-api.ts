...
export namespace funcs {
   ...
   * @param {string} start - Start position name (inclusive) empty means the sequence start
   * @param {string} end - End position name (inclusive) empty means the sequence end
   ...
   * @param {DG.DataFrame} table - Input data table
   * @param {string} molecules - Macromolecule sequence column
   *   semType: Macromolecule
   * @param {DG.Column} activities - Numeric activity column to look for cliffs in
   * @param {number} similarity - Similarity cutoff
   * @param {string} methodName - Dimensionality reduction method for the 2D projection
   *   choices: ["UMAP","t-SNE"]
   * @param {string} similarityMetric - Sequence distance metric
   ...
   *   semType: Macromolecule
   * @param {DG.Column} clustersCol - Optional cluster column sequences are aligned separately within each cluster
   * @param {any} options - Alignment options (engine method gap penalties selected-rows-only etc.)
   */
   ...
   * @param {DG.Column} sequenceCol
   *   semType: Macromolecule
   * @param {string} method - MAFFT alignment strategy
   *   choices: ["mafft --auto","mafft","linsi","ginsi","einsi","fftns","fftnsi","nwns","nwnsi"]
   * @param {number} gapOpen - Gap opening penalty
   * @param {number} gapExtend - Gap extension penalty
   */
   ...
   *   choices: ["fasta","separator","helm"]
   * @param {string} separator - Monomer separator for the separator notation, "." when left blank
   */
   ...
   * @param {DG.Column} sequence
   *   semType: Macromolecule
   * @param {string} motif - A monomer run, or a regular expression over the sequence
   */
   ...
   * @param {DG.Column} helmCol - Column of HELM sequences to convert
   *   semType: Macromolecule
   * @param {boolean} chiralityEngine - Preserve monomer stereochemistry using the chirality engine
   */
