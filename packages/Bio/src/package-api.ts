...
export namespace funcs {
  ...
  export async function initBio(): Promise<any> {
  ...
  export async function splitToMonomersEditor(call: any ): Promise<any> {
  ...
  export async function getRegion(sequence: DG.Column , start?: string , end?: string , name?: string ): Promise<any> {
  ...
  export async function getRegionTopMenu(table: DG.DataFrame , sequence: DG.Column , start?: string , end?: string , name?: string ): Promise<any> {
  ...
  export async function toAtomicLevel(table: DG.DataFrame , seqCol: DG.Column , nonlinear: boolean , highlight: boolean ): Promise<any> {
  ...
  export async function multipleSequenceAlignmentDialog(): Promise<any> {
    return await grok.functions.call('Bio:MultipleSequenceAlignmentDialog', {});
  }

  //Multiple sequence alignment
  export async function alignSequences(sequenceCol: DG.Column , clustersCol: DG.Column , options?: any ): Promise<any> {
  ...
  export async function subsequenceSearchTopMenu(macromolecules: DG.Column ): Promise<any> {
  ...
  export async function manageMonomerLibraries(): Promise<any> {
    return await grok.functions.call('Bio:ManageMonomerLibraries', {});
  }

  export async function manageLibrariesView(): Promise<any> {
  ...
  export async function manageLibrariesAppTreeBrowser(treeNode: any , browsePanel: any ): Promise<any> {
    return await grok.functions.call('Bio:ManageLibrariesAppTreeBrowser', { treeNode, browsePanel });
  }
  ...
  export async function detectMacromoleculeProbe(file: DG.FileInfo , colName: string , probeCount: number ): Promise<any> {
  ...
  export async function getMolFromHelm(df: DG.DataFrame , helmCol: DG.Column , chiralityEngine: boolean ): Promise<any> {
