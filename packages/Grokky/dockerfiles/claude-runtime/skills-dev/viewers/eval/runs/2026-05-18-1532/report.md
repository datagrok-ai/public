...
Started: 2026-05-18T12:32:49.170Z
Duration: 41.1s
Model: `sonnet`
...
- Total: 41.1s wall
- Mean: 6.4s · Median: 4.8s · p95: 14.3s
- Slowest 3: `change-color-column` (14.3s), `wrong-tool-trap-chem-space` (14.2s), `add-histogram-split-by-class` (14.0s)
...
|----|----------|------|---------|---------|-----------|---------|---------|
| add-scatter-height-weight | atomic-do | pass | pass | pass | pass | **PASS** | 9.5s |
| add-histogram-age | atomic-do | pass | pass | pass | pass | **PASS** | 3.8s |
| add-line-chart-date-total | atomic-do | pass | pass | pass | pass | **PASS** | 4.0s |
| add-histogram-split-by-class | atomic-do | pass | pass | pass | pass | **PASS** | 14.0s |
| add-bar-chart-count-by-category | atomic-do | pass | pass | pass | pass | **PASS** | 4.1s |
| add-box-plot-activity-by-class | atomic-do | pass | pass | pass | pass | **PASS** | 4.1s |
...
| close-all-except-grid | atomic-undo | pass | pass | pass | pass | **PASS** | 3.9s |
| remove-histogram | atomic-undo | pass | pass | pass | pass | **PASS** | 5.0s |
| close-every-chart | atomic-undo | pass | pass | pass | pass | **PASS** | 4.0s |
| scatter-mw-logp-colored-regression | combine | pass | pass | pass | pass | **PASS** | 4.8s |
| add-then-close-sequenced | combine | pass | pass | pass | pass | **PASS** | 4.3s |
| replace-scatter-with-heatmap | combine | pass | pass | pass | pass | **PASS** | 9.8s |
| wrong-tool-trap-chem-space | wrong-tool-trap | pass | pass | pass | pass | **PASS** | 14.2s |
| wrong-tool-trap-deprecated-shorthand | wrong-tool-trap | pass | pass | pass | pass | **PASS** | 5.2s |
| wrong-tool-trap-fromtype-direct | wrong-tool-trap | pass | pass | pass | pass | **PASS** | 5.2s |
| reset-to-just-grid | reset-or-cleanup | pass | pass | pass | pass | **PASS** | 4.2s |
| remove-every-chart-fresh-start | reset-or-cleanup | pass | pass | pass | pass | **PASS** | 3.6s |
| change-color-column | atomic-do | pass | pass | pass | pass | **PASS** | 14.3s |
