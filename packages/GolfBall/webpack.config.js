...
module.exports = {
  ...
  entry: {
    ...
    'optimize-worker': {filename: 'optimize-worker.js', import: './src/golf-ball/workers/optimize-worker.ts'},
    'sensitivity-worker': {filename: 'sensitivity-worker.js', import: './src/golf-ball/workers/sensitivity-worker.ts'},
  },
  resolve: {
    symlinks: false,
