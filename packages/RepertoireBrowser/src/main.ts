...
export class MolecularLiabilityBrowser {
    ...
    async init(urlVid) {
        ...
        let path =  './externalData/properties.json';//_package.webRoot + 'externalData/properties.json';
        let strt = await _package.files.readAsText(path);
        let pf = JSON.parse(strt);
    ...
    //     ////////////////////////////////////////////////////
    //     let jsonStr = JSON.parse(await _package.files.readAsText(`tpps-sons/myFile.json`));;
