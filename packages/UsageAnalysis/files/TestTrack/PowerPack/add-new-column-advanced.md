...
priority: p1
realizes_atlas: [powerpack.cp.add-new-column-persists, powerpack.int.add-new-column-datasync-roundtrip]
realizes: [powerpack.dialogs.add-new-column, file.menu.save.tables-as-project]
