...
test("DiffStudio Cyclic Models (PK-PD): Load, Multiaxis+Facet, Count clickers, tooltips", async ({
  page,
}) => {
  ...
  await softStep(
    "Step 2: Check Multiaxis and Facet tabs are updated",
    async () => {
  ...
  await softStep(
    "Step 3: Modify Count via clickers; real-time URL update",
    async () => {
