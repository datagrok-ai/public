...
priority: p2
realizes_atlas: [sequencetranslator.cp.st-cp-translator-smoke, sequencetranslator.cp.st-cp-combine-sense-antisense-flow]
realizes: [sequencetranslator.oligo-toolkit, bio.polytool.combine-sequences]
realized_as:
