...
priority: p0
realizes_atlas: [bio.op.detect_macromolecule_on_open, bio.op.convert_notation]
realizes: [bio.menu.analyze.sequence-space, bio.action.convert-notation, bio.import.fasta, bio.export.fasta]
