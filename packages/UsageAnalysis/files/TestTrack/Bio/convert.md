...
realizes: [bio.transform.convert-sequence-notation, bio.calculate.extract-region, bio.polytool.convert, bio.transform.to-atomic-level, bio.transform.split-to-monomers]
