...
res AS (
select e.id, pp.name as package, u.friendly_name as user,
...
e.event_time as time_old, u.id as uid, u.group_id as ugid, pp.package_id as pid
from events e
inner join event_parameter_values epv
inner join event_parameters ep
...
select e.id, pp.name as package, u.friendly_name as user,
       ev.event_time as time_old, u.id as uid, u.group_id as ugid, pp.package_id as pid
