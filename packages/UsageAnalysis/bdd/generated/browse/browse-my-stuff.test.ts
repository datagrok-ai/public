...
test.describe("The My stuff section of the Browse tree", () => {
  ...
  test("My stuff gathers the user's own things", {tag: ["@browse", "@realizes:views.browse"]}, async ({browser}) => {
    ...
    await session.step(22, "And My stuff tree node inside browse tree is expanded", () => isExpanded(page, el("My stuff tree node inside browse tree")));
    await session.step(25, "Then the following elements should be visible:", () => followingShouldBe(page, "visible", [["My-stuff---Recent tree node inside browse tree"],["My-stuff---Favorites tree node inside browse tree"],["My-stuff---Shared-with-me tree node inside browse tree"],["My-stuff---My-connections tree node inside browse tree"],["My-stuff---My-dashboards tree node inside browse tree"],["My-stuff---My-scripts tree node inside browse tree"],["My-stuff---My-spaces tree node inside browse tree"],["My-stuff---My-tables tree node inside browse tree"],["My-stuff---My-files tree node inside browse tree"]]));
