...
test.describe("Line chart multi-axis layout and splitting into series", () => {
  ...
  test("Line chart multi-axis layout and splitting into series", {tag: ["@journey", "@viewers", "@realizes:viewers.line-chart"]}, async ({browser}) => {
    ...
    await run.scenario("Two Y columns get a chart box each, and Multi Axis folds them into one", async () => {
      ...
      await session.step(48, "When user sets properties of line chart viewer:", () => setProperties(page, el("line chart viewer"), [["multiAxis","false"],["yColumnNames","Chemical Space X"]]));
    ...
    await run.scenario("Y Global Scale replaces the pair of scales with one that covers both columns", async () => {
      await session.step(55, "When user sets properties of line chart viewer:", () => setProperties(page, el("line chart viewer"), [["yColumnNames","Chemical Space X, TPSA"],["multiAxis","true"]]));
      ...
      await session.step(70, "When user sets properties of line chart viewer:", () => setProperties(page, el("line chart viewer"), [["multiAxis","false"],["yColumnNames","Chemical Space X"]]));
    ...
    await run.scenario("Multi Axis with two split columns keeps drawing, and a hover over it logs nothing", async () => {
      await session.step(104, "When user sets properties of line chart viewer:", () => setProperties(page, el("line chart viewer"), [["yColumnNames","Chemical Space X, TPSA"],["multiAxis","true"]]));
      ...
      await session.step(124, "When user sets properties of line chart viewer:", () => setProperties(page, el("line chart viewer"), [["splitColumnNames",""],["multiAxis","false"],["yColumnNames","Chemical Space X"]]));
    ...
    await run.scenario("An edit in the Y column list keeps the three Y columns, and its search box sits inside the list", async () => {
      await session.step(133, "When user sets properties of line chart viewer:", () => setProperties(page, el("line chart viewer"), [["yColumnNames","Chemical Space X, Chemical Space Y, TPSA"],["multiAxis","true"]]));
      ...
      await session.step(155, "When user sets properties of line chart viewer:", () => setProperties(page, el("line chart viewer"), [["multiAxis","false"],["yColumnNames","Chemical Space X"]]));
    ...
    await run.scenario("A split multiplies every Y column's series", async () => {
      await session.step(180, "When user sets properties of line chart viewer:", () => setProperties(page, el("line chart viewer"), [["yColumnNames","Chemical Space X, TPSA"],["splitColumnNames","Stereo Category"]]));
      ...
      await session.step(186, "When user sets properties of line chart viewer:", () => setProperties(page, el("line chart viewer"), [["splitColumnNames",""],["yColumnNames","Chemical Space X"]]));
