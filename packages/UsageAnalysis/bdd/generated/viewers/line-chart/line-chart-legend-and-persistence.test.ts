...
test.describe("Line chart legend, category colours and what survives a round-trip", () => {
  ...
  test("Line chart legend, category colours and what survives a round-trip", {tag: ["@journey", "@viewers", "@realizes:viewers.line-chart"]}, async ({browser}) => {
    ...
    await session.step(35, "And user colors \"Stereo Category\" column categorically:", () => colorCategorical(page, "Stereo Category", [["R_ONE","#FF0000"],["S_ABS","#00FF00"],["S_ACHIR","#0000FF"],["S_PART","#FFFF00"],["S_UNKN","#FF00FF"]]));
    await session.step(41, "And user adds a line chart viewer with:", () => addViewerWith(page, "line chart", [["xColumnName","Chemical Space X"],["yColumnNames","Chemical Space Y"],["splitColumnNames","Stereo Category"]]));
    ...
    await run.scenario("The chart configuration and the category colour come back from a saved layout (GROK-17278)", async () => {
      ...
      await session.step(103, "And user colors \"Stereo Category\" column categorically:", () => colorCategorical(page, "Stereo Category", [["R_ONE","#00AAFF"]]));
    ...
    await run.scenario("The default palette gives neighbouring split categories different colors", async () => {
      ...
      await session.step(128, "And user adds a line chart viewer with:", () => addViewerWith(page, "line chart", [["xColumnName","STARTED"],["yColumnNames","WEIGHT"],["splitColumnNames","DIS_POP"],["Legend Visibility","Always"],["Legend Position","Right"]]));
    ...
    await run.scenario("Three Y columns under Multi Axis share one scale", async () => {
      await session.step(167, "When user sets \"yColumnNames\" property of line chart viewer to \"AGE, HEIGHT, WEIGHT\"", () => setProperty(page, "yColumnNames", el("line chart viewer"), "AGE, HEIGHT, WEIGHT"));
      await session.step(168, "Then the \"y columns\" reading of line chart viewer should be \"AGE, HEIGHT, WEIGHT\"", () => readingReads(page, "y columns", el("line chart viewer"), "AGE, HEIGHT, WEIGHT"));
      await session.step(169, "And the \"charts\" reading of line chart viewer should be 1", () => readingIs(page, "charts", el("line chart viewer"), 1));
      await session.step(170, "And the \"y axes\" reading of line chart viewer should be 0", () => readingIs(page, "y axes", el("line chart viewer"), 0));
      await session.step(171, "And line chart viewer should not have a \"y2 axis\" area", () => hasNoArea(page, el("line chart viewer"), "y2 axis"));
      await session.step(172, "And the legend of line chart viewer should list 18 items", () => legendLists(page, el("line chart viewer"), 18));
      await session.step(173, "And \"AGE / RA\" legend item in legend of line chart viewer should be visible", () => shouldBe(page, el("\"AGE / RA\" legend item in legend of line chart viewer"), "visible"));
      await session.step(174, "And \"HEIGHT / RA\" legend item in legend of line chart viewer should be visible", () => shouldBe(page, el("\"HEIGHT / RA\" legend item in legend of line chart viewer"), "visible"));
      await session.step(175, "And \"WEIGHT / RA\" legend item in legend of line chart viewer should be visible", () => shouldBe(page, el("\"WEIGHT / RA\" legend item in legend of line chart viewer"), "visible"));
      await session.step(176, "When user sets \"yColumnNames\" property of line chart viewer to \"WEIGHT, HEIGHT\"", () => setProperty(page, "yColumnNames", el("line chart viewer"), "WEIGHT, HEIGHT"));
      await session.step(177, "Then the \"y axes\" reading of line chart viewer should be 2", () => readingIs(page, "y axes", el("line chart viewer"), 2));
      await session.step(178, "And line chart viewer should have a \"y2 axis\" area", () => hasArea(page, el("line chart viewer"), "y2 axis"));
      await session.step(179, "And the legend of line chart viewer should list 12 items", () => legendLists(page, el("line chart viewer"), 12));
    ...
    await run.scenario("Replacing a Y column replaces its block and leaves the other one", async () => {
      await session.step(183, "Then the \"WEIGHT / RA\" item in the legend of line chart viewer should be colored \"#9467BD\"", () => legendItemColor(page, "WEIGHT / RA", el("line chart viewer"), "#9467BD"));
      await session.step(184, "And the \"WEIGHT / AS\" item in the legend of line chart viewer should be colored \"#1F77B4\"", () => legendItemColor(page, "WEIGHT / AS", el("line chart viewer"), "#1F77B4"));
      await session.step(185, "When user sets \"yColumnNames\" property of line chart viewer to \"WEIGHT, AGE\"", () => setProperty(page, "yColumnNames", el("line chart viewer"), "WEIGHT, AGE"));
      await session.step(186, "Then the \"y columns\" reading of line chart viewer should be \"WEIGHT, AGE\"", () => readingReads(page, "y columns", el("line chart viewer"), "WEIGHT, AGE"));
      await session.step(187, "And the legend of line chart viewer should list 12 items", () => legendLists(page, el("line chart viewer"), 12));
      await session.step(188, "And the \"lines\" reading of line chart viewer should be 12", () => readingIs(page, "lines", el("line chart viewer"), 12));
      await session.step(189, "And the following elements should be visible:", () => followingShouldBe(page, "visible", [["\"WEIGHT / AS\" legend item in legend of line chart viewer"],["\"WEIGHT / Indigestion\" legend item in legend of line chart viewer"],["\"WEIGHT / PsA\" legend item in legend of line chart viewer"],["\"WEIGHT / Psoriasis\" legend item in legend of line chart viewer"],["\"WEIGHT / RA\" legend item in legend of line chart viewer"],["\"WEIGHT / UC\" legend item in legend of line chart viewer"],["\"AGE / AS\" legend item in legend of line chart viewer"],["\"AGE / Indigestion\" legend item in legend of line chart viewer"],["\"AGE / PsA\" legend item in legend of line chart viewer"],["\"AGE / Psoriasis\" legend item in legend of line chart viewer"],["\"AGE / RA\" legend item in legend of line chart viewer"],["\"AGE / UC\" legend item in legend of line chart viewer"]]));
      await session.step(202, "And \"HEIGHT / RA\" legend item in legend of line chart viewer should be absent", () => shouldBe(page, el("\"HEIGHT / RA\" legend item in legend of line chart viewer"), "absent"));
      await session.step(203, "And the \"WEIGHT / RA\" item in the legend of line chart viewer should be colored \"#9467BD\"", () => legendItemColor(page, "WEIGHT / RA", el("line chart viewer"), "#9467BD"));
      await session.step(204, "And the \"WEIGHT / AS\" item in the legend of line chart viewer should be colored \"#1F77B4\"", () => legendItemColor(page, "WEIGHT / AS", el("line chart viewer"), "#1F77B4"));
      await session.step(205, "And no errors should have been logged", () => noErrors(page));
    });
    await run.scenario("Split, Multi Axis and the Y blocks come back from a saved layout", async () => {
      await session.step(208, "When user saves the layout of the current table view to the server", () => saveLayoutToServer(page));
      await session.step(209, "And user sets properties of line chart viewer:", () => setProperties(page, el("line chart viewer"), [["multiAxis","false"],["splitColumnNames",""],["yColumnNames","WEIGHT"]]));
      await session.step(213, "Then \"multiAxis\" property of line chart viewer should be \"false\"", () => propertyShouldBe(page, "multiAxis", el("line chart viewer"), "false"));
      await session.step(214, "And the \"y columns\" reading of line chart viewer should be \"WEIGHT\"", () => readingReads(page, "y columns", el("line chart viewer"), "WEIGHT"));
      await session.step(215, "And the legend of line chart viewer should be hidden", () => shouldBe(page, el("the legend of line chart viewer"), "hidden"));
      await session.step(216, "When user loads the saved layout", () => loadLayout(page));
      await session.step(217, "Then \"multiAxis\" property of line chart viewer should be \"true\"", () => propertyShouldBe(page, "multiAxis", el("line chart viewer"), "true"));
      await session.step(218, "And the \"y columns\" reading of line chart viewer should be \"WEIGHT, AGE\"", () => readingReads(page, "y columns", el("line chart viewer"), "WEIGHT, AGE"));
      await session.step(219, "And the \"lines\" reading of line chart viewer should be 12", () => readingIs(page, "lines", el("line chart viewer"), 12));
      await session.step(220, "And the legend of line chart viewer should list 12 items", () => legendLists(page, el("line chart viewer"), 12));
      await session.step(221, "And the following elements should be visible:", () => followingShouldBe(page, "visible", [["\"WEIGHT / AS\" legend item in legend of line chart viewer"],["\"WEIGHT / Indigestion\" legend item in legend of line chart viewer"],["\"WEIGHT / PsA\" legend item in legend of line chart viewer"],["\"WEIGHT / Psoriasis\" legend item in legend of line chart viewer"],["\"WEIGHT / RA\" legend item in legend of line chart viewer"],["\"WEIGHT / UC\" legend item in legend of line chart viewer"],["\"AGE / AS\" legend item in legend of line chart viewer"],["\"AGE / Indigestion\" legend item in legend of line chart viewer"],["\"AGE / PsA\" legend item in legend of line chart viewer"],["\"AGE / Psoriasis\" legend item in legend of line chart viewer"],["\"AGE / RA\" legend item in legend of line chart viewer"],["\"AGE / UC\" legend item in legend of line chart viewer"]]));
    ...
    await run.scenario("Split, Multi Axis and the Y blocks come back from a saved project", async () => {
      await session.step(237, "When user saves the current view as project \"bdd-line-chart-legend-blocks\"", () => saveAsProject(page, "bdd-line-chart-legend-blocks"));
      await session.step(238, "And user closes all views", () => closeAllViews(page));
      await session.step(239, "And user opens the \"bdd-line-chart-legend-blocks\" project", () => openProject(page, "bdd-line-chart-legend-blocks"));
      await session.step(240, "Then line chart viewer should be added to the open tableview", () => viewerAdded(page, "line chart"));
      await session.step(241, "And \"multiAxis\" property of line chart viewer should be \"true\"", () => propertyShouldBe(page, "multiAxis", el("line chart viewer"), "true"));
      await session.step(242, "And the \"y columns\" reading of line chart viewer should be \"WEIGHT, AGE\"", () => readingReads(page, "y columns", el("line chart viewer"), "WEIGHT, AGE"));
      await session.step(243, "And the \"lines\" reading of line chart viewer should be 12", () => readingIs(page, "lines", el("line chart viewer"), 12));
      await session.step(244, "And the legend of line chart viewer should list 12 items", () => legendLists(page, el("line chart viewer"), 12));
      await session.step(245, "And the following elements should be visible:", () => followingShouldBe(page, "visible", [["\"WEIGHT / AS\" legend item in legend of line chart viewer"],["\"WEIGHT / Indigestion\" legend item in legend of line chart viewer"],["\"WEIGHT / PsA\" legend item in legend of line chart viewer"],["\"WEIGHT / Psoriasis\" legend item in legend of line chart viewer"],["\"WEIGHT / RA\" legend item in legend of line chart viewer"],["\"WEIGHT / UC\" legend item in legend of line chart viewer"],["\"AGE / AS\" legend item in legend of line chart viewer"],["\"AGE / Indigestion\" legend item in legend of line chart viewer"],["\"AGE / PsA\" legend item in legend of line chart viewer"],["\"AGE / Psoriasis\" legend item in legend of line chart viewer"],["\"AGE / RA\" legend item in legend of line chart viewer"],["\"AGE / UC\" legend item in legend of line chart viewer"]]));
      await session.step(258, "And \"HEIGHT / RA\" legend item in legend of line chart viewer should be absent", () => shouldBe(page, el("\"HEIGHT / RA\" legend item in legend of line chart viewer"), "absent"));
      await session.step(259, "And no errors should have been logged", () => noErrors(page));
    });
    run.finish();
  });
});
