...
test.describe("Molecules in the legend", () => {
  ...
  test("Molecules in the legend", {tag: ["@journey", "@viewers", "@realizes:viewers.legend"]}, async ({browser}) => {
    ...
    await session.step(26, "When user adds a scatter plot viewer with:", () => addViewerWith(page, "scatter plot", [["colorColumnName","Core"],["Legend Visibility","Always"],["Legend Position","Right"]]));
    await session.step(30, "And user adds a histogram viewer with:", () => addViewerWith(page, "histogram", [["splitColumnName","Core"],["Legend Visibility","Always"],["Legend Position","Right"]]));
    await session.step(34, "And user adds a line chart viewer with:", () => addViewerWith(page, "line chart", [["splitColumnNames","Core"],["Legend Visibility","Always"],["Legend Position","Right"]]));
    await session.step(38, "And user adds a bar chart viewer with:", () => addViewerWith(page, "bar chart", [["splitColumnName","Series"],["stackColumnName","Core"],["Legend Visibility","Always"],["Legend Position","Right"]]));
    await session.step(43, "And user adds a pie chart viewer with:", () => addViewerWith(page, "pie chart", [["categoryColumnName","Core"],["Legend Visibility","Always"],["Legend Position","Right"]]));
    await session.step(47, "And user adds a trellis plot viewer with:", () => addViewerWith(page, "trellis plot", [["xColumnNames","Core"],["Viewer Type","Scatter plot"],["Legend Visibility","Always"],["Legend Position","Right"]]));
    ...
    await session.step(53, "And user adds a box plot viewer with:", () => addViewerWith(page, "box plot", [["categoryColumnNames","Core"],["markerColorColumnName","Core"],["Legend Visibility","Always"],["Legend Position","Right"]]));
    ...
    await run.scenario("Markers on Core add structure items next to the color items of Series", async () => {
      ...
      await session.step(86, "When user sets properties of scatter plot viewer:", () => setProperties(page, el("scatter plot viewer"), [["Color","Core"],["Markers",""]]));
