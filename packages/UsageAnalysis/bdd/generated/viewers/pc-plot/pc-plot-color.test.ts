...
test.describe("PC plot colouring, legend and colour scale", () => {
  ...
  test("PC plot colouring, legend and colour scale", {tag: ["@journey", "@viewers", "@realizes:viewers.pc-plot"]}, async ({browser}) => {
    ...
    await run.scenario("Color Min and Color Max clamp the scale and recolour the lines", async () => {
      ...
      await session.step(106, "When user sets properties of pc plot viewer:", () => setProperties(page, el("pc plot viewer"), [["Color Axis Type","linear"],["Color Min",""],["Color Max",""]]), [["Color Axis Type","linear"],["Color Min",""],["Color Max",""]]);
    ...
    await run.scenario("A conditional colour coding on the column hands the plot its bins", async () => {
      ...
      await session.step(118, "When user colors \"HEIGHT\" column conditionally:", () => colorConditional(page, "HEIGHT", [["20-150","#00FF00"],["150-250","#FFA500"]]), [["20-150","#00FF00"],["150-250","#FFA500"]]);
    ...
    await run.scenario("A DateTime colour column is split by its Color Map", async () => {
      await session.step(153, "When user sets properties of pc plot viewer:", () => setProperties(page, el("pc plot viewer"), [["Color","STARTED"],["Color Map","year"]]), [["Color","STARTED"],["Color Map","year"]]);
      ...
      await session.step(167, "When user sets properties of pc plot viewer:", () => setProperties(page, el("pc plot viewer"), [["Color Map",""],["Color",""]]), [["Color Map",""],["Color",""]]);
