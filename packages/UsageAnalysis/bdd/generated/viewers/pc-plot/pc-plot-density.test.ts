...
test.describe("PC plot density overlay", () => {
  ...
  test("PC plot density overlay", {tag: ["@journey", "@viewers", "@realizes:viewers.pc-plot"]}, async ({browser}) => {
    ...
    await session.step(19, "And user adds a pc plot viewer with:", () => addViewerWith(page, "pc plot", [["Column Names","AGE, HEIGHT, WEIGHT"],["Show All Lines","false"]]), [["Column Names","AGE, HEIGHT, WEIGHT"],["Show All Lines","false"]]);
    ...
    await run.scenario("The box plot's parts each add their own ink", async () => {
      ...
      await session.step(70, "When user sets properties of pc plot viewer:", () => setProperties(page, el("pc plot viewer"), [["Show Upper Dash","true"],["Show Mean Cross","true"],["Show Median","true"],["Show Interquartile Range","true"],["Show Circles","true"]]), [["Show Upper Dash","true"],["Show Mean Cross","true"],["Show Median","true"],["Show Interquartile Range","true"],["Show Circles","true"]]);
    ...
    await run.scenario("A logarithmic AGE axis keeps the density painted", async () => {
      ...
      await session.step(115, "When user sets properties of pc plot viewer:", () => setProperties(page, el("pc plot viewer"), [["Show Density","false"],["Density Style","circles"],["Show All Lines","true"]]), [["Show Density","false"],["Density Style","circles"],["Show All Lines","true"]]);
