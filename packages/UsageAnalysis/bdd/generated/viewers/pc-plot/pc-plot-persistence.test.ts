...
test.describe("PC plot persistence and Pick Up / Apply", () => {
  ...
  test("PC plot persistence and Pick Up / Apply", {tag: ["@journey", "@viewers", "@realizes:viewers.pc-plot"]}, async ({browser}) => {
    ...
    await session.step(18, "And user adds a pc plot viewer with:", () => addViewerWith(page, "pc plot", [["Column Names","AGE, HEIGHT, WEIGHT"],["Color","RACE"],["Show Title","true"],["Title","PC Persistence Probe"]]), [["Column Names","AGE, HEIGHT, WEIGHT"],["Color","RACE"],["Show Title","true"],["Title","PC Persistence Probe"]]);
    ...
    await run.scenario("A saved layout restores the viewer set and the configuration", async () => {
      ...
      await session.step(34, "And properties of pc plot viewer should be:", () => propertiesShouldBe(page, el("pc plot viewer"), [["Column Names","AGE, HEIGHT, WEIGHT"],["Color","RACE"],["Title","PC Persistence Probe"]]), [["Column Names","AGE, HEIGHT, WEIGHT"],["Color","RACE"],["Title","PC Persistence Probe"]]);
    ...
    await run.scenario("A saved project survives Close All and a reopen", async () => {
      ...
      await session.step(49, "And properties of pc plot viewer should be:", () => propertiesShouldBe(page, el("pc plot viewer"), [["Column Names","AGE, HEIGHT, WEIGHT"],["Color","RACE"],["Title","PC Persistence Probe"]]), [["Column Names","AGE, HEIGHT, WEIGHT"],["Color","RACE"],["Title","PC Persistence Probe"]]);
    ...
    await run.scenario("Pick Up on one plot and Apply on another copies its settings, once", async () => {
      ...
      await session.step(61, "When user sets properties of first pc plot viewer:", () => setProperties(page, el("first pc plot viewer"), [["Column Names","AGE, WEIGHT, STARTED"],["Log Columns","AGE"],["Color","RACE"],["Legend Position","Left"],["Title","Source Plot"]]), [["Column Names","AGE, WEIGHT, STARTED"],["Log Columns","AGE"],["Color","RACE"],["Legend Position","Left"],["Title","Source Plot"]]);
      ...
      await session.step(72, "Then properties of second pc plot viewer should be:", () => propertiesShouldBe(page, el("second pc plot viewer"), [["Title","Source Plot"],["Color","RACE"],["Legend Position","Left"],["Log Columns","AGE"],["Column Names","AGE, WEIGHT, STARTED"]]), [["Title","Source Plot"],["Color","RACE"],["Legend Position","Left"],["Log Columns","AGE"],["Column Names","AGE, WEIGHT, STARTED"]]);
      ...
      await session.step(84, "When user sets properties of pc plot viewer:", () => setProperties(page, el("pc plot viewer"), [["Column Names","AGE, HEIGHT, WEIGHT"],["Log Columns",""],["Legend Position","Auto"],["Title",""],["Show Title","false"],["Color",""]]), [["Column Names","AGE, HEIGHT, WEIGHT"],["Log Columns",""],["Legend Position","Auto"],["Title",""],["Show Title","false"],["Color",""]]);
