...
test.describe("PC plot in-chart range filter", () => {
  ...
  test("PC plot in-chart range filter", {tag: ["@journey", "@viewers", "@realizes:viewers.pc-plot"]}, async ({browser}) => {
    ...
    await run.scenario("Dragging the AGE max handle filters the table, Reset View gives it back", async () => {
      ...
      await session.step(29, "When user drags the max handle of the \"AGE\" range slider of pc plot viewer by 120 pixels", () => dragRangeHandle(page, "max", "AGE", el("pc plot viewer"), 120));
    ...
    await run.scenario("Show Filtered Out Lines draws the rows the slider dropped", async () => {
      await session.step(44, "When user drags the max handle of the \"AGE\" range slider of pc plot viewer by 120 pixels", () => dragRangeHandle(page, "max", "AGE", el("pc plot viewer"), 120));
    ...
    await run.scenario("A filter card and the in-chart slider compose with AND", async () => {
      ...
      await session.step(64, "When user drags the max handle of the \"HEIGHT\" range slider of pc plot viewer by 120 pixels", () => dragRangeHandle(page, "max", "HEIGHT", el("pc plot viewer"), 120));
      ...
      await session.step(72, "When user drags the max handle of the \"HEIGHT\" range slider of pc plot viewer by 120 pixels", () => dragRangeHandle(page, "max", "HEIGHT", el("pc plot viewer"), 120));
    ...
    await run.scenario("A second range filter after a DateTime colour split still filters (GROK-18489)", async () => {
      ...
      await session.step(85, "And user drags the max handle of the \"AGE\" range slider of pc plot viewer by 120 pixels", () => dragRangeHandle(page, "max", "AGE", el("pc plot viewer"), 120));
      ...
      await session.step(89, "When user drags the min handle of the \"AGE\" range slider of pc plot viewer by -120 pixels", () => dragRangeHandle(page, "min", "AGE", el("pc plot viewer"), -120));
      ...
      await session.step(93, "And user drags the max handle of the \"AGE\" range slider of pc plot viewer by 100 pixels", () => dragRangeHandle(page, "max", "AGE", el("pc plot viewer"), 100));
    ...
    await run.scenario("Changing a histogram's column leaves the plot's filter alone (github-972)", async () => {
      ...
      await session.step(104, "And user drags the max handle of the \"AGE\" range slider of pc plot viewer by 120 pixels", () => dragRangeHandle(page, "max", "AGE", el("pc plot viewer"), 120));
    ...
    await run.scenario("Closing the plot releases the filter it contributed", async () => {
      await session.step(118, "When user drags the max handle of the \"AGE\" range slider of pc plot viewer by 120 pixels", () => dragRangeHandle(page, "max", "AGE", el("pc plot viewer"), 120));
