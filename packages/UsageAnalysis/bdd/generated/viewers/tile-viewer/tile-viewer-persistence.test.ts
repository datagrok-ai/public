...
test.describe("Tile viewer persistence", () => {
  ...
  test("Tile viewer persistence", {tag: ["@journey", "@viewers", "@realizes:viewers.tile-viewer"]}, async ({browser}) => {
    ...
    await session.step(23, "And user adds a tile viewer with:", () => addTileViewerWith(page, [["Lanes Column Name","RACE"],["Lanes","Black, Asian"],["Show Title","true"],["Title","Patient cards"]]), [["Lanes Column Name","RACE"],["Lanes","Black, Asian"],["Show Title","true"],["Title","Patient cards"]]);
    ...
    await run.scenario("A layout saved on the server brings the lanes and the viewer set back", async () => {
      ...
      await session.step(62, "And properties of tile viewer should be:", () => propertiesShouldBe(page, el("tile viewer"), [["Lanes Column Name","RACE"],["Lanes","Black, Asian"],["Title","Patient cards"]]), [["Lanes Column Name","RACE"],["Lanes","Black, Asian"],["Title","Patient cards"]]);
    ...
    await run.scenario("A project saved, closed and reopened brings all of it back", async () => {
      ...
      await session.step(98, "And properties of tile viewer should be:", () => propertiesShouldBe(page, el("tile viewer"), [["Lanes Column Name","RACE"],["Lanes","Black, Asian"],["Title","Patient cards"]]), [["Lanes Column Name","RACE"],["Lanes","Black, Asian"],["Title","Patient cards"]]);
