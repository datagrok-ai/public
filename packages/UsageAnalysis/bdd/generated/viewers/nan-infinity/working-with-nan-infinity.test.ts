...
test.describe("A NaN and an Infinity in the plotted columns", () => {
  ...
  test("A NaN and an Infinity in the plotted columns", {tag: ["@journey", "@viewers", "@realizes:viewers.scatter-plot"]}, async ({browser}) => {
    ...
    await session.step(13, "And user adds a scatter plot viewer with:", () => addViewerWith(page, "scatter plot", [["X","HEIGHT"],["Y","WEIGHT"],["Size","AGE"],["Color","RACE"],["Show Regression Line","true"]]), [["X","HEIGHT"],["Y","WEIGHT"],["Size","AGE"],["Color","RACE"],["Show Regression Line","true"]]);
