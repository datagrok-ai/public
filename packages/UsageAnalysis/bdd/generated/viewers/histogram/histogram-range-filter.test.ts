...
test.describe("Histogram range filter", () => {
  ...
  test("Histogram range filter", {tag: ["@journey", "@viewers", "@realizes:viewers.histogram"]}, async ({browser}) => {
    ...
    await session.step(13, "And user adds a histogram viewer with:", () => addViewerWith(page, "histogram", [["Value","AGE"],["Show Range Inputs","true"],["Filtering Enabled","true"]]), [["Value","AGE"],["Show Range Inputs","true"],["Filtering Enabled","true"]]);
    ...
    await run.scenario("A stacked split keeps the range filter", async () => {
      ...
      await session.step(51, "When user sets properties of histogram viewer:", () => setProperties(page, el("histogram viewer"), [["Split","SEX"],["Split Stack","true"]]), [["Split","SEX"],["Split Stack","true"]]);
      ...
      await session.step(59, "When user sets properties of histogram viewer:", () => setProperties(page, el("histogram viewer"), [["Split",""],["Split Stack","false"]]), [["Split",""],["Split Stack","false"]]);
