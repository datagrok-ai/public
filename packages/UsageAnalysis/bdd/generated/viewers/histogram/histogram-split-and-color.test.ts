...
test.describe("Histogram split, stacking and color coding", () => {
  ...
  test("Histogram split, stacking and color coding", {tag: ["@journey", "@viewers", "@realizes:viewers.histogram"]}, async ({browser}) => {
    ...
    await run.scenario("Color coding by a numerical column", async () => {
      ...
      await session.step(32, "When user sets properties of histogram viewer:", () => setProperties(page, el("histogram viewer"), [["Color Aggr Type","avg"],["Invert Color Scheme","true"]]), [["Color Aggr Type","avg"],["Invert Color Scheme","true"]]);
      ...
      await session.step(38, "When user sets properties of histogram viewer:", () => setProperties(page, el("histogram viewer"), [["Invert Color Scheme","false"],["Color",""]]), [["Invert Color Scheme","false"],["Color",""]]);
    ...
    await run.scenario("Split Stack brings the bars back as one segment per category", async () => {
      await session.step(79, "When user sets properties of histogram viewer:", () => setProperties(page, el("histogram viewer"), [["Split","SEX"],["Split Stack","true"]]), [["Split","SEX"],["Split Stack","true"]]);
      ...
      await session.step(90, "When user sets properties of histogram viewer:", () => setProperties(page, el("histogram viewer"), [["Show Values",""],["Split Stack","false"],["Split",""]]), [["Show Values",""],["Split Stack","false"],["Split",""]]);
    ...
    await run.scenario("Normalize Values decides what the vertical axis is scaled to", async () => {
      ...
      await session.step(99, "When user sets properties of histogram viewer:", () => setProperties(page, el("histogram viewer"), [["Split","SEX"],["Normalize Values","true"]]), [["Split","SEX"],["Normalize Values","true"]]);
      ...
      await session.step(108, "When user sets properties of histogram viewer:", () => setProperties(page, el("histogram viewer"), [["Normalize Values","true"],["Split",""]]), [["Normalize Values","true"],["Split",""]]);
    ...
    await run.scenario("Distribution lines and markers under a split", async () => {
      ...
      await session.step(123, "When user sets properties of histogram viewer:", () => setProperties(page, el("histogram viewer"), [["Spline Tension","0"],["Show Markers","true"],["Show Distribution Lines","false"],["Split",""]]), [["Spline Tension","0"],["Show Markers","true"],["Show Distribution Lines","false"],["Split",""]]);
    ...
    await run.scenario("A range narrowed under a split keeps the table filter valid", async () => {
      await session.step(132, "When user sets properties of histogram viewer:", () => setProperties(page, el("histogram viewer"), [["Split","RACE"],["Show Range Inputs","true"]]), [["Split","RACE"],["Show Range Inputs","true"]]);
      ...
      await session.step(144, "When user sets properties of histogram viewer:", () => setProperties(page, el("histogram viewer"), [["Show Range Inputs","false"],["Split",""]]), [["Show Range Inputs","false"],["Split",""]]);
