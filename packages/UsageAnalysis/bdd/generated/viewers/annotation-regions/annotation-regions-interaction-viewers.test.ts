...
/* ---
generated: features/viewers/annotation-regions/annotation-regions-interaction-viewers.feature
...
test.describe("Hovering and clicking regions on every viewer", () => {
  const session = feature(test, "features/viewers/annotation-regions/annotation-regions-interaction-viewers.feature", import.meta.url);
