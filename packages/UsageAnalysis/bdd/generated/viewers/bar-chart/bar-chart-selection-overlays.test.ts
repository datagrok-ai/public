...
test.describe("Bar chart selected and filtered rows overlays", () => {
  ...
  test("Bar chart selected and filtered rows overlays", {tag: ["@journey", "@viewers", "@realizes:viewers.bar-chart"]}, async ({browser}) => {
    ...
    await session.step(13, "And user adds a bar chart viewer with:", () => addViewerWith(page, "bar chart", [["Split","RACE"],["Value","AGE"],["Value Aggr Type","count"],["Row Source","All"],["Show Selected Rows","true"],["Show Filtered Rows","true"]]), [["Split","RACE"],["Value","AGE"],["Value Aggr Type","count"],["Row Source","All"],["Show Selected Rows","true"],["Show Filtered Rows","true"]]);
    ...
    await run.scenario("Average is not", async () => {
      ...
      await session.step(92, "When user sets properties of bar chart viewer:", () => setProperties(page, el("bar chart viewer"), [["Show Selected Rows","false"],["Show Filtered Rows","false"],["Value Aggr Type","count"]]), [["Show Selected Rows","false"],["Show Filtered Rows","false"],["Value Aggr Type","count"]]);
