...
test.describe("Scatter plot legend of a conditionally coloured column", () => {
  ...
  test("A conditionally coloured column set as Color lists one legend entry per rule", {tag: ["@viewers", "@realizes:viewers.scatter-plot"]}, async ({browser}) => {
    ...
    await session.step(13, "And user adds a scatter plot viewer with:", () => addViewerWith(page, "scatter plot", [["X","WEIGHT"],["Y","HEIGHT"]]), [["X","WEIGHT"],["Y","HEIGHT"]]);
    ...
    await session.step(19, "When user colors \"AGE\" column conditionally:", () => colorConditional(page, "AGE", [["18-45","#00FF00"],["45-89","#FF0000"]]), [["18-45","#00FF00"],["45-89","#FF0000"]]);
