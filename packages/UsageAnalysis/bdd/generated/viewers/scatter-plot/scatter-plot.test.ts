...
test.describe("Scatter plot property surface", () => {
  ...
  test("Scatter plot property surface", {tag: ["@journey", "@viewers", "@realizes:viewers.scatter-plot"]}, async ({browser}) => {
    ...
    await run.scenario("The axis histograms appear beside the plot and re-bin", async () => {
      ...
      await session.step(34, "When user sets properties of scatter plot viewer:", () => setProperties(page, el("scatter plot viewer"), [["Show X Histogram","false"],["Show Y Histogram","false"],["Histogram Bins","10"]]));
    ...
    await run.scenario("Grid lines, the axes and the on-viewer selectors can be turned off", async () => {
      ...
      await session.step(47, "When user sets properties of scatter plot viewer:", () => setProperties(page, el("scatter plot viewer"), [["Show Vertical Grid Lines","false"],["Show Horizontal Grid Lines","false"]]));
      ...
      await session.step(51, "When user sets properties of scatter plot viewer:", () => setProperties(page, el("scatter plot viewer"), [["Show X Axis","false"],["Show Y Axis","false"]]));
      ...
      await session.step(57, "When user sets properties of scatter plot viewer:", () => setProperties(page, el("scatter plot viewer"), [["Show X Selector","false"],["Show Y Selector","false"]]));
      ...
      await session.step(63, "When user sets properties of scatter plot viewer:", () => setProperties(page, el("scatter plot viewer"), [["Show X Axis","true"],["Show Y Axis","true"],["Show X Selector","true"],["Show Y Selector","true"],["Show Vertical Grid Lines","true"],["Show Horizontal Grid Lines","true"]]));
    ...
    await run.scenario("Whisker columns draw error bars around the markers", async () => {
      ...
      await session.step(78, "When user sets properties of scatter plot viewer:", () => setProperties(page, el("scatter plot viewer"), [["X Whisker Min Column","AGE"],["X Whisker Max Column","WEIGHT"],["Y Whisker Min Column","HEIGHT"],["Y Whisker Max Column","WEIGHT"]]));
      ...
      await session.step(86, "When user sets properties of scatter plot viewer:", () => setProperties(page, el("scatter plot viewer"), [["X Whisker Min Column",""],["X Whisker Max Column",""],["Y Whisker Min Column",""],["Y Whisker Max Column",""]]));
    ...
    await run.scenario("Title and description show on the viewer and go away again", async () => {
      ...
      await session.step(111, "When user sets properties of scatter plot viewer:", () => setProperties(page, el("scatter plot viewer"), [["Description","Test description"],["Description Visibility Mode","Always"]]));
      ...
      await session.step(116, "When user sets properties of scatter plot viewer:", () => setProperties(page, el("scatter plot viewer"), [["Title",""],["Description",""]]));
    ...
    await run.scenario("Lines Order draws connecting lines and Lines By defaults to the color column", async () => {
      ...
      await session.step(138, "When user sets properties of scatter plot viewer:", () => setProperties(page, el("scatter plot viewer"), [["Lines By",""],["Lines Order",""],["Color",""]]));
    ...
    await run.scenario("Data > Table rebinds the plot to another table and back, and the Filter formula narrows it", async () => {
      ...
      await session.step(160, "When user sets properties of scatter plot viewer:", () => setProperties(page, el("scatter plot viewer"), [["X","WEIGHT"],["Y","HEIGHT"]]));
