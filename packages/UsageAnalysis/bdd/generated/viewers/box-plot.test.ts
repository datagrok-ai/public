...
test.describe("Box plot property surface", () => {
  ...
  test("Box plot property surface", {tag: ["@journey", "@viewers", "@realizes:viewers.box-plot"]}, async ({browser}) => {
    ...
    await run.scenario("Context menus as property paths", async () => {
      await test.step("Then \"Show Inside Values\" of box plot viewer should be \"true\"", () => propertyShouldBe(page, "Show Inside Values", el("box plot viewer"), "true"));
      ...
      await test.step("Then \"Show Inside Values\" of box plot viewer should be \"false\"", () => propertyShouldBe(page, "Show Inside Values", el("box plot viewer"), "false"));
      ...
      await test.step("Then \"Show Outside Values\" of box plot viewer should be \"false\"", () => propertyShouldBe(page, "Show Outside Values", el("box plot viewer"), "false"));
      await test.step("And box plot viewer should have less ink than before", () => lessInk(page, el("box plot viewer")));
      await test.step("When user picks \"Misc > Show Inside Values\" from the context menu of box plot viewer", () => pickFromContextMenu(page, "Misc > Show Inside Values", el("box plot viewer")));
      ...
      await test.step("Then \"Show Inside Values\" of box plot viewer should be \"true\"", () => propertyShouldBe(page, "Show Inside Values", el("box plot viewer"), "true"));
      await test.step("And \"Show Outside Values\" of box plot viewer should be \"true\"", () => propertyShouldBe(page, "Show Outside Values", el("box plot viewer"), "true"));
      await test.step("And box plot viewer should have more ink than before", () => moreInk(page, el("box plot viewer")));
      await test.step("When user sets \"Marker Size Column\" of box plot viewer to \"WEIGHT\"", () => setProperty(page, "Marker Size Column", el("box plot viewer"), "WEIGHT"));
      ...
      await test.step("And user sets \"Marker Size Column\" of box plot viewer to \"\"", () => setProperty(page, "Marker Size Column", el("box plot viewer"), ""));
    });
    await run.scenario("Statistics and group-comparison menu regions", async () => {
      ...
      await test.step("Then \"Show Group Comparison\" of box plot viewer should be \"true\"", () => propertyShouldBe(page, "Show Group Comparison", el("box plot viewer"), "true"));
      ...
      await test.step("When user closes the context menu", () => closeContextMenu(page));
      await test.step("And user sets \"Show Group Comparison\" of box plot viewer to \"false\"", () => setProperty(page, "Show Group Comparison", el("box plot viewer"), "false"));
    });
    await run.scenario("Resize and auto layout", async () => {
      await test.step("Given user sets \"Auto Layout\" of box plot viewer to \"true\"", () => setProperty(page, "Auto Layout", el("box plot viewer"), "true"));
      ...
      await test.step("Then \"Marker Color\" column input in box plot viewer should be visible", () => shouldBe(page, el("\"Marker Color\" column input in box plot viewer"), "visible"));
      await test.step("When user sets \"Marker Color Column\" of box plot viewer to \"SEX\"", () => setProperty(page, "Marker Color Column", el("box plot viewer"), "SEX"));
      ...
      await test.step("When user sets \"Marker Color Column\" of box plot viewer to \"\"", () => setProperty(page, "Marker Color Column", el("box plot viewer"), ""));
    });
    await run.scenario("Marker gate and size scaling", async () => {
      await test.step("When user sets \"Show Markers\" of box plot viewer to \"false\"", () => setProperty(page, "Show Markers", el("box plot viewer"), "false"));
      ...
      await test.step("When user sets \"Show Markers\" of box plot viewer to \"true\"", () => setProperty(page, "Show Markers", el("box plot viewer"), "true"));
      ...
      await test.step("When user sets \"Marker Size Column\" of box plot viewer to \"WEIGHT\"", () => setProperty(page, "Marker Size Column", el("box plot viewer"), "WEIGHT"));
      await test.step("And user sets \"Marker Size Scaling\" of box plot viewer to \"logarithmic\"", () => setProperty(page, "Marker Size Scaling", el("box plot viewer"), "logarithmic"));
      await test.step("Then box plot viewer should have repainted", () => repainted(page, el("box plot viewer")));
      await test.step("When user sets \"Marker Size Scaling\" of box plot viewer to \"linear\"", () => setProperty(page, "Marker Size Scaling", el("box plot viewer"), "linear"));
      await test.step("Then box plot viewer should have repainted", () => repainted(page, el("box plot viewer")));
      await test.step("When user sets \"Marker Size Column\" of box plot viewer to \"\"", () => setProperty(page, "Marker Size Column", el("box plot viewer"), ""));
    });
    await run.scenario("Whisker and control-band style", async () => {
      await test.step("When user sets \"Whisker Line Width\" of box plot viewer to \"4\"", () => setProperty(page, "Whisker Line Width", el("box plot viewer"), "4"));
      await test.step("Then box plot viewer should have repainted", () => repainted(page, el("box plot viewer")));
      await test.step("When user sets \"Whisker Width Ratio\" of box plot viewer to \"0.3\"", () => setProperty(page, "Whisker Width Ratio", el("box plot viewer"), "0.3"));
      await test.step("Then box plot viewer should have repainted", () => repainted(page, el("box plot viewer")));
      await test.step("When user sets \"Control Band Color\" of box plot viewer to \"#00AA00\"", () => setProperty(page, "Control Band Color", el("box plot viewer"), "#00AA00"));
      await test.step("Then no errors should have been logged", () => noErrors(page));
    ...
    await run.scenario("Controls visibility", async () => {
      await test.step("Then \"Show Size Selector\" of box plot viewer should be \"false\"", () => propertyShouldBe(page, "Show Size Selector", el("box plot viewer"), "false"));
      ...
      await test.step("When user sets \"Show Size Selector\" of box plot viewer to \"true\"", () => setProperty(page, "Show Size Selector", el("box plot viewer"), "true"));
      await test.step("And user hovers over box plot viewer", () => hoverOver(page, el("box plot viewer")));
      ...
      await test.step("When user sets \"Show Value Selector\" of box plot viewer to \"false\"", () => setProperty(page, "Show Value Selector", el("box plot viewer"), "false"));
      ...
      await test.step("When user sets \"Show Color Selector\" of box plot viewer to \"false\"", () => setProperty(page, "Show Color Selector", el("box plot viewer"), "false"));
      await test.step("Then \"Marker Color\" column input in box plot viewer should be hidden", () => shouldBe(page, el("\"Marker Color\" column input in box plot viewer"), "hidden"));
      await test.step("When user sets \"Show Category Selector\" of box plot viewer to \"false\"", () => setProperty(page, "Show Category Selector", el("box plot viewer"), "false"));
      await test.step("Then box plot viewer should have repainted", () => repainted(page, el("box plot viewer")));
      await test.step("When user sets \"Show Value Axis\" of box plot viewer to \"false\"", () => setProperty(page, "Show Value Axis", el("box plot viewer"), "false"));
      await test.step("Then box plot viewer should have repainted", () => repainted(page, el("box plot viewer")));
      await test.step("When user sets \"Show Category Axis\" of box plot viewer to \"false\"", () => setProperty(page, "Show Category Axis", el("box plot viewer"), "false"));
      await test.step("Then box plot viewer should have repainted", () => repainted(page, el("box plot viewer")));
    ...
    await run.scenario("Title and description", async () => {
      ...
      await test.step("When user sets \"Description Position\" of box plot viewer to \"Bottom\"", () => setProperty(page, "Description Position", el("box plot viewer"), "Bottom"));
      ...
      await test.step("When user sets \"Description Visibility Mode\" of box plot viewer to \"Never\"", () => setProperty(page, "Description Visibility Mode", el("box plot viewer"), "Never"));
    ...
    await run.scenario("Axis font", async () => {
      await test.step("When user sets \"Axis Font\" of box plot viewer to \"normal normal 16px \\\"Roboto\\\"\"", () => setProperty(page, "Axis Font", el("box plot viewer"), "normal normal 16px \"Roboto\""));
      await test.step("Then \"Axis Font\" of box plot viewer should be \"normal normal 16px \\\"Roboto\\\"\"", () => propertyShouldBe(page, "Axis Font", el("box plot viewer"), "normal normal 16px \"Roboto\""));
      await test.step("And box plot viewer should have repainted", () => repainted(page, el("box plot viewer")));
      await test.step("When user sets \"Axis Font\" of box plot viewer to \"normal normal 10px \\\"Roboto\\\"\"", () => setProperty(page, "Axis Font", el("box plot viewer"), "normal normal 10px \"Roboto\""));
      await test.step("Then no errors should have been logged", () => noErrors(page));
    });
    await run.scenario("Date category mapping", async () => {
      await test.step("When user sets \"Category 1\" of box plot viewer to \"STARTED\"", () => setProperty(page, "Category 1", el("box plot viewer"), "STARTED"));
      await test.step("Then \"Category 1\" of box plot viewer should be \"STARTED\"", () => propertyShouldBe(page, "Category 1", el("box plot viewer"), "STARTED"));
      await test.step("When user sets \"Category 1 Map\" of box plot viewer to \"month\"", () => setProperty(page, "Category 1 Map", el("box plot viewer"), "month"));
      await test.step("Then box plot viewer should have repainted", () => repainted(page, el("box plot viewer")));
      await test.step("And \"Category 1 Map\" of box plot viewer should be \"month\"", () => propertyShouldBe(page, "Category 1 Map", el("box plot viewer"), "month"));
      await test.step("When user sets \"Category 1 Map\" of box plot viewer to \"quarter\"", () => setProperty(page, "Category 1 Map", el("box plot viewer"), "quarter"));
      await test.step("Then box plot viewer should have repainted", () => repainted(page, el("box plot viewer")));
      await test.step("When user sets \"Category 1\" of box plot viewer to \"RACE\"", () => setProperty(page, "Category 1", el("box plot viewer"), "RACE"));
      await test.step("Then \"Category 1\" of box plot viewer should be \"RACE\"", () => propertyShouldBe(page, "Category 1", el("box plot viewer"), "RACE"));
      await test.step("And no errors should have been logged", () => noErrors(page));
      await test.step("When user sets \"Category 1\" of box plot viewer to \"SEX\"", () => setProperty(page, "Category 1", el("box plot viewer"), "SEX"));
    });
    await run.scenario("Custom tooltip", async () => {
      ...
      await test.step("Then \"Row Tooltip\" of box plot viewer should be \"AGE\\nSEX\\nWEIGHT\"", () => propertyShouldBe(page, "Row Tooltip", el("box plot viewer"), "AGE\\nSEX\\nWEIGHT"));
    ...
    await run.scenario("Table switching resets Category 2", async () => {
      ...
      await test.step("When user sets \"Category 2\" of box plot viewer to \"RACE\"", () => setProperty(page, "Category 2", el("box plot viewer"), "RACE"));
      await test.step("Then \"Category 2\" of box plot viewer should be \"RACE\"", () => propertyShouldBe(page, "Category 2", el("box plot viewer"), "RACE"));
      await test.step("When user sets \"Table\" of box plot viewer to \"spgi-100\"", () => setProperty(page, "Table", el("box plot viewer"), "spgi-100"));
      await test.step("Then \"Category 2\" of box plot viewer should not be \"RACE\"", () => propertyShouldNotBe(page, "Category 2", el("box plot viewer"), "RACE"));
      await test.step("And no errors should have been logged", () => noErrors(page));
      ...
      await test.step("Then \"Table\" of box plot viewer should be \"spgi-100\"", () => propertyShouldBe(page, "Table", el("box plot viewer"), "spgi-100"));
      await test.step("And box plot viewer should be painted", () => painted(page, el("box plot viewer")));
      await test.step("When user sets \"Table\" of box plot viewer to \"demog-1000\"", () => setProperty(page, "Table", el("box plot viewer"), "demog-1000"));
      ...
      await test.step("Then \"Table\" of box plot viewer should be \"demog-1000\"", () => propertyShouldBe(page, "Table", el("box plot viewer"), "demog-1000"));
    });
    await run.scenario("Coloring keeps the render valid", async () => {
      await test.step("When user sets \"Marker Color Column\" of box plot viewer to \"RACE\"", () => setProperty(page, "Marker Color Column", el("box plot viewer"), "RACE"));
      await test.step("Then \"Marker Color Column\" of box plot viewer should be \"RACE\"", () => propertyShouldBe(page, "Marker Color Column", el("box plot viewer"), "RACE"));
      await test.step("And box plot viewer should be painted", () => painted(page, el("box plot viewer")));
      await test.step("And no errors should have been logged", () => noErrors(page));
      await test.step("When user sets \"Marker Color Column\" of box plot viewer to \"\"", () => setProperty(page, "Marker Color Column", el("box plot viewer"), ""));
    });
