...
test.describe("Word cloud text size, rotation, shape and font", () => {
  ...
  test("Word cloud text size, rotation, shape and font", {tag: ["@journey", "@viewers", "@realizes:viewers.word-cloud"]}, async ({browser}) => {
    ...
    await session.step(19, "And user adds a word cloud viewer with:", () => addViewerWith(page, "word cloud", [["wordColumnName","RACE"],["minRotationDegree","0"],["maxRotationDegree","0"]]), [["wordColumnName","RACE"],["minRotationDegree","0"],["maxRotationDegree","0"]]);
    ...
    await run.scenario("Text size spreads the boxes by count, and equal min and max flattens them", async () => {
      ...
      await session.step(31, "When user sets properties of word cloud viewer:", () => setProperties(page, el("word cloud viewer"), [["minTextSize","20"],["maxTextSize","20"]]), [["minTextSize","20"],["maxTextSize","20"]]);
      ...
      await session.step(39, "When user sets properties of word cloud viewer:", () => setProperties(page, el("word cloud viewer"), [["minTextSize","14"],["maxTextSize","100"]]), [["minTextSize","14"],["maxTextSize","100"]]);
    ...
    await run.scenario("A rotation of 90 degrees turns every box on its side", async () => {
      await session.step(47, "When user sets properties of word cloud viewer:", () => setProperties(page, el("word cloud viewer"), [["minTextSize","20"],["maxTextSize","20"]]), [["minTextSize","20"],["maxTextSize","20"]]);
      ...
      await session.step(51, "When user sets properties of word cloud viewer:", () => setProperties(page, el("word cloud viewer"), [["minRotationDegree","90"],["maxRotationDegree","90"]]), [["minRotationDegree","90"],["maxRotationDegree","90"]]);
      ...
      await session.step(58, "When user sets properties of word cloud viewer:", () => setProperties(page, el("word cloud viewer"), [["minRotationDegree","0"],["maxRotationDegree","0"],["minTextSize","14"],["maxTextSize","100"]]), [["minRotationDegree","0"],["maxRotationDegree","0"],["minTextSize","14"],["maxTextSize","100"]]);
    ...
    await run.scenario("The font reading is the font the words were drawn with, not the property", async () => {
      ...
      await session.step(95, "When user sets properties of word cloud viewer:", () => setProperties(page, el("word cloud viewer"), [["bold","true"],["fontFamily","sans-serif"]]), [["bold","true"],["fontFamily","sans-serif"]]);
