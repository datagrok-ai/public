...
test.describe("Pie chart clicks — Select and Filter", () => {
  ...
  test("Pie chart clicks — Select and Filter", {tag: ["@journey", "@viewers", "@realizes:viewers.pie-chart"]}, async ({browser}) => {
    ...
    await session.step(20, "And user adds a pie chart viewer with:", () => addViewerWith(page, "pie chart", [["Category","RACE"],["Row Source","All"]]), [["Category","RACE"],["Row Source","All"]]);
    ...
    await run.scenario("Closing the viewer releases the filter it held", async () => {
      ...
      await session.step(107, "When user adds a pie chart viewer with:", () => addViewerWith(page, "pie chart", [["Category","RACE"],["Row Source","All"],["On Click","Filter"]]), [["Category","RACE"],["Row Source","All"],["On Click","Filter"]]);
