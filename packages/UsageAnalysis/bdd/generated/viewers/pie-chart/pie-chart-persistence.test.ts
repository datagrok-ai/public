...
test.describe("Pie chart persistence", () => {
  ...
  test("Pie chart persistence", {tag: ["@journey", "@viewers", "@realizes:viewers.pie-chart"]}, async ({browser}) => {
    ...
    await run.scenario("A project saved, closed and reopened brings all of it back", async () => {
      ...
      await session.step(71, "And properties of pie chart viewer should be:", () => propertiesShouldBe(page, el("pie chart viewer"), [["Category","RACE"],["Segment Angle Aggr Type","sum"],["Show Value","true"],["Start Angle","45"],["Shift","5"],["Title","Race mix"]]), [["Category","RACE"],["Segment Angle Aggr Type","sum"],["Show Value","true"],["Start Angle","45"],["Shift","5"],["Title","Race mix"]]);
    ...
    await run.scenario("The coloring goes back where it was found", async () => {
      await session.step(86, "When user colors \"RACE\" column categorically:", () => colorCategorical(page, "RACE", [["Asian","#1F77B4"]]), [["Asian","#1F77B4"]]);
