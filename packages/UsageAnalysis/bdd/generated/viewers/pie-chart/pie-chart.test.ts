...
test.describe("Pie chart property surface", () => {
  ...
  test("Pie chart property surface", {tag: ["@journey", "@viewers", "@realizes:viewers.pie-chart"]}, async ({browser}) => {
    ...
    await session.step(20, "And user adds a pie chart viewer with:", () => addViewerWith(page, "pie chart", [["Category","RACE"]]), [["Category","RACE"]]);
    ...
    await run.scenario("With nothing left to say a wedge gets no label at all", async () => {
      ...
      await session.step(117, "When user sets properties of pie chart viewer:", () => setProperties(page, el("pie chart viewer"), [["Show Label","false"],["Show Percentage","false"]]), [["Show Label","false"],["Show Percentage","false"]]);
      ...
      await session.step(126, "When user sets properties of pie chart viewer:", () => setProperties(page, el("pie chart viewer"), [["Show Label","true"],["Show Percentage","true"],["Show Value","false"]]), [["Show Label","true"],["Show Percentage","true"],["Show Value","false"]]);
    ...
    await run.scenario("Auto Layout off hands the margins to the chart box", async () => {
      ...
      await session.step(155, "When user sets properties of pie chart viewer:", () => setProperties(page, el("pie chart viewer"), [["Auto Layout","false"],["Margin Left","100"],["Margin Top","100"]]), [["Auto Layout","false"],["Margin Left","100"],["Margin Top","100"]]);
      ...
      await session.step(162, "When user sets properties of pie chart viewer:", () => setProperties(page, el("pie chart viewer"), [["Auto Layout","true"],["Margin Left","10"],["Margin Top","10"]]), [["Auto Layout","true"],["Margin Left","10"],["Margin Top","10"]]);
    ...
    await run.scenario("The Table property rebinds the chart to another table", async () => {
      ...
      await session.step(193, "When user sets properties of pie chart viewer:", () => setProperties(page, el("pie chart viewer"), [["Table","demog-1000"],["Category","RACE"]]), [["Table","demog-1000"],["Category","RACE"]]);
    ...
    await run.scenario("Donut mode opens a hole and puts the column name in it", async () => {
      ...
      await session.step(217, "When user sets properties of pie chart viewer:", () => setProperties(page, el("pie chart viewer"), [["Show Center Label","true"],["Center Label",""],["Mode","Pie"]]), [["Show Center Label","true"],["Center Label",""],["Mode","Pie"]]);
