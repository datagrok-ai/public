...
test.describe("Forms viewer layout and project round-trips", () => {
  ...
  test("Forms viewer layout and project round-trips", {tag: ["@journey", "@viewers", "@realizes:viewers.forms"]}, async ({browser}) => {
    ...
    await session.step(17, "And user adds a forms viewer with:", () => addViewerWith(page, "forms", [["fieldsColumnNames","SEVERITY, STARTED, CONTROL, DEMOG, WEIGHT, HEIGHT, DIS_POP, RACE, SEX, AGE, USUBJID"],["sortByColumnName","AGE"],["showMouseOverRow","false"]]), [["fieldsColumnNames","SEVERITY, STARTED, CONTROL, DEMOG, WEIGHT, HEIGHT, DIS_POP, RACE, SEX, AGE, USUBJID"],["sortByColumnName","AGE"],["showMouseOverRow","false"]]);
