...
test.describe("Trellis plot tiled view and auto layout", () => {
  ...
  test("Trellis plot tiled view and auto layout", {tag: ["@journey", "@viewers", "@realizes:viewers.trellis-plot"]}, async ({browser}) => {
    ...
    await session.step(17, "And user adds a trellis plot viewer with:", () => addViewerWith(page, "trellis plot", [["X Column Names","DIS_POP"],["Y Column Names",""],["Viewer Type","Scatter plot"],["Pack Categories","false"]]), [["X Column Names","DIS_POP"],["Y Column Names",""],["Viewer Type","Scatter plot"],["Pack Categories","false"]]);
    ...
    await run.scenario("Tiles off returns a single band", async () => {
      ...
      await session.step(61, "When user sets properties of trellis plot viewer:", () => setProperties(page, el("trellis plot viewer"), [["Tiles","true"],["Tiles Per Row","4"]]), [["Tiles","true"],["Tiles Per Row","4"]]);
    ...
    await run.scenario("With auto layout off the control panel stays at any size", async () => {
      ...
      await session.step(83, "When user sets properties of trellis plot viewer:", () => setProperties(page, el("trellis plot viewer"), [["Show Control Panel","true"],["Auto Layout","true"]]), [["Show Control Panel","true"],["Auto Layout","true"]]);
    ...
    await run.scenario("The two label strips and the two selector strips drop on their own thresholds", async () => {
      await session.step(91, "When user sets properties of trellis plot viewer:", () => setProperties(page, el("trellis plot viewer"), [["X Column Names","SEX"],["Y Column Names","RACE"]]), [["X Column Names","SEX"],["Y Column Names","RACE"]]);
      ...
      await session.step(114, "When user sets properties of trellis plot viewer:", () => setProperties(page, el("trellis plot viewer"), [["X Column Names","DIS_POP"],["Y Column Names",""]]), [["X Column Names","DIS_POP"],["Y Column Names",""]]);
    ...
    await run.scenario("Title and description", async () => {
      await session.step(120, "When user sets properties of trellis plot viewer:", () => setProperties(page, el("trellis plot viewer"), [["Show Title","true"],["Title","Demographics"]]), [["Show Title","true"],["Title","Demographics"]]);
      ...
      await session.step(124, "When user sets properties of trellis plot viewer:", () => setProperties(page, el("trellis plot viewer"), [["Description","By race and sex"],["Description Visibility Mode","Always"],["Description Position","Top"]]), [["Description","By race and sex"],["Description Visibility Mode","Always"],["Description Position","Top"]]);
      ...
      await session.step(139, "When user sets properties of trellis plot viewer:", () => setProperties(page, el("trellis plot viewer"), [["Title",""],["Description",""],["Description Visibility Mode","Auto"],["Description Position","Top"]]), [["Title",""],["Description",""],["Description Visibility Mode","Auto"],["Description Position","Top"]]);
    ...
    await run.scenario("The full screen icon lives in the cell the pointer is in", async () => {
      await session.step(147, "When user sets properties of trellis plot viewer:", () => setProperties(page, el("trellis plot viewer"), [["X Column Names","SEX"],["Y Column Names","RACE"]]), [["X Column Names","SEX"],["Y Column Names","RACE"]]);
