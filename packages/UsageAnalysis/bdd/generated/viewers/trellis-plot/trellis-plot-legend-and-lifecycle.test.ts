...
test.describe("Trellis plot legend and lifecycle", () => {
  ...
  test("Trellis plot legend and lifecycle", {tag: ["@journey", "@viewers", "@realizes:viewers.trellis-plot"]}, async ({browser}) => {
    ...
    await session.step(24, "And user adds a trellis plot viewer with:", () => addViewerWith(page, "trellis plot", [["X Column Names","SEX"],["Y Column Names","RACE"],["Viewer Type","Scatter plot"]]), [["X Column Names","SEX"],["Y Column Names","RACE"],["Viewer Type","Scatter plot"]]);
    ...
    await run.scenario("The legend takes each of the four slots", async () => {
      ...
      await session.step(53, "When user sets properties of trellis plot viewer:", () => setProperties(page, el("trellis plot viewer"), [["Legend Visibility","Always"],["Legend Position","Auto"]]), [["Legend Visibility","Always"],["Legend Position","Auto"]]);
    ...
    await run.scenario("A layout round-trip through the server restores the split and the type", async () => {
      await session.step(116, "When user sets properties of trellis plot viewer:", () => setProperties(page, el("trellis plot viewer"), [["X Column Names","RACE"],["Y Column Names","SEX"],["Viewer Type","Bar chart"]]), [["X Column Names","RACE"],["Y Column Names","SEX"],["Viewer Type","Bar chart"]]);
      ...
      await session.step(126, "And properties of trellis plot viewer should be:", () => propertiesShouldBe(page, el("trellis plot viewer"), [["X Column Names","RACE"],["Y Column Names","SEX"],["Viewer Type","Bar chart"]]), [["X Column Names","RACE"],["Y Column Names","SEX"],["Viewer Type","Bar chart"]]);
    ...
    await run.scenario("A project round-trip restores the split, the type and the row source", async () => {
      await session.step(135, "When user sets properties of trellis plot viewer:", () => setProperties(page, el("trellis plot viewer"), [["X Column Names","SEX"],["Y Column Names","RACE"],["Viewer Type","Scatter plot"],["Row Source","All"]]), [["X Column Names","SEX"],["Y Column Names","RACE"],["Viewer Type","Scatter plot"],["Row Source","All"]]);
      ...
      await session.step(145, "And properties of trellis plot viewer should be:", () => propertiesShouldBe(page, el("trellis plot viewer"), [["X Column Names","SEX"],["Y Column Names","RACE"],["Viewer Type","Scatter plot"],["Row Source","All"]]), [["X Column Names","SEX"],["Y Column Names","RACE"],["Viewer Type","Scatter plot"],["Row Source","All"]]);
