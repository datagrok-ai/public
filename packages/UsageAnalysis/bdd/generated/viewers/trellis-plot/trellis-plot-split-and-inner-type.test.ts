...
test.describe("Trellis plot split columns and the inner viewer", () => {
  ...
  test("Trellis plot split columns and the inner viewer", {tag: ["@journey", "@viewers", "@realizes:viewers.trellis-plot"]}, async ({browser}) => {
    ...
    await run.scenario("A no-data excursion leaves no stale frame", async () => {
      ...
      await session.step(127, "When user sets properties of trellis plot viewer:", () => setProperties(page, el("trellis plot viewer"), [["Y Column Names",""],["Viewer Type","Bar chart"]]), [["Y Column Names",""],["Viewer Type","Bar chart"]]);
      ...
      await session.step(131, "When user sets properties of trellis plot viewer:", () => setProperties(page, el("trellis plot viewer"), [["Y Column Names","RACE"],["Viewer Type","Pie chart"]]), [["Y Column Names","RACE"],["Viewer Type","Pie chart"]]);
    ...
    await run.scenario("Gridlines follow the mode and the inner type", async () => {
      ...
      await session.step(158, "When user sets properties of trellis plot viewer:", () => setProperties(page, el("trellis plot viewer"), [["Show Gridlines","auto"],["Viewer Type","Scatter plot"]]), [["Show Gridlines","auto"],["Viewer Type","Scatter plot"]]);
      ...
      await session.step(164, "When user sets properties of trellis plot viewer:", () => setProperties(page, el("trellis plot viewer"), [["Viewer Type","Scatter plot"],["Show Gridlines","always"]]), [["Viewer Type","Scatter plot"],["Show Gridlines","always"]]);
