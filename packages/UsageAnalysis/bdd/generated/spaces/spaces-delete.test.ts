...
test.describe("Deleting a space", () => {
  ...
  test("Deleting a space", {tag: ["@journey", "@spaces", "@realizes:views.space"]}, async ({browser}) => {
    ...
    await run.scenario("Deleting asks first", async () => {
      await session.step(15, "When user picks \"Create Space...\" from the context menu of Spaces tree node", () => pickFromContextMenu(page, "Create Space...", el("Spaces tree node")));
      ...
      await session.step(19, "When user picks \"Delete Space\" from the context menu of BDD-Del tree node", () => pickFromContextMenu(page, "Delete Space", el("BDD-Del tree node")));
    ...
    await run.scenario("Cancelling the confirmation keeps the space", async () => {
      ...
      await session.step(25, "Then \"Are you sure?\" dialog should be hidden", () => shouldBe(page, el("\"Are you sure?\" dialog"), "hidden"));
      await session.step(26, "And 1 space named \"BDD-Del\" should be on the server", () => spacesOnServer(page, 1, "BDD-Del"));
      await session.step(27, "And BDD-Del tree node should be visible", () => shouldBe(page, el("BDD-Del tree node"), "visible"));
    });
    await run.scenario("Confirming removes it from the server and the tree", async () => {
      await session.step(30, "When user picks \"Delete Space\" from the context menu of BDD-Del tree node", () => pickFromContextMenu(page, "Delete Space", el("BDD-Del tree node")));
      ...
      await session.step(32, "Then \"Are you sure?\" dialog should be hidden", () => shouldBe(page, el("\"Are you sure?\" dialog"), "hidden"));
      await session.step(33, "And 0 spaces named \"BDD-Del\" should be on the server", () => spacesOnServer(page, 0, "BDD-Del"));
      await session.step(34, "And BDD-Del tree node should be absent", () => shouldBe(page, el("BDD-Del tree node"), "absent"));
    });
    await run.scenario("Deleting one child leaves its sibling", async () => {
      await session.step(37, "When user picks \"Create Space...\" from the context menu of Spaces tree node", () => pickFromContextMenu(page, "Create Space...", el("Spaces tree node")));
      ...
      await session.step(41, "When user picks \"Create Child Space...\" from the context menu of BDD-Del-Parent tree node", () => pickFromContextMenu(page, "Create Child Space...", el("BDD-Del-Parent tree node")));
      ...
      await session.step(44, "Then BDD-Del-Child1 tree node should be visible", () => shouldBe(page, el("BDD-Del-Child1 tree node"), "visible"));
      await session.step(45, "When user picks \"Create Child Space...\" from the context menu of BDD-Del-Parent tree node", () => pickFromContextMenu(page, "Create Child Space...", el("BDD-Del-Parent tree node")));
      ...
      await session.step(48, "Then BDD-Del-Child2 tree node should be visible", () => shouldBe(page, el("BDD-Del-Child2 tree node"), "visible"));
      await session.step(49, "When user picks \"Delete Space\" from the context menu of BDD-Del-Child1 tree node", () => pickFromContextMenu(page, "Delete Space", el("BDD-Del-Child1 tree node")));
      ...
      await session.step(51, "Then BDD-Del-Child1 tree node should be absent", () => shouldBe(page, el("BDD-Del-Child1 tree node"), "absent"));
      await session.step(52, "And BDD-Del-Child2 tree node should be visible", () => shouldBe(page, el("BDD-Del-Child2 tree node"), "visible"));
    });
    await run.scenario("Deleting the parent takes the remaining child with it", async () => {
      await session.step(55, "When user picks \"Delete Space\" from the context menu of BDD-Del-Parent tree node", () => pickFromContextMenu(page, "Delete Space", el("BDD-Del-Parent tree node")));
      ...
      await session.step(58, "And BDD-Del-Parent tree node should be absent", () => shouldBe(page, el("BDD-Del-Parent tree node"), "absent"));
      await session.step(59, "And BDD-Del-Child2 tree node should be absent", () => shouldBe(page, el("BDD-Del-Child2 tree node"), "absent"));
    });
    run.finish();
  });
});
