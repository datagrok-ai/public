...
test.describe("Deleting a space", () => {
  ...
  test("Deleting a space", {tag: ["@journey", "@spaces", "@realizes:views.space"]}, async ({browser}) => {
    ...
    await run.scenario("Cancelling the confirmation keeps the space", async () => {
      ...
      await session.step(27, "And BDD-Del tree node inside browse tree should be visible", () => shouldBe(page, el("BDD-Del tree node inside browse tree"), "visible"));
    });
    await run.scenario("Confirming removes it from the server and the tree", async () => {
      ...
      await session.step(34, "And BDD-Del tree node inside browse tree should be absent", () => shouldBe(page, el("BDD-Del tree node inside browse tree"), "absent"));
    });
    await run.scenario("Deleting one child leaves its sibling", async () => {
      ...
      await session.step(44, "Then BDD-Del-Child1 tree node inside browse tree should be visible", () => shouldBe(page, el("BDD-Del-Child1 tree node inside browse tree"), "visible"));
      ...
      await session.step(48, "Then BDD-Del-Child2 tree node inside browse tree should be visible", () => shouldBe(page, el("BDD-Del-Child2 tree node inside browse tree"), "visible"));
      ...
      await session.step(51, "Then BDD-Del-Child1 tree node inside browse tree should be absent", () => shouldBe(page, el("BDD-Del-Child1 tree node inside browse tree"), "absent"));
      await session.step(52, "And BDD-Del-Child2 tree node inside browse tree should be visible", () => shouldBe(page, el("BDD-Del-Child2 tree node inside browse tree"), "visible"));
    });
    await run.scenario("Deleting the parent takes the remaining child with it", async () => {
      ...
      await session.step(58, "And BDD-Del-Parent tree node inside browse tree should be absent", () => shouldBe(page, el("BDD-Del-Parent tree node inside browse tree"), "absent"));
      await session.step(59, "And BDD-Del-Child2 tree node inside browse tree should be absent", () => shouldBe(page, el("BDD-Del-Child2 tree node inside browse tree"), "absent"));
    });
    run.finish();
  });
});
