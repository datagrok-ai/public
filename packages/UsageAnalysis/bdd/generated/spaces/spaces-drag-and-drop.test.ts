...
test.describe("Putting files into a space by dragging them", () => {
  ...
  test("Putting files into a space by dragging them", {tag: ["@journey", "@spaces", "@realizes:views.space"]}, async ({browser}) => {
    ...
    await run.scenario("Two spaces and the demo files", async () => {
      ...
      await session.step(33, "Given Files tree node inside browse tree is expanded", () => isExpanded(page, el("Files tree node inside browse tree")));
      await session.step(34, "When user clicks on \"Files > Demo\" tree node inside browse tree", () => clickOn(page, el("\"Files > Demo\" tree node inside browse tree")));
    ...
    await run.scenario("The dialog offers Link, Copy and Move, and names the target", async () => {
      await session.step(39, "When user drags demog.csv link in gallery to BDD-DnD tree node inside browse tree", () => dragTo(page, el("demog.csv link in gallery"), el("BDD-DnD tree node inside browse tree")));
    ...
    await run.scenario("Cancelling leaves the space empty", async () => {
      ...
      await session.step(47, "When user double-clicks on BDD-DnD tree node inside browse tree", () => doubleClickOn(page, el("BDD-DnD tree node inside browse tree")));
    ...
    await run.scenario("A copied file lands in the space", async () => {
      ...
      await session.step(53, "And user drags demog.csv link in gallery to BDD-DnD tree node inside browse tree", () => dragTo(page, el("demog.csv link in gallery"), el("BDD-DnD tree node inside browse tree")));
      ...
      await session.step(57, "When user double-clicks on BDD-DnD tree node inside browse tree", () => doubleClickOn(page, el("BDD-DnD tree node inside browse tree")));
    ...
    await run.scenario("A second file joins the first", async () => {
      ...
      await session.step(68, "And user drags TSLA.csv link in gallery to BDD-DnD tree node inside browse tree", () => dragTo(page, el("TSLA.csv link in gallery"), el("BDD-DnD tree node inside browse tree")));
      ...
      await session.step(72, "When user double-clicks on BDD-DnD tree node inside browse tree", () => doubleClickOn(page, el("BDD-DnD tree node inside browse tree")));
    ...
    await run.scenario("A copy is made in the source space to move later", async () => {
      await session.step(77, "When user clicks on \"Files > Demo\" tree node inside browse tree", () => clickOn(page, el("\"Files > Demo\" tree node inside browse tree")));
      await session.step(78, "And user drags beer.csv link in gallery to BDD-DnD-Src tree node inside browse tree", () => dragTo(page, el("beer.csv link in gallery"), el("BDD-DnD-Src tree node inside browse tree")));
      ...
      await session.step(82, "When user double-clicks on BDD-DnD-Src tree node inside browse tree", () => doubleClickOn(page, el("BDD-DnD-Src tree node inside browse tree")));
    ...
    await run.scenario("Moving takes the file out of the source space", async () => {
      await session.step(87, "When user drags beer.csv link in gallery to BDD-DnD tree node inside browse tree", () => dragTo(page, el("beer.csv link in gallery"), el("BDD-DnD tree node inside browse tree")));
      ...
      await session.step(93, "When user double-clicks on BDD-DnD tree node inside browse tree", () => doubleClickOn(page, el("BDD-DnD tree node inside browse tree")));
      ...
      await session.step(96, "When user double-clicks on BDD-DnD-Src tree node inside browse tree", () => doubleClickOn(page, el("BDD-DnD-Src tree node inside browse tree")));
    ...
    await run.scenario("The demo files kept their originals", async () => {
      await session.step(101, "When user clicks on \"Files > Demo\" tree node inside browse tree", () => clickOn(page, el("\"Files > Demo\" tree node inside browse tree")));
