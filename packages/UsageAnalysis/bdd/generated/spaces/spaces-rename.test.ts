...
test.describe("Renaming a space", () => {
  ...
  test("Renaming a space", {tag: ["@journey", "@spaces", "@realizes:views.space"]}, async ({browser}) => {
    ...
    await run.scenario("The Rename dialog opens on the current name", async () => {
      ...
      await session.step(24, "When user picks \"Rename...\" from the context menu of BDD-Ren tree node", () => pickFromContextMenu(page, "Rename...", el("BDD-Ren tree node")));
    ...
    await run.scenario("Cancelling the rename keeps the old name", async () => {
      ...
      await session.step(34, "And BDD-Ren tree node should be visible", () => shouldBe(page, el("BDD-Ren tree node"), "visible"));
    });
    await run.scenario("A rename reaches the server and the tree", async () => {
      await session.step(37, "When user picks \"Rename...\" from the context menu of BDD-Ren tree node", () => pickFromContextMenu(page, "Rename...", el("BDD-Ren tree node")));
      ...
      await session.step(43, "And BDD-Ren-New tree node should be visible", () => shouldBe(page, el("BDD-Ren-New tree node"), "visible"));
      await session.step(44, "And BDD-Ren tree node should be absent", () => shouldBe(page, el("BDD-Ren tree node"), "absent"));
    });
    await run.scenario("Renaming onto an existing name is refused", async () => {
      await session.step(47, "When user picks \"Create Space...\" from the context menu of Spaces tree node", () => pickFromContextMenu(page, "Create Space...", el("Spaces tree node")));
      ...
      await session.step(51, "When user picks \"Rename...\" from the context menu of BDD-Ren-New tree node", () => pickFromContextMenu(page, "Rename...", el("BDD-Ren-New tree node")));
    ...
    await run.scenario("A child space is renamed from its card in the parent", async () => {
      await session.step(61, "When user picks \"Create Space...\" from the context menu of Spaces tree node", () => pickFromContextMenu(page, "Create Space...", el("Spaces tree node")));
      ...
      await session.step(65, "When user picks \"Create Child Space...\" from the context menu of BDD-Ren-Parent tree node", () => pickFromContextMenu(page, "Create Child Space...", el("BDD-Ren-Parent tree node")));
      ...
      await session.step(68, "Then BDD-Ren-Child tree node should be visible", () => shouldBe(page, el("BDD-Ren-Child tree node"), "visible"));
      await session.step(69, "When user double-clicks on BDD-Ren-Parent tree node", () => doubleClickOn(page, el("BDD-Ren-Parent tree node")));
      ...
      await session.step(77, "When user expands BDD-Ren-Parent tree node", () => expand(page, el("BDD-Ren-Parent tree node")));
      await session.step(78, "Then BDD-Ren-ChildNew tree node should be visible", () => shouldBe(page, el("BDD-Ren-ChildNew tree node"), "visible"));
      await session.step(79, "And BDD-Ren-Child tree node should be absent", () => shouldBe(page, el("BDD-Ren-Child tree node"), "absent"));
    });
    run.finish();
  });
});
