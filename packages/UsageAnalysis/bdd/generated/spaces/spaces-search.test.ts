...
test.describe("Searching spaces", () => {
  ...
  test("Searching spaces", {tag: ["@journey", "@spaces", "@realizes:views.space"]}, async ({browser}) => {
    ...
    await run.scenario("A whole name keeps only that space", async () => {
      await session.step(32, "When user enters \"BDD-Find\" into space search", () => enterInto(page, "BDD-Find", el("space search")));
      await session.step(33, "Then BDD-Find link in space gallery should be visible", () => shouldBe(page, el("BDD-Find link in space gallery"), "visible"));
      await session.step(34, "And BDD-Miss link in space gallery should be absent", () => shouldBe(page, el("BDD-Miss link in space gallery"), "absent"));
    });
    await run.scenario("Part of a name still matches", async () => {
      await session.step(37, "When user enters \"BDD-Fi\" into space search", () => enterInto(page, "BDD-Fi", el("space search")));
      await session.step(38, "Then BDD-Find link in space gallery should be visible", () => shouldBe(page, el("BDD-Find link in space gallery"), "visible"));
      await session.step(39, "And BDD-Miss link in space gallery should be absent", () => shouldBe(page, el("BDD-Miss link in space gallery"), "absent"));
    });
    await run.scenario("A name nothing carries empties the list", async () => {
      await session.step(42, "When user enters \"zzz-no-such-space\" into space search", () => enterInto(page, "zzz-no-such-space", el("space search")));
      await session.step(43, "Then BDD-Find link in space gallery should be absent", () => shouldBe(page, el("BDD-Find link in space gallery"), "absent"));
      await session.step(44, "And BDD-Miss link in space gallery should be absent", () => shouldBe(page, el("BDD-Miss link in space gallery"), "absent"));
    });
    await run.scenario("Clearing the search brings both back", async () => {
      await session.step(47, "When user clears space search", () => clearField(page, el("space search")));
      await session.step(48, "Then BDD-Find link in space gallery should be visible", () => shouldBe(page, el("BDD-Find link in space gallery"), "visible"));
    ...
    await run.scenario("A child space is searchable inside its parent", async () => {
      ...
      await session.step(60, "When user clears space search", () => clearField(page, el("space search")));
      await session.step(61, "Then BDD-Find-Child link in space gallery should be visible", () => shouldBe(page, el("BDD-Find-Child link in space gallery"), "visible"));
    });
    run.finish();
  });
});
