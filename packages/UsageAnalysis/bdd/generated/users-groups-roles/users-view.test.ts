...
test.describe("The Users view", () => {
  ...
  test("The Users view", {tag: ["@journey", "@users", "@realizes:views.users"]}, async ({browser}) => {
    ...
    await run.scenario("Selecting a user fills the context panel (Users-17)", async () => {
      ...
      await session.step(171, "And the following elements should be visible:", () => followingShouldBe(page, "visible", [["\"Personal\" accordion header in context panel"],["\"Roles\" accordion header in context panel"],["\"Member of\" accordion header in context panel"]]));
      await session.step(175, "And the following elements should be present:", () => followingShouldBe(page, "present", [["\"Projects\" accordion header in context panel"],["\"Activity\" accordion header in context panel"],["\"Chats\" accordion header in context panel"],["\"Privileges\" accordion header in context panel"]]));
