...
test.describe("The Roles view", () => {
  ...
  test("The Roles view", {tag: ["@journey", "@serial", "@roles", "@realizes:views.roles"]}, async ({browser}) => {
    ...
    await run.scenario("The toolbar carries its controls (Roles-02)", async () => {
      await session.step(48, "Then the following elements should be visible:", () => followingShouldBe(page, "visible", [["\"New Role...\" button"],["gallery search"],["\"Switch to brief view\" icon inside gallery toolbar"],["\"Switch to card view\" icon inside gallery toolbar"],["\"Switch to grid view\" icon inside gallery toolbar"],["\"Refresh\" icon inside gallery toolbar"]]), [["\"New Role...\" button"],["gallery search"],["\"Switch to brief view\" icon inside gallery toolbar"],["\"Switch to card view\" icon inside gallery toolbar"],["\"Switch to grid view\" icon inside gallery toolbar"],["\"Refresh\" icon inside gallery toolbar"]]);
