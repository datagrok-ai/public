...
Feature: Deleting a space
  ...
  Scenario: Deleting asks first
    ...
    When user picks "Delete Space" from the context menu of BDD-Del tree node
  ...
  Scenario: Cancelling the confirmation keeps the space
    ...
    And BDD-Del tree node should be visible
  ...
  Scenario: Confirming removes it from the server and the tree
    ...
    And BDD-Del tree node should be absent
  ...
  Scenario: Deleting one child leaves its sibling
    ...
    When user picks "Create Child Space..." from the context menu of BDD-Del-Parent tree node
    And user enters "BDD-Del-Child1" into Name input in Create Space dialog
    And user clicks on OK button in Create Space dialog
    Then BDD-Del-Child1 tree node should be visible
    When user picks "Create Child Space..." from the context menu of BDD-Del-Parent tree node
    And user enters "BDD-Del-Child2" into Name input in Create Space dialog
    And user clicks on OK button in Create Space dialog
    Then BDD-Del-Child2 tree node should be visible
    When user picks "Delete Space" from the context menu of BDD-Del-Child1 tree node
    And user clicks on DELETE button in "Are you sure?" dialog
    Then BDD-Del-Child1 tree node should be absent
    And BDD-Del-Child2 tree node should be visible

  Scenario: Deleting the parent takes the remaining child with it
    When user picks "Delete Space" from the context menu of BDD-Del-Parent tree node
    And user clicks on DELETE button in "Are you sure?" dialog
    Then 0 spaces named "BDD-Del-Parent" should be on the server
    And BDD-Del-Parent tree node should be absent
    And BDD-Del-Child2 tree node should be absent
