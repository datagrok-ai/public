...
| Sketcher Input | `string` | as String Input, pre-tagged `semType: Molecule` |
| Helm Input | `string` | as String Input, pre-tagged `semType: Macromolecule` |
