 ...
 * `/apps/<Package>/<App>`. */
export const APP_PATH = '/apps/diff-studio';
...
export const openApp = Given('user opens the Diff Studio app', async (page: Page) => {
  ...
  await page.locator('[data-u2-name="Diff Studio"]').waitFor({timeout: 60000});
}, {tier: 'ui', enters: 'Diff Studio app', description: 'needs this package published on the stand'});
