...
//input: int order = 3 {caption: Order Of Polynomial Regression} [Order Of Polynomial Regression]
...
function gaussianElimination(input, order) {
  ...
  const coefficients1 = polynomialRegressionCoefficients(df1.col(colNames1['tp1']), df1.col(colNames1['res1']), order);    
  const coefficients2 = polynomialRegressionCoefficients(df1.col(colNames1['tp2']), df1.col(colNames1['res2']), order);
