...
//output: dataframe fluxDecayDf {caption: Flux decay experimental results; viewer: Scatter Plot(title: Absolut flux decay, y: "J (LMH)", block: 50, filter: "!${isOutlier}", showFilteredOutPoints: "true",  filteredOutRowsColor: 4293991195) | Scatter Plot(title: Relative flux decay, y: "J/Jo", block: 50, filter: "!${isOutlier}", showFilteredOutPoints: "true",  filteredOutRowsColor: 4293991195); category: OUTPUT}
