...
Scripts could specify the required [environment](../../help/develop/scripting.md#environments), 
such as libraries used, their versions, versions
of the language interpreter, etc. We use 
[Conda environments](../../help/develop/scripting.md#conda-environments) for Python, and 
[Renv environments](../../help/develop/scripting.md#conda-environments) for R.

## Data sources

The platform allows to seamlessly [access](../../help/home.md#access) any machine-readable data source,
such as [databases](../../help/access/data-connection.md),
[web services](../../help/access/open-api.md),
[files](../../help/access/importing-data.md) (either on network shares on in S3).
To make a model retrieve the input data from the data source, annotate the
input parameter with the corresponding [parameterized query](../../help/access/parameterized-queries.md).
...
[creating a parameterized query](../../help/access/parameterized-queries.md), 
