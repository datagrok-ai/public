...
export namespace scripts {
  ...
  export async function iirFilter(data: DG.DataFrame , signal: DG.Column , order: number , frequency: number , sampleRate: number , type: string ): Promise<{filtered: DG.DataFrame, filter: any}> {
