...
/* ---
generated: features/annotation-regions/annotation-regions-tools-menu.feature
...
test.describe("The Tools menu offers the region items", () => {
  const session = feature(test, "features/annotation-regions/annotation-regions-tools-menu.feature", import.meta.url);
