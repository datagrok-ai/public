...
/* ---
generated: features/annotation-regions/annotation-regions-persistence.feature
...
test.describe("Annotation regions persist with the view", () => {
  const session = feature(test, "features/annotation-regions/annotation-regions-persistence.feature", import.meta.url);
