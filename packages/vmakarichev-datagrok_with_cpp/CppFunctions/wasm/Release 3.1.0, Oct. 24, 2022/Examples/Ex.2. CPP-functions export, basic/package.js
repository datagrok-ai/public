...
export function minOfColumn(df, col) {
  return cFuncWrapper(NewModule, 'minOfArr',  'num',
                      ['f32c'],
                      [col]);
}
...
//input: column col
//output: double num
export function maxOfColumn(df, col) {
  return cFuncWrapper(NewModule, 'maxOfArr',  'num',
                      ['f32c'],
                      [col]);
}
...
// Functions from stat\statistics.cpp
