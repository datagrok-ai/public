...
var FAEexplicit = undefined;

async function initFAEexplicit() {
  if (FAEexplicit === undefined) {
    console.log("Wasm not Loaded, Loading");
    FAEexplicit = await exportFAEexplicit();
    FAEexplicit.solveFAEexplicit = solveFAEexplicit;
  } else {
