...
if (typeof exports === 'object' && typeof module === 'object')
  ...
  define([], function() { return exportLib; });
else if (typeof exports === 'object')
  exports["exportLib"] = exportLib;
...
async function initLib() {
  if (Lib === undefined) {
    ...
    Lib = await exportLib();
    Lib.sum = sum;
    Lib.maxFloatCol = maxFloatCol;
    Lib.maxIntCol = maxIntCol;
    Lib.addFloatCols = addFloatCols;
    Lib.addIntCols = addIntCols;
    Lib.doubledInts = doubledInts;
    Lib.doubledFloats = doubledFloats;
  } else {
