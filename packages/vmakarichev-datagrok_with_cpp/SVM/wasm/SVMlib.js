...
var SVMlib = undefined;

async function initSVMlib() {
  if (SVMlib === undefined) {
    console.log("Wasm not Loaded, Loading");
    SVMlib = await exportSVMlib();
    SVMlib.generateDataset = generateDataset;
    SVMlib.normalizeDataset = normalizeDataset;
    SVMlib.trainLSSVM = trainLSSVM;
    SVMlib.predictByLSSVM = predictByLSSVM;
  } else {
