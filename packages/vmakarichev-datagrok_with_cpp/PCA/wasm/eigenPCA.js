...
async function initEigenPCA() {
  if (EigenPCA === undefined) {
    ...
    EigenPCA.principalComponentAnalysis = principalComponentAnalysis;
    EigenPCA.error = error;
    /* {  
      arguments: {
          columns: {
              type: 'floatColumns'
