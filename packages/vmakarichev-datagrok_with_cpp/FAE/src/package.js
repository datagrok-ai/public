...
// ORIGINAL INITIAL VALUES ARE REMOVED!
...
export async function solveFAE(t0, t1, h, FFox, KKox, FFred, KKred, Ffree, Kfree, FKred, FKox, MEAthiol, CO2, yO2P, Cystamine, VL) {

  let timesCount = Math.trunc((t1 - t0) / h) + 1;
  let varsCount = 14;

  return callWasm(ODEsolver, 'solveFAE', 
    [t0, t1, h, FFox, KKox, FFred, KKred, Ffree, Kfree, FKred, FKox, MEAthiol, CO2, yO2P, Cystamine, VL, timesCount, varsCount]);
}
