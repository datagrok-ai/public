...
async function initAnalyzer() {
  if (Analyzer === undefined) {
    ...
    Analyzer = await exportAnalyzer();
    Analyzer.principalComponentAnalysis = principalComponentAnalysis;
    Analyzer.error = error;
    Analyzer.partialLeastSquareRegression = partialLeastSquareRegression;
  } else {
