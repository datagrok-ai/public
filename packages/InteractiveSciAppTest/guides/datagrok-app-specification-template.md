...
> This template follows the structure of `datagrok-interactive-app-guide.md`.
> Section numbers here match the guide's section numbers.
...
| Worker adapter | Yes / No | Web worker wrapper for core tasks |
