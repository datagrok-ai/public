...
// Small workflow based on the Wine Quality dateset //
//////////////////////////////////////////////////////
    ...
    steps: [
      {
        ...
        nqName: 'Compute2:fetchwinedata',
      },
      {
        id: 'clusterwinedata',
        friendlyName: 'Clustering',
        nqName: 'Compute2:clusterwinedata',
      },
      {
        id: 'trainregression',
        friendlyName: 'Train Regression Model',
        nqName: 'Compute2:trainregression',
      },
      {
        id: 'mergepredictions',
        friendlyName: 'Merge predictions of two models',
        nqName: 'Compute2:mergepredictions',
      },
    ],
    links: [
      {
