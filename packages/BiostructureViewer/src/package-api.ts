...
export namespace funcs {
  ...
  export async function previewBiostructureStructure(file: DG.FileInfo ): Promise<DG.View> {
    return await grok.functions.call('BiostructureViewer:PreviewBiostructureStructure', { file });
  }

  export async function previewBiostructureTopology(file: DG.FileInfo ): Promise<DG.View> {
    return await grok.functions.call('BiostructureViewer:PreviewBiostructureTopology', { file });
  }

  export async function previewBiostructureDensity(file: DG.FileInfo ): Promise<DG.View> {
