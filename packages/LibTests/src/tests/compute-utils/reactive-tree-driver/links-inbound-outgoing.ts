...
category('ComputeUtils: Driver links inbound outgoing', async () => {
  ...
  test('Root remove item', async () => {
    ...
    tree.init().subscribe();
    const [link] = [...tree.linksState.links.values()];
    expectDeepEqual(tree.linksState.isAffected([], link, undefined, 1), true, {prefix: 'isAffected'});
  ...
  test('Nested add nested item', async () => {
    ...
    expectDeepEqual(tree.linksState.isAffected([{idx: 2}], link3, 1), false, {prefix: 'link3 isAffected'});
    ...
    expectDeepEqual(tree.linksState.isAffected([{idx: 2}], link4, 1), false, {prefix: 'link4 isAffected'});
  ...
  test('Nested remove item', async () => {
    ...
    tree.init().subscribe();
    const [link1, link2, link3, link4, link5] = [...tree.linksState.links.values()];
    expectDeepEqual(tree.linksState.isAffected([], link1, undefined, 2), true, {prefix: 'link1 isAffected'});
    ...
    expectDeepEqual(tree.linksState.isAffected([], link2, undefined, 2), true, {prefix: 'link2 isAffected'});
    ...
    expectDeepEqual(tree.linksState.isAffected([], link3, undefined, 2), true, {prefix: 'link3 isAffected'});
    ...
    expectDeepEqual(tree.linksState.isAffected([], link4, undefined, 2), true, {prefix: 'link4 isAffected'});
    ...
    expectDeepEqual(tree.linksState.isAffected([], link5, undefined, 2), true, {prefix: 'link5 isAffected'});
  ...
  test('Nested move item', async () => {
    ...
    tree.init().subscribe();
    const [link1, link2, link3, link4, link5] = [...tree.linksState.links.values()];
    expectDeepEqual(tree.linksState.isAffected([], link1, 2, 1), true, {prefix: 'link1 isAffected'});
    ...
    expectDeepEqual(tree.linksState.isAffected([], link2, 2, 1), true, {prefix: 'link2 isAffected'});
    ...
    expectDeepEqual(tree.linksState.isAffected([], link3, 2, 1), true, {prefix: 'link3 isAffected'});
    ...
    expectDeepEqual(tree.linksState.isAffected([], link4, 2, 1), true, {prefix: 'link4 isAffected'});
    ...
    expectDeepEqual(tree.linksState.isAffected([], link5, 2, 1), true, {prefix: 'link5 isAffected'});
