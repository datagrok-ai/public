...
export class RegistrationAssayRunView {
  view: DG.View;
  ...
  constructor() {
    ...
    this.view.name = 'Register Assay Run';
    this.createInputs();
  ...
  private buildUI() {
    ...
    const registerButton = ui.bigButton('REGISTER', async () => await this.registerAssayRun());
  ...
  private async registerAssayRun() {
  }
