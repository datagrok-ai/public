...
var Reactor = undefined;

async function initReactor() {
  if (Reactor === undefined) {
    console.log("Wasm not Loaded, Loading");
    Reactor = await exportReactor();
    Reactor.solveReactor = solveReactor;
  } else {
