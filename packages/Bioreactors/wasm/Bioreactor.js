...
var solveBioreactor = {
  arguments: {
    ...
    _solution: {
      ...
      names: ['t', 'FFox(t)', 'KKox(t)', 'FFred(t)', 'KKred(t)', 'Ffree(t)', 'Kfree(t)', 'FKred(t)', 'FKox(t)', 'MEA(t)', 'CO2(t)', 'yO2P(t)', 'CYST(t)', 'VL(t)']
    }
  },
  output: {
...
var Bioreactor = undefined;

async function initBioreactor() {
  if (Bioreactor === undefined) {
    console.log("Wasm not Loaded, Loading");
    Bioreactor = await exportBioreactor();
    Bioreactor.solveBioreactor = solveBioreactor;
  } else {
