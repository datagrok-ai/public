...
export class Viewport {
  ...
  xToWorld(screen: number): number {
    return this.xt.worldToScreen(screen, this.screen.width, this.world.minX, this.world.maxX, this.inverseX);
  }

  yToWorld(screen: number): number {
    return this.yt.worldToScreen(screen, this.screen.height, this.world.minY, this.world.maxY, this.inverseY);
  }
