# BenchlingLink — Third-Party Libraries

The `@datagrok/benchlinglink` package is distributed under the MIT license
...
redistributed as part of the published BenchlingLink plugin and impose no
