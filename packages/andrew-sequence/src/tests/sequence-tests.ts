...
category('complement function', () => {
  const checkComplementResult = (input: string, expected: string) => {
  ...
  test('upper case characters replacement', async () => {
    const expected = 'TACG';
    const input = 'ATGC';
  ...
  test('lower case characters replacement', async () => {
    const expected = 'tacg';
    const input = 'atgc';
  ...
  test('lower & upper case characters replacement including spaces', async () => {
