...
test.describe("Hierarchical clustering from the Chem menu", () => {
  ...
  test("Hierarchical clustering from the Chem menu", {tag: ["@journey", "@realizes:dendrogram.cp.hier-clustering-chem-dialog-end-to-end", "@GROK-19595"]}, async ({browser}) => {
    ...
    await run.scenario("Euclidean distance and ward linkage attach a tree with a leaf for every molecule", async () => {
      ...
      await session.step(36, "And the task bar should have shown \"Creating dendrogram\"", () => taskBarShown(page, "Creating dendrogram"));
      await session.step(37, "And the task bar should have finished \"Creating dendrogram\"", () => taskBarFinished(page, "Creating dendrogram"));
      await session.step(38, "And the \"tree leaves\" reading of grid should be 1000", () => readingIs(page, "tree leaves", el("grid"), 1000));
      await session.step(39, "And \"Assign Clusters\" icon should be visible", () => shouldBe(page, el("\"Assign Clusters\" icon"), "visible"));
    ...
    await run.scenario("Removing the tree, then manhattan distance and single linkage attach a tree of another height", async () => {
      await session.step(43, "When user remembers the \"tree height\" reading of grid", () => rememberReading(page, "tree height", el("grid")));
      await session.step(44, "And user clicks on \"Remove Dendrogram\" icon", () => clickOn(page, el("\"Remove Dendrogram\" icon")));
      await session.step(45, "Then \"Assign Clusters\" icon should be absent", () => shouldBe(page, el("\"Assign Clusters\" icon"), "absent"));
      await session.step(46, "And grid should not report a \"tree leaves\" reading", () => noSuchReading(page, el("grid"), "tree leaves"));
      await session.step(47, "When user picks \"Chem > Analyze > Hierarchical Clustering...\" from the top menu", () => pickFromTopMenu(page, "Chem > Analyze > Hierarchical Clustering..."));
      await session.step(48, "And user selects \"manhattan\" in Distance input in \"Hierarchical Clustering\" dialog", () => selectIn(page, "manhattan", el("Distance input in \"Hierarchical Clustering\" dialog")));
      await session.step(49, "And user selects \"single\" in Linkage input in \"Hierarchical Clustering\" dialog", () => selectIn(page, "single", el("Linkage input in \"Hierarchical Clustering\" dialog")));
      await session.step(50, "Then Distance input in \"Hierarchical Clustering\" dialog should have value \"manhattan\"", () => shouldHaveValue(page, el("Distance input in \"Hierarchical Clustering\" dialog"), "manhattan"));
      await session.step(51, "And Linkage input in \"Hierarchical Clustering\" dialog should have value \"single\"", () => shouldHaveValue(page, el("Linkage input in \"Hierarchical Clustering\" dialog"), "single"));
      await session.step(52, "When user clicks on OK button in \"Hierarchical Clustering\" dialog", () => clickOn(page, el("OK button in \"Hierarchical Clustering\" dialog")));
      await session.step(53, "Then the task bar should have finished \"Creating dendrogram\"", () => taskBarFinished(page, "Creating dendrogram"));
      await session.step(54, "And the \"tree leaves\" reading of grid should be 1000", () => readingIs(page, "tree leaves", el("grid"), 1000));
      await session.step(55, "And the \"tree height\" reading of grid should not be as remembered", () => readingNotAsRemembered(page, "tree height", el("grid")));
    ...
    await run.scenario("Numeric columns with median linkage attach a tree with a leaf for every row", async () => {
      await session.step(60, "When user remembers the \"tree height\" reading of grid", () => rememberReading(page, "tree height", el("grid")));
      await session.step(61, "And user clicks on \"Remove Dendrogram\" icon", () => clickOn(page, el("\"Remove Dendrogram\" icon")));
      await session.step(62, "And user picks \"Chem > Analyze > Hierarchical Clustering...\" from the top menu", () => pickFromTopMenu(page, "Chem > Analyze > Hierarchical Clustering..."));
      await session.step(63, "And user clicks on editor of Features input in \"Hierarchical Clustering\" dialog", () => clickOn(page, el("editor of Features input in \"Hierarchical Clustering\" dialog")));
      await session.step(64, "Then \"Select columns...\" dialog should be visible", () => shouldBe(page, el("\"Select columns...\" dialog"), "visible"));
      await session.step(65, "When user clicks on None label in \"Select columns...\" dialog", () => clickOn(page, el("None label in \"Select columns...\" dialog")));
      await session.step(66, "And user clicks on the \"cell 4 of x\" area of grid viewer in \"Select columns...\" dialog", () => clickArea(page, "cell 4 of x", el("grid viewer in \"Select columns...\" dialog")));
      await session.step(67, "And user clicks on the \"cell 5 of x\" area of grid viewer in \"Select columns...\" dialog", () => clickArea(page, "cell 5 of x", el("grid viewer in \"Select columns...\" dialog")));
      await session.step(68, "Then the \"text of cell 4 of __name\" reading of grid viewer in \"Select columns...\" dialog should be \"pIC50_HIV_Integrase\"", () => readingReads(page, "text of cell 4 of __name", el("grid viewer in \"Select columns...\" dialog"), "pIC50_HIV_Integrase"));
      await session.step(69, "And the \"text of cell 5 of __name\" reading of grid viewer in \"Select columns...\" dialog should be \"Q\"", () => readingReads(page, "text of cell 5 of __name", el("grid viewer in \"Select columns...\" dialog"), "Q"));
      await session.step(70, "And \"Select columns...\" dialog should contain text \"2 checked\"", () => shouldContainText(page, el("\"Select columns...\" dialog"), "2 checked"));
      await session.step(71, "When user clicks on OK button in \"Select columns...\" dialog", () => clickOn(page, el("OK button in \"Select columns...\" dialog")));
      await session.step(72, "Then editor of Features input in \"Hierarchical Clustering\" dialog should contain text \"(2)\"", () => shouldContainText(page, el("editor of Features input in \"Hierarchical Clustering\" dialog"), "(2)"));
      await session.step(73, "When user selects \"median\" in Linkage input in \"Hierarchical Clustering\" dialog", () => selectIn(page, "median", el("Linkage input in \"Hierarchical Clustering\" dialog")));
      await session.step(74, "Then Linkage input in \"Hierarchical Clustering\" dialog should have value \"median\"", () => shouldHaveValue(page, el("Linkage input in \"Hierarchical Clustering\" dialog"), "median"));
      await session.step(75, "When user clicks on OK button in \"Hierarchical Clustering\" dialog", () => clickOn(page, el("OK button in \"Hierarchical Clustering\" dialog")));
      await session.step(76, "Then the task bar should have finished \"Creating dendrogram\"", () => taskBarFinished(page, "Creating dendrogram"));
      await session.step(77, "And the \"tree leaves\" reading of grid should be 1000", () => readingIs(page, "tree leaves", el("grid"), 1000));
