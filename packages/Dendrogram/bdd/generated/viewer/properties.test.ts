...
test.describe("The Dendrogram viewer's properties from the property panel", () => {
  ...
  test("The Dendrogram viewer's properties from the property panel", {tag: ["@journey", "@realizes:dendrogram.cp.viewer-from-newick-prop", "@known-failure"]}, async ({browser}) => {
    ...
    await session.step(18, "And user opens a table \"leaves4\" with:", () => openTableOf(page, "leaves4", [["leaf","value"],["a","1"],["b","2"],["c","3"],["d","4"]]));
    ...
    await session.step(26, "And user adds Dendrogram viewer with:", () => addViewerWith(page, "Dendrogram", [["newick","((a:1,b:1):1,(c:1,d:1):1);"],["nodeColumnName","leaf"]]));
