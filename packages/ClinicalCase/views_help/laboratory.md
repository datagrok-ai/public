...
Scatter plot for analyzing possible risk of a fatal drug-induced liver injury. To generate scatter plot you should select values for ALT, AST and Bilirubin on a property panel.
...
Baseline, endpoint visits as well as laboratory value can be selected using dropdown lists on a property panel.
...
Laboratory value as well as study visit can be selected via dropdown lists on a property panel.
