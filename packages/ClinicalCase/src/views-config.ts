import {ACT_TRT_ARM, AE_END_DAY, AE_START_DATE, AE_START_DAY, AE_TERM, CON_MED_END_DAY, CON_MED_START_DAY,
  CON_MED_TRT, INV_DRUG_END_DAY, INV_DRUG_NAME, INV_DRUG_START_DAY, MH_TERM,
  PLANNED_TRT_ARM} from './constants/columns-constants';
import {ADVERSE_EVENTS_VIEW_NAME, AE_BROWSER_VIEW_NAME, AE_RISK_ASSESSMENT_VIEW_NAME,
  DISTRIBUTIONS_VIEW_NAME, LABORATORY_VIEW_NAME, MEDICAL_HISTORY_VIEW_NAME,
...
export class ClinicalCaseViewsConfig {
  config = {
    [SUMMARY_VIEW_NAME]: {
