...
export const domains = {
  ae: {
    'STUDYID': { label: 'Study Identifier', type: 'Char', req: isRequired.REQIIRED },
    'DOMAIN': { label: 'Domain Abbreviation', type: 'Char', req: isRequired.REQIIRED },
    'USUBJID': { label: 'Unique Subject Identifier', type: 'Char', req: isRequired.REQIIRED },
    'AESEQ': { label: 'Sequence Number', type: 'Num', req: isRequired.REQIIRED },
    ...
    'AETERM': { label: 'Reported Term for the Adverse Event', type: 'Char', req: isRequired.REQIIRED },
    ...
    'AEDECOD': { label: 'Dictionary-Derived Term', type: 'Char', req: isRequired.REQIIRED },
    ...
    'AEBODSYS': { label: 'Body System or Organ Class', type: 'Char', req: isRequired.EXPECTED },
    ...
    'AESEV': { label: 'Severity/Intensity', type: 'Char', format: '(AESEV)', req: isRequired.PERMITTED },
    'AESER': { label: 'Serious Event', type: 'Char', format: '(NY)', req: isRequired.EXPECTED },
    ...
    'AEREL': { label: 'Causality', type: 'Char', req: isRequired.EXPECTED },
    ...
    'AEOUT': { label: 'Outcome of Adverse Event', type: 'Char', format: '(OUT)', req: isRequired.PERMITTED },
    ...
    'AESHOSP': { label: 'Requires or Prolongs Hospitalization', type: 'Char', format: '(NY)', req: isRequired.PERMITTED },
    ...
    'AESTDTC': { label: 'Start Date/Time of Adverse Event', type: 'Char', format: 'ISO 8601', req: isRequired.EXPECTED },
    'AEENDTC': { label: 'End Date/Time of Adverse Event', type: 'Char', format: 'ISO 8601', req: isRequired.EXPECTED },
    'AESTDY': { label: 'Study Day of Start of Adverse Event', type: 'Num', req: isRequired.PERMITTED },
    'AEENDY': { label: 'Study Day of End of Adverse Event', type: 'Num', req: isRequired.PERMITTED },
  ...
  dm: {
    ...
    'RFSTDTC': { label: 'Subject Reference Start Date/Time', type: 'Char', format: 'ISO 8601', req: isRequired.EXPECTED },
    'RFENDTC': { label: 'Subject Reference End Date/Time', type: 'Char', format: 'ISO 8601', req: isRequired.EXPECTED },
    ...
    'DTHDTC': { label: 'Date/Time of Death', type: 'Char', format: 'ISO 8601', req: isRequired.EXPECTED },
    'DTHFL': { label: 'Subject Death Flag', type: 'Char', format: '(NY)', req: isRequired.EXPECTED },
    'SITEID': { label: 'Study Site Identifier', type: 'Char', req: isRequired.REQIIRED },
    ...
    'AGE': { label: 'Age', type: 'Num', req: isRequired.EXPECTED },
    'AGEU': { label: 'Age Units', type: 'Char', format: '(AGEU)', req: isRequired.EXPECTED },
    'SEX': { label: 'Sex', type: 'Char', format: '(SEX)', req: isRequired.REQIIRED },
    'RACE': { label: 'Race', type: 'Char', format: '(RACE)', req: isRequired.EXPECTED },
    'ETHNIC': { label: 'Ethnicity', type: 'Char', format: '(ETHNIC)', req: isRequired.PERMITTED },
    ...
    'ACTARM': { label: 'Description of Actual Arm', type: 'Char', req: isRequired.EXPECTED },
