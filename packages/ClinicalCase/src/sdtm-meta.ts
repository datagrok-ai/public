...
export const domains = {
  ...
  cm: {
    ...
    [sdtmCols.CON_MED_NAME]: { label: 'Reported Name of Drug, Med, or Therapy', type: 'Char' },
  ...
  lb: {
    ...
    [sdtmCols.LAB_VISIT_NAME]: { label: 'Visit Name', type: 'Char' },
    [sdtmCols.LAB_VISIT_DAY]: { label: 'Planned Study Day of Visit', type: 'Num' },
    'TAETORD': { label: 'Planned Order of Element within Arm', type: 'Num' },
    'EPOCH': { label: 'Epoch', type: 'Char', format: '(EPOCH)' },
