...
export const domains = {
  ae: {
    ...
    [sdtmCols.AE_OUTCOME]: {label: 'Outcome of Adverse Event', type: 'Char',
      format: '(OUT)', req: isRequired.PERMITTED},
    ...
    'AESDISAB': {label: 'Persist or Signif Disability/Incapacity', type: 'Char', format: '(NY)',
      req: isRequired.PERMITTED},
    'AESDTH': {label: 'Results in Death', type: 'Char', format: '(NY)', req: isRequired.PERMITTED},
    [sdtmCols.AE_REQ_HOSP]: {label: 'Requires or Prolongs Hospitalization', type: 'Char', format: '(NY)',
      req: isRequired.PERMITTED},
    ...
    [sdtmCols.AE_START_DATE]: {label: 'Start Date/Time of Adverse Event', type: 'Char', format: 'ISO 8601',
      req: isRequired.EXPECTED},
    [sdtmCols.AE_END_DATE]: {label: 'End Date/Time of Adverse Event', type: 'Char', format: 'ISO 8601',
      req: isRequired.EXPECTED},
  ...
  dm: {
    ...
    [sdtmCols.SUBJ_REF_STDT]: {label: 'Subject Reference Start Date/Time', type: 'Char', format: 'ISO 8601',
      req: isRequired.EXPECTED},
    [sdtmCols.SUBJ_REF_ENDT]: {label: 'Subject Reference End Date/Time', type: 'Char', format: 'ISO 8601',
      req: isRequired.EXPECTED},
  ...
  lb: {
    ...
    'LBTESTCD': {label: 'Lab Test or Examination Short Name', type: 'Char',
      format: '(LBTESTCD)', rule: 'regex ^[A-Za-z_]{1}[A-Za-z_0-9]{0,7}$'},
    [sdtmCols.LAB_TEST]: {label: 'Lab Test or Examination Name', type: 'Char',
      format: '(LBTEST)', rule: 'regex ^.{1,40}$'},
    ...
    [sdtmCols.LAB_RES_N]: {label: 'Numeric Result/Finding in Standard Units', type: 'Num',
      rule: '${LBSTNRLO}-${LBSTNRHI}'},
    ...
    [sdtmCols.VISIT]: {label: 'Visit Name', type: 'Char'},
