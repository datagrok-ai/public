...
export namespace queries {
   ...
   * @param {string} molecule_type
   * @param {string} subname
   * @param {number} max_phase
   * @param {number} num_ro5_violations
   * @returns {Promise<DG.DataFrame>}
   */
   ...
   * @param {number} maxNumberOfMolecules
   * @returns {Promise<DG.DataFrame>}
   */
