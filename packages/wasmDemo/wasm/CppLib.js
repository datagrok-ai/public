...
if (typeof exports === 'object' && typeof module === 'object')
  ...
  define([], function() { return exportCppLib; });
else if (typeof exports === 'object')
  exports["exportCppLib"] = exportCppLib;
...
var CppLib = undefined;

async function initCppLib() {
  if (CppLib === undefined) {
    console.log("Wasm not Loaded, Loading");
    CppLib = await exportCppLib();
    CppLib.sum = sum;
    CppLib.maxFloatCol = maxFloatCol;
    CppLib.maxIntCol = maxIntCol;
    CppLib.addFloatCols = addFloatCols;
    CppLib.addIntCols = addIntCols;
    CppLib.doubledInts = doubledInts;
    CppLib.doubledFloats = doubledFloats;
    CppLib.principalComponentAnalysis = principalComponentAnalysis;
    CppLib.error = error;
    CppLib.partialLeastSquareRegression = partialLeastSquareRegression;
  } else {
