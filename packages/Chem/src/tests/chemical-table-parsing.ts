...
const PARSED_Y = [-1.5401, -1.4280, -2.7270, -3.9664, -2.9506, -1.9303, -0.4345, 0.3155, -0.4345, 0.3155, 1.8155, 2.5655,
  1.8155, 0.4104, 1.8728, 2.8931, 2.4510, 0.9886, -0.0317];

const ATOM_TYPES_V2K = ['C', 'N', 'C', 'O', 'C', 'N', 'C', 'C', 'C', 'C', 'C', 'C', 'C', 'C', 'C', 'C', 'C', 'C', 'C'];

const ATOM_TYPES_V3K = ['NOT [C,N]', 'N', 'C', 'O', 'C', 'N', 'C', 'C', 'C', 'C', 'C', 'C', 'C', 'C', 'C', 'C', 'C', 'C', 'C'];
