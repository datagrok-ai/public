...
`;
    ...
    await _testSearchSubstructure(df, 'smiles', substructureSmiles, [0, 2]);
  });
...
`;
  ...
  test('searchSustructurePerformance', async () => {
    const df = grok.data.demo.molecules(30000);
...
`;
    ...
    await _testSearchSubstructure(df, 'smiles', substructureSmiles, [2]);
  });
  ...
  test('searchSustructureWith2Columns', async () => {
    ...
    const csv =
      `smiles, smiles1
${targetSmiles[0]}, COc1ccc2cc(ccc2c1)C(C)C(=O)Oc3ccc(C)cc3OC
COc1ccc2cc(ccc2c1)C(C)C(=O)Oc3ccc(C)cc3OC, ${targetSmiles[0]}
${targetSmiles[1]}, COc1ccc2c(c1)c(CC(=O)N3CCCC3C(=O)Oc4ccc(C)cc4OC)c(C)n2C(=O)c5ccc(Cl)cc5
CC(C(=O)NCCS)c1cccc(c1)C(=O)c2ccccc2, COc1ccc2c(c1)c(CC(=O)N3CCCC3C(=O)Oc4ccc(C)cc4OC)c(C)n2C(=O)c5ccc(Cl)cc5
COc1ccc2c(c1)c(CC(=O)N3CCCC3C(=O)Oc4ccc(C)cc4OC)c(C)n2C(=O)c5ccc(Cl)cc5, ${targetSmiles[1]}
`;
    const df = DG.DataFrame.fromCsv(csv);
    await _testSearchSubstructure(df, 'smiles', substructureSmiles, [0, 2]);
    await _testSearchSubstructure(df, 'smiles1', substructureSmiles, [1, 4]);
  });
