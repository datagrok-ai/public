let PATH_TO_WASM = "RDKit_minimal_2021.03_17.wasm";

export async function createRDKit(strPathToWASM = null) {
  PATH_TO_WASM = strPathToWASM + "dist/RDKit_minimal_2021.03_17.wasm";
  let rdkit = await initRDKitModule();
  return rdkit;
}

var initRDKitModule = (function () {
  var _scriptDir = typeof document !== 'undefined' && document.currentScript ? document.currentScript.src : undefined;
  if (typeof __filename !== 'undefined') _scriptDir = _scriptDir || __filename;
  return (
    function (initRDKitModule) {
      initRDKitModule = initRDKitModule || {};

      var Module = typeof initRDKitModule !== "undefined" ? initRDKitModule : {};
      ...
      var wasmBinaryFile = PATH_TO_WASM;
      // Removed for always consistent path
