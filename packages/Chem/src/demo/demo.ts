...
export async function _demoActivityCliffs(): Promise<void> {
    ...
    demoScript
        ...
        .step('Find activity cliffs', async () => {
            ...
            scatterPlot = await getActivityCliffs(table, molecules, null as any, axesNames, 'Activity cliffs', table.col('In-vivo Activity')!, 78, BitArrayMetricsNames.Tanimoto,
...
--end`
    ...
    const runQuery = async () => {
        ...
        await funccall.call();
        let data: DG.DataFrame = funccall.getOutputParamValue();
