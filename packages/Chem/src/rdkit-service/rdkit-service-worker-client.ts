...
export class RdKitServiceWorkerClient extends WorkerMessageBusClient {
  ...
  getFingerprints = async (fingerprintType: Fingerprint, molecules?: string[]) =>
    this.call(WORKER_CALL.GET_FINGERPRINTS, [fingerprintType, molecules]);
  ...
  getMolSafe = async (molecules: string[], details: {}, warnOff: boolean, checkIfSmarts: boolean) => 
    this.call(WORKER_CALL.GET_MOL_SAFE, [molecules, details, warnOff, checkIfSmarts]);
}
