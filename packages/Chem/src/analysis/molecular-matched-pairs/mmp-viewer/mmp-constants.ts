...
export const CLIFFS_TAB_TOOLTIP = `2D Chemical space based on UMAP algorithm. Lines connect pairs of molecules with substitutions. Arrow points to greater value. Use filters on the scatter plot to change activity difference cutoff or switch of/on the lines for any activity. Click on a line to see details in a context panel.`