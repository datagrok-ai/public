...
import {finishSpec, ensurePropertyCategory, openViewerGear, propertyGridValue,
  selectPropertyGridChoice} from '@datagrok-libraries/test/src/playwright/viewers';
import {addCardViaColumnSelector, cardCaptions} from '@datagrok-libraries/test/src/playwright/filter-panel';
