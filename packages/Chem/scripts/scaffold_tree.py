...
#function that return the parent of the scaffold
def get_parent(tree, scaffold):
    return ''.join(tree.get_parent_scaffolds(scaffold, max_levels=1))

#funtion that returns the right order of scaffolds
...
def get_json_representation(tree):
    ...
    for i in range(1, len(sorted_scaffolds)):
        ...
        print(str(tree.get_parent_scaffolds(sorted_scaffolds[i], max_levels=1)))
