...
}; // solveTwoCompartmentPK

var TwoCompartmentPK = undefined;

async function initTwoCompartmentPK() {
  if (TwoCompartmentPK === undefined) {
    console.log("Wasm not Loaded, Loading");
    TwoCompartmentPK = await exportTwoCompartmentPK();
    TwoCompartmentPK.solveTwoCompartmentPK = solveTwoCompartmentPK;
  } else {
