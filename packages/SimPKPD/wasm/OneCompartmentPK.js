...
var OneCompartmentPK = undefined;

async function initOneCompartmentPK() {
  if (OneCompartmentPK === undefined) {
    console.log("Wasm not Loaded, Loading");
    OneCompartmentPK = await exportOneCompartmentPK();
    OneCompartmentPK.solveOneCompartmentPK = solveOneCompartmentPK;
  } else {
