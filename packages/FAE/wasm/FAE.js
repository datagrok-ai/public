...
async function initFAE() {
  if (FAE === undefined) {
    console.log("Wasm not Loaded, Loading");
    FAE = await exportFAE();
    FAE.solveFAE = solveFAE;
  } else {
