...
//connection: Neo4jDBTests
//input: int id = 20
//test: Dbtests:expectTable(Neo4jIntTypePatternNone(20), OpenFile('System:AppData/Dbtests/common/data20.d42'))
...
//test: Dbtests:expectTable(Neo4jStringTypeIntPatternOpMore(), OpenFile('System:AppData/Dbtests/common/data29-30.d42'))
...
//test: Dbtests:expectTable(Neo4jStringTypeIntPatternOpMoreEq(), OpenFile('System:AppData/Dbtests/common/data29-30.d42'))
MATCH(p:Person) WHERE @id(p.id) RETURN p.id AS id, p.first_name AS first_name,
    p.last_name AS last_name, p.email AS email, p.gender AS gender, p.ip_address AS ip_address,
    p.bool AS bool, p.country AS country, p.date AS date, p.some_number AS some_number;
//end
...
//test: Dbtests:expectTable(Neo4jStringTypeIntPatternOpLessEq(), OpenFile('System:AppData/Dbtests/common/data1.d42'))
MATCH(p:Person) WHERE @id(p.id) RETURN p.id AS id, p.first_name AS first_name,
    p.last_name AS last_name, p.email AS email, p.gender AS gender, p.ip_address AS ip_address,
    p.bool AS bool, p.country AS country, p.date AS date, p.some_number AS some_number;
//end
...
//test: Dbtests:expectTable(Neo4jStringTypeIntPatternOpLess(), OpenFile('System:AppData/Dbtests/common/data1.d42'))
MATCH(p:Person) WHERE @id(p.id) RETURN p.id AS id, p.first_name AS first_name,
    p.last_name AS last_name, p.email AS email, p.gender AS gender, p.ip_address AS ip_address,
    p.bool AS bool, p.country AS country, p.date AS date, p.some_number AS some_number;
//end
...
//test: Dbtests:expectTable(Neo4jStringTypeIntPatternOpIn(), OpenFile('System:AppData/Dbtests/common/data29-30.d42'))
MATCH(p:Person) WHERE @id(p.id) RETURN p.id AS id, p.first_name AS first_name,
    p.last_name AS last_name, p.email AS email, p.gender AS gender, p.ip_address AS ip_address,
    p.bool AS bool, p.country AS country, p.date AS date, p.some_number AS some_number;
//end
...
//test: Dbtests:expectTable(Neo4jStringTypeIntPatternOpMinMax(), OpenFile('System:AppData/Dbtests/common/data29-30.d42'))
MATCH(p:Person) WHERE @id(p.id) RETURN p.id AS id, p.first_name AS first_name,
    p.last_name AS last_name, p.email AS email, p.gender AS gender, p.ip_address AS ip_address,
    p.bool AS bool, p.country AS country, p.date AS date, p.some_number AS some_number;
//end
...
//test: Dbtests:expectTable(Neo4jDoubleTypePatternNone(510.32), OpenFile('System:AppData/Dbtests/common/data1.d42'))
...
//test: Dbtests:expectTable(Neo4jStringTypePatternDoubleOpMore(), OpenFile('System:AppData/Dbtests/common/data10,26.d42'))
...
//connection: Neo4jDBTests
//input: string some_number = ">=975" {pattern: double}
//test: Dbtests:expectTable(Neo4jStringTypePatternDoubleOpMoreEq(), OpenFile('System:AppData/Dbtests/common/data10,26.d42'))
MATCH(p:Person) WHERE @some_number(p.some_number) RETURN p.id AS id, p.first_name AS first_name,
    p.last_name AS last_name, p.email AS email, p.gender AS gender, p.ip_address AS ip_address,
    p.bool AS bool, p.country AS country, p.date AS date, p.some_number AS some_number;
//end
...
//test: Dbtests:expectTable(Neo4jStringTypePatternDoubleOpLess(), OpenFile('System:AppData/Dbtests/common/data5.d42'))
MATCH(p:Person) WHERE @some_number(p.some_number) RETURN p.id AS id, p.first_name AS first_name,
    p.last_name AS last_name, p.email AS email, p.gender AS gender, p.ip_address AS ip_address,
    p.bool AS bool, p.country AS country, p.date AS date, p.some_number AS some_number;
//end
...
//connection: Neo4jDBTests
//input: string some_number = "<=20" {pattern: double}
//test: Dbtests:expectTable(Neo4jStringTypePatternDoubleOpLessEq(), OpenFile('System:AppData/Dbtests/common/data5.d42'))
MATCH(p:Person) WHERE @some_number(p.some_number) RETURN p.id AS id, p.first_name AS first_name,
    p.last_name AS last_name, p.email AS email, p.gender AS gender, p.ip_address AS ip_address,
    p.bool AS bool, p.country AS country, p.date AS date, p.some_number AS some_number;
//end
...
//test: Dbtests:expectTable(Neo4jStringTypePatternStringOpContains(first_name = 'contains Z'), OpenFile('System:AppData/Dbtests/common/data25.d42'))
...
//test: Dbtests:expectTable(Neo4jStringTypePatternStringOpStartsWith(first_name='starts with W'), OpenFile('System:AppData/Dbtests/common/data23.d42'))
MATCH(p:Person) WHERE @first_name(p.first_name) RETURN p.id AS id, p.first_name AS first_name,
    p.last_name AS last_name, p.email AS email, p.gender AS gender, p.ip_address AS ip_address,
    p.bool AS bool, p.country AS country, p.date AS date, p.some_number AS some_number;
//end
...
//test: Dbtests:expectTable(Neo4jStringTypePatternStringOpEndsWith(first_name = 'ends with y'), OpenFile('System:AppData/Dbtests/common/data6,23,25.d42'))
MATCH(p:Person) WHERE @first_name(p.first_name) RETURN p.id AS id, p.first_name AS first_name,
    p.last_name AS last_name, p.email AS email, p.gender AS gender, p.ip_address AS ip_address,
    p.bool AS bool, p.country AS country, p.date AS date, p.some_number AS some_number;
//end
...
//test: Dbtests:expectTable(Neo4jStringTypePatternStringOpIn(), OpenFile('System:AppData/Dbtests/common/data2,5,20.d42'))
...
//test: Dbtests:expectTable(Neo4jStringTypePatternStringOpRegex(email = 'regex ^([A-Za-z0-9_]+@google.com.au)$'), OpenFile('System:AppData/Dbtests/common/data9.d42'))
...
//test: Dbtests:expectTable(Neo4jPatternsAllParams(first_name = "starts with p", id = ">1", false, email = "contains com", some_number = ">20", country = "in (Indonesia)", date = "before 1/1/2022"), OpenFile("System:AppData/Dbtests/common/data13.d42"))
