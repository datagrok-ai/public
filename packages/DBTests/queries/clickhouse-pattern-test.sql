...
-- test: Dbtests:expectTable(ClickHouseStringTypePatternDoubleOpMore('>975'), OpenFile('System:AppData/Dbtests/common/data1026.d42')) // cat: ClickHouse
SELECT * FROM mock_data WHERE @some_number(some_number);
-- end
...
-- connection: ClickHouseDBTests
-- input: string some_number = ">=975" {pattern: double}
-- test: Dbtests:expectTable(ClickHouseStringTypePatternDoubleOpMoreEq('>=975'), OpenFile('System:AppData/Dbtests/common/data1026.d42')) // cat: ClickHouse
SELECT * FROM mock_data WHERE @some_number(some_number);
-- end
...
-- test: Dbtests:expectTable(ClickHouseStringTypePatternStringOpEndsWith(first_name = 'ends with y'), OpenFile('System:AppData/Dbtests/common/data62325.d42')) // cat: ClickHouse
SELECT * FROM mock_data WHERE @first_name(first_name);
-- end
...
-- test: Dbtests:expectTable(ClickHouseStringTypePatternStringOpIn(country='in (Poland, Brazil)'), OpenFile('System:AppData/Dbtests/common/data2520.d42')) // cat: ClickHouse
