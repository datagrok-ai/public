...
category('TableQueryBuilder', () => {
    ...
    test('no fields', async () => {
        const tq = DG.TableQueryBuilder.from(testTableName).build();
        tq.connection = northwind;
    ...
    test('fields limit', async () => {
        const tq = DG.TableQueryBuilder.from(testTableName)
    ...
    test('fields where datetime pattern', async () => {
        const tq = DG.TableQueryBuilder.from('orders')
    ...
    test('fields where string pattern', async () => {
        const tq = DG.TableQueryBuilder.from('customers')
