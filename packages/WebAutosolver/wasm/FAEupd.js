...
var FAEupd = undefined;

async function initFAEupd() {
  if (FAEupd === undefined) {
    console.log("Wasm not Loaded, Loading");
    FAEupd = await exportFAEupd();
    FAEupd.solveFAEupd = solveFAEupd;
  } else {
