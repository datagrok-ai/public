...
export namespace scripts {
  ...
  //file and blob
  export async function juliaFileBlobInputOutput(fileInput: DG.FileInfo , blobInput: any ): Promise<{fileOutput: DG.FileInfo, blobOutput: undefined}> {
  ...
  export async function juliaDate(input_datetime: any ): Promise<undefined> {
  ...
  export async function juliaGraphics(df: DG.DataFrame , xName: DG.Column , yName: DG.Column ): Promise<undefined> {
  ...
  //map input/output
  export async function juliaMap(input_map: any , unique_key: string ): Promise<undefined> {
  ...
  //file and blob
  export async function octaveFileBlobInputOutput(fileInput: DG.FileInfo , blobInput: any ): Promise<{fileOutput: DG.FileInfo, blobOutput: undefined}> {
  ...
  //datetime input/output
  export async function octaveDate(input_datetime: any ): Promise<undefined> {
  ...
  //graphics output column input
  export async function octaveGraphics(df: DG.DataFrame , xName: DG.Column , yName: DG.Column ): Promise<undefined> {
  ...
  //map input/output
  export async function octaveMap(input_map: any , unique_key: string ): Promise<undefined> {
  ...
  export async function pythonParamsTest(i: number , d: number , b: boolean , s: string , m: any , df: DG.DataFrame ): Promise<{ri: number, rd: number, rb: boolean, rs: string, rm: undefined, rdf: DG.DataFrame}> {
    return await grok.functions.call('CVMTests:PythonParamsTest', { i, d, b, s, m, df });
  }

  //file and blob
  export async function pythonFileBlobInputOutput(fileInput: DG.FileInfo , blobInput: any ): Promise<{fileOutput: DG.FileInfo, blobOutput: undefined}> {
  ...
  //df input/output
  export async function pythonDataframeGraphicsCached(df: DG.DataFrame ): Promise<{resultDf: DG.DataFrame, scatter: undefined}> {
  ...
  //datetime input/output
  export async function pythonDate(input_datetime: any ): Promise<undefined> {
  ...
  //graphics output column input
  export async function pythonGraphics(df: DG.DataFrame , xName: DG.Column , yName: DG.Column ): Promise<undefined> {
  ...
  //map input/output
  export async function pythonMap(input_map: any , unique_key: string ): Promise<undefined> {
  ...
  export async function rParamsTest(i: number , d: number , b: boolean , s: string , dt: any , df: DG.DataFrame ): Promise<{ri: number, rd: number, rb: boolean, rs: string, rdt: undefined, rdf: DG.DataFrame}> {
    return await grok.functions.call('CVMTests:RParamsTest', { i, d, b, s, dt, df });
  }

  //file and blob
  export async function rFileBlobInputOutput(fileInput: DG.FileInfo , blobInput: any ): Promise<{fileOutput: DG.FileInfo, blobOutput: undefined}> {
  ...
  //datetime input/output
  export async function rDate(input_datetime: any ): Promise<undefined> {
  ...
  //graphics output column input
  export async function rGraphics(df: DG.DataFrame , xName: DG.Column , yName: DG.Column ): Promise<undefined> {
