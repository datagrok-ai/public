...
t.onCurrentCellChanged.subscribe((_) => grok.balloon.info(`Cell: ${t.currentCell.rowIndex}, ${t.currentCell.column.name}`));
t.onCurrentColChanged.subscribe((_) => grok.balloon.info(`Column: ${t.currentCol.name}`));
t.onCurrentRowChanged.subscribe((_) => grok.balloon.info(`Row: ${t.currentRow.idx}`));
