...
category('ValueMatcher', () => {
  test('numerical pattern equals', async () => {
    let matcher = DG.ValueMatcher.numerical('5');
  ...
  test('numerical pattern less than', async () => {
    let matcher = DG.ValueMatcher.numerical('< 10');
    expect(matcher.operator, '<');
  ...
  test('numerical pattern range(inclusive)', async () => {
    let matcher = DG.ValueMatcher.numerical('10-20');
    expect(matcher.operator, '-');
  ...
  test('numerical pattern in', async () => {
    let matcher = DG.ValueMatcher.numerical('in(5,10)');
  ...
  test('numerical pattern not in', async () => {
    let matcher = DG.ValueMatcher.numerical('not in(5,10)');
  ...
  test('string pattern contains', async () => {
    let matcher = DG.ValueMatcher.string('contains foo');
  ...
  test('string pattern starts with', async () => {
    let matcher = DG.ValueMatcher.string('starts with Charles');
  ...
  test('string pattern ends with', async () => {
    let matcher = DG.ValueMatcher.string('ends with District');
  ...
  test('string pattern in', async () => {
    let matcher = DG.ValueMatcher.string('in (asian, other)');
    expect(matcher.operator, 'in');
  ...
  test('string pattern not in', async () => {
    let matcher = DG.ValueMatcher.string('not in (m, f)');
    expect(matcher.operator, 'not in');
