...
--test: ApiTests:expectTable(MySqlPatternsAll(), OpenFile('System:AppData/ApiTests/datasets/test/mysql/data1-30.d42'))
...
--connection: MySqlApiTests
--input: int id = 20
--test: ApiTests:expectTable(MySqlIntTypePatternNone(20), OpenFile('System:AppData/ApiTests/datasets/test/mysql/data20.d42'))
...
--test: ApiTests:expectTable(MySqlStringTypeIntPatternOpMore(), OpenFile('System:AppData/ApiTests/datasets/test/mysql/data29-30.d42'))
SELECT * FROM mock_data WHERE @id(id)
--end
