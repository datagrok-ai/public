...
test.describe("Forms viewer layout and project persistence", () => {
  ...
  test("Forms viewer layout and project persistence", {tag: ["@journey", "@viewers", "@realizes:viewers.forms"]}, async ({browser}) => {
    ...
    await session.step(12, "And user adds a forms viewer with:", () => addViewerWith(page, "forms", [["Show Mouse Over Row","false"]]), [["Show Mouse Over Row","false"]]);
    await session.step(14, "And user sets properties of forms viewer:", () => setProperties(page, el("forms viewer"), [["Fields","AGE, USUBJID, HEIGHT, SEX"],["Sort By","AGE"]]), [["Fields","AGE, USUBJID, HEIGHT, SEX"],["Sort By","AGE"]]);
