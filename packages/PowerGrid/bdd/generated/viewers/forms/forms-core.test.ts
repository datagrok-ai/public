...
test.describe("Forms viewer core — cards, sort and pinning", () => {
  ...
  test("Forms viewer core — cards, sort and pinning", {tag: ["@journey", "@viewers", "@realizes:viewers.forms"]}, async ({browser}) => {
    ...
    await session.step(15, "And user adds a forms viewer with:", () => addViewerWith(page, "forms", [["Show Mouse Over Row","false"]]), [["Show Mouse Over Row","false"]]);
    await session.step(17, "Then forms viewer should be visible", () => shouldBe(page, el("forms viewer"), "visible"));
    await session.step(18, "And properties of forms viewer should be:", () => propertiesShouldBe(page, el("forms viewer"), [["Show Selected Rows","true"],["Show Current Row","true"],["Use Grid Sort","true"],["Renderer Size","small"],["Number Format","Same as grid"],["Color Code","true"]]), [["Show Selected Rows","true"],["Show Current Row","true"],["Use Grid Sort","true"],["Renderer Size","small"],["Number Format","Same as grid"],["Color Code","true"]]);
