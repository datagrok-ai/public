...
- **L-BFGS-B** - limited-memory BFGS with **native box constraints**, Moré–Thuente strong-Wolfe line search, compact representation (Byrd–Nocedal–Schnabel 1994), and the Morales–Nocedal (2011) subspace refinement
