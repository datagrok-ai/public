...
export function webGPUVectorCosine(maxArraySize: number, _entryIndex: number) {
  return `
  var dist: f32 = 0.0;
...
export const distanceFunctionComplexity: { [key in WEBGPUDISTANCE]: (maxEntrySize: number) => number } = {//
  ...
  [WEBGPUDISTANCE.TANIMOTO]: (maxEntrySize: number) => Math.ceil(maxEntrySize / 30),
  [WEBGPUDISTANCE.SOKAL]: (maxEntrySize: number) => Math.ceil(maxEntrySize / 30),
  [WEBGPUDISTANCE.COSINE]: (maxEntrySize: number) => Math.ceil(maxEntrySize / 30),
  [WEBGPUDISTANCE.ASYMMETRIC]: (maxEntrySize: number) => Math.ceil(maxEntrySize / 30),
  ...
  [WEBGPUDISTANCE.VECTOR_COSINE]: (maxEntrySize: number) => Math.ceil(maxEntrySize / 30)
};
...
export const TypeSupportedDistances: {[key in WGPUENTRYTYPE] : Set<WEBGPUDISTANCE>} = {
  ...
  [WGPUENTRYTYPE.UINT32ARRAY]: new Set([WEBGPUDISTANCE.HAMMING, WEBGPUDISTANCE.EUCLIDEAN, WEBGPUDISTANCE.MANHATTAN, WEBGPUDISTANCE.MONOMER_CHEMICAL_DISTANCE, WEBGPUDISTANCE.LEVENSTEIN, WEBGPUDISTANCE.NEEDLEMAN_WUNSCH, WEBGPUDISTANCE.TANIMOTO, WEBGPUDISTANCE.COSINE, WEBGPUDISTANCE.VECTOR_COSINE, WEBGPUDISTANCE.SOKAL, WEBGPUDISTANCE.ASYMMETRIC, WEBGPUDISTANCE.OneHot, WEBGPUDISTANCE.Difference]),
  [WGPUENTRYTYPE.INT32ARRAY]: new Set([WEBGPUDISTANCE.EUCLIDEAN, WEBGPUDISTANCE.MANHATTAN, WEBGPUDISTANCE.OneHot, WEBGPUDISTANCE.Difference, WEBGPUDISTANCE.VECTOR_COSINE]),
  [WGPUENTRYTYPE.FLOAT32ARRAY]: new Set([WEBGPUDISTANCE.EUCLIDEAN, WEBGPUDISTANCE.MANHATTAN, WEBGPUDISTANCE.Difference, WEBGPUDISTANCE.VECTOR_COSINE]),
