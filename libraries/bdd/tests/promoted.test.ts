...
test('the editor, the console, the panes and the shell phrases of the round resolve', () => {
  assert.deepEqual(errorsOf([
    ...
    'And user opens the local file "fixtures/bdd-swagger.yaml"',
    'And user enters the DG_PG_PASSWORD secret into Password input',
    ...
    'And the "Activity" pane of the context panel should count 2',
