...
// so does a gallery's view-mode icon (d4-current, data_source_card_view.dart)
const SELECTED = '[aria-selected="true"], [aria-pressed="true"], [aria-checked="true"], [aria-current]:not([aria-current="false"]), ' +
  '.u2-list-row-selected, .tab-handle-selected, .dockspan-tab-handle-selected, .d4-current';
