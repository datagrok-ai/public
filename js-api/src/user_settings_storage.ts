...
export class UserSettingsStorage {
   ...
   * @param isPrivate - Value will be available only for current user. If false, shared storage is used. */
   ...
   * @param name - Storage name
   * @param {{[key: string]: string}} data
   * @param isPrivate - Data will be replaced in private or shared storage */
   ...
   * @param name - Storage name
   * @param isPrivate - Map will be retrieved from private or shared storage. */
   ...
   * @param name - Storage name
   * @param isPrivate - Value will be retrieved from private or shared storage. */
   ...
   * @param name - Storage name
   * @param isPrivate - Value will be deleted from private or shared storage. */
