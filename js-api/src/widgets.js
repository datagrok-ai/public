define(['require', 'exports', './wrappers', './events', './entities'], function (require, exports, wrappers_1, events_1, entities_1) {
  'use strict';
  Object.defineProperty(exports, '__esModule', { value: true });
  exports.ColumnComboBox = exports.HtmlTable = exports.RangeSlider = exports.TreeViewNode = exports.Color = exports.TagElement = exports.TagEditor = exports.TaskBarProgressIndicator = exports.ProgressIndicator = exports.InputBase = exports.Balloon = exports.Menu = exports.Dialog = exports.ToolboxPage = exports.TabPane = exports.TabControl = exports.AccordionPane = exports.Accordion = exports.DartWidget = exports.Filter = exports.Widget = exports.ObjectPropertyBag = void 0;
  let api = window;
  ...
  exports.ObjectPropertyBag = ObjectPropertyBag;
  ...
  class Widget {
    ...
    addProperty(propertyName, propertyType, defaultValue = null, options = null) {
      let obj = this;
      // @ts-ignore
      let p = entities_1.Property.create(propertyName, propertyType, () => obj[propertyName], null, defaultValue);
      p.set = function (_, x) {
        // @ts-ignore
        obj[propertyName] = x;
  ...
  class Accordion extends DartWidget {
    ...
    static create(key = null) {
      return wrappers_1.toJs(api.grok_Accordion(key));
    }
    /** @type {AccordionPane[]} */
    get panes() {
      return api.grok_TabControlBase_Get_Panes(this.d).map(wrappers_1.toJs);
    }
    /** Returns a pane with the specified name.
         * @param {string} name
         * @returns {AccordionPane} */
    getPane(name) {
      return wrappers_1.toJs(api.grok_TabControlBase_GetPane(this.d, name));
    }
    addPane(name, getContent, expanded = false, before = null) {
      return wrappers_1.toJs(api.grok_Accordion_AddPane(this.d, name, getContent, expanded, before !== null ? before.d : null));
    }
  }
  ...
  class TabControl {
    ...
    static create(vertical = false) {
      return wrappers_1.toJs(api.grok_TabControl(vertical));
    }
    get root() {
      return api.grok_Widget_Get_Root(this.d);
    }
    ...
    addPane(name, getContent, icon = null) {
      return wrappers_1.toJs(api.grok_TabControlBase_AddPane(this.d, name, getContent, icon));
    }
    clear() {
  ...
  class ToolboxPage {
    ...
    get accordion() {
      return wrappers_1.toJs(api.grok_ToolboxPage_Get_Accordion(this.d));
    }
  }
  ...
  class Dialog {
    ...
    /** @returns {Observable} */
    get onClose() {
      return events_1.__obs('d4-dialog-closed', this.d);
    }
    ...
    /** Adds content to the dialog.
         ...
         * @returns {Dialog} */
    add(content) {
      api.grok_Dialog_Add(this.d, wrappers_1.toDart(ui.extract(content)));
      return this;
    }
    /** Closes the dialog. */
    close() {
  ...
  class Menu {
    ...
    static create() {
      return wrappers_1.toJs(api.grok_Menu());
    }
    /** Creates a popup menu.
         * @returns {Menu} */
    static popup() {
      return wrappers_1.toJs(api.grok_Menu_Context());
    }
    /** Finds a child menu item with the specified text.
         * @param {string} text
         * @returns {Menu} */
    find(text) {
      return wrappers_1.toJs(api.grok_Menu_Find(this.d, text));
    }
    ...
    /** Adds a menu group with the specified text.
         ...
         * @returns {Menu} */
    group(text) {
      return wrappers_1.toJs(api.grok_Menu_Group(this.d, text));
    }
    /** Adds a menu group with the specified text and handler.
         ...
         * @returns {Menu} */
    item(text, onClick) {
      return wrappers_1.toJs(api.grok_Menu_Item(this.d, text, onClick));
    }
    /** For each item in items, adds a menu group with the specified text and handler.
         ...
         * @returns {Menu} */
    items(items, onClick) {
      return wrappers_1.toJs(api.grok_Menu_Items(this.d, items, onClick));
    }
    /** Adds a separator line.
         *  @returns {Menu} */
    separator() {
      return wrappers_1.toJs(api.grok_Menu_Separator(this.d));
    }
    /** Shows the menu.
         * @returns {Menu} */
    show() {
      return wrappers_1.toJs(api.grok_Menu_Show(this.d));
    }
  }
  exports.Menu = Menu;
  ...
  class InputBase {
    ...
    ;
    get value() {
      return wrappers_1.toJs(api.grok_InputBase_Get_Value(this.d));
    }
    ;
    set value(x) {
      wrappers_1.toDart(api.grok_InputBase_Set_Value(this.d, x));
    }
    ;
    get stringValue() {
    ...
    onChanged(callback) {
      return events_1._sub(api.grok_InputBase_OnChanged(this.d, callback));
    }
    /// Occurs when [value] is changed by user.
    onInput(callback) {
      return events_1._sub(api.grok_InputBase_OnInput(this.d, callback));
    }
    save() {
    ...
    static forProperty(property) {
      return wrappers_1.toJs(api.grok_InputBase_ForProperty(property.d));
    }
  }
  ...
  class ProgressIndicator {
    ...
    static create() {
      return wrappers_1.toJs(api.grok_ProgressIndicator_Create());
    }
    get percent() {
    ...
    get onProgressUpdated() {
      return events_1.observeStream(api.grok_Progress_Updated(this.d));
    }
    get onLogUpdated() {
      return events_1.observeStream(api.grok_Progress_Log_Updated(this.d));
    }
  }
  exports.ProgressIndicator = ProgressIndicator;
  class TaskBarProgressIndicator extends ProgressIndicator {
    static create(name) {
      return wrappers_1.toJs(api.grok_TaskBarProgressIndicator_Create(name));
    }
    close() {
      return api.grok_TaskBarProgressIndicator_Close(this.d);
    }
  }
  exports.TaskBarProgressIndicator = TaskBarProgressIndicator;
  class TagEditor {
    constructor(d) {
      this.d = d;
    }
    static create() {
      return wrappers_1.toJs(api.grok_TagEditor());
    }
    get root() {
    ...
    set acceptsDragDrop(predicate) {
      // @ts-ignore
      api.grok_TagEditor_Set_AcceptsDragDrop(this.d, (x) => predicate(wrappers_1.toJs(x, false)));
    }
    ;
    set doDrop(action) {
      // @ts-ignore
      api.grok_TagEditor_Set_DoDrop(this.d, (x) => action(wrappers_1.toJs(x, false)));
    }
    onChanged(callback) {
      return events_1._sub(api.grok_TagEditor_OnChanged(this.d, callback));
    }
  }
  ...
  class TreeViewNode {
    ...
    static tree() {
      return wrappers_1.toJs(api.grok_TreeViewNode_Tree());
    }
    /** Visual root.
         * @type {HTMLElement} */
    get root() {
    ...
    get items() {
      return api.grok_TreeViewNode_Items(this.d).map((i) => wrappers_1.toJs(i));
    }
    ...
    group(text, value = null, expanded = true) {
      return wrappers_1.toJs(api.grok_TreeViewNode_Group(this.d, text, value, expanded));
    }
    ...
    item(text, value = null) {
      return wrappers_1.toJs(api.grok_TreeViewNode_Item(this.d, text, value));
    }
  ...
  class RangeSlider extends DartWidget {
    static create() {
      return wrappers_1.toJs(api.grok_RangeSlider());
    }
    ...
    /** @returns {Observable} */
    get onValuesChanged() {
      return events_1.observeStream(api.grok_RangeSlider_Get_OnValuesChanged(this.d));
    }
  }
  exports.RangeSlider = RangeSlider;
  class HtmlTable extends DartWidget {
    ...
    static create(items, renderer, columnNames = null) {
      return wrappers_1.toJs(api.grok_HtmlTable(items, renderer !== null ? (object, ind) => renderer(wrappers_1.toJs(object), ind) : null, columnNames));
    }
    /** Removes item */
    remove(item) {
  ...
  class ColumnComboBox extends DartWidget {
    ...
    static create(dataframe, predicate) {
      return wrappers_1.toJs(api.grok_ColumnComboBox(dataframe.d, (x) => predicate(wrappers_1.toJs(x))));
    }
    /** @type {boolean} */
    get vertical() {
    ...
    /** @type {Property} */
    get property() {
      return wrappers_1.toJs(api.grok_ColumnComboBox_Get_Property(this.d));
    }
  }
  exports.ColumnComboBox = ColumnComboBox;
});
