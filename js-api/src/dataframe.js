...
define(['require', 'exports', 'rxjs', './const', './events', './wrappers', './const', './utils'], function (require, exports, rxjs, const_1, events_1, wrappers_1, const_2, utils_1) {
  'use strict';
  Object.defineProperty(exports, '__esModule', { value: true });
  exports.Qnum = exports.QNUM_GREATER = exports.QNUM_EXACT = exports.QNUM_LESS = exports.GroupByBuilder = exports.Stats = exports.BitSet = exports.Cell = exports.RowList = exports.ValueMatcher = exports.RowMatcher = exports.ColumnList = exports.Column = exports.Row = exports.DataFrame = void 0;
  ...
  const MapProxy = new Proxy(class {
    ...
    keys() {
      return utils_1._toIterable(api.grok_Map_Keys(this.d));
    }
    values() {
      return utils_1._toIterable(api.grok_Map_Values(this.d));
    }
    *[Symbol.iterator]() {
  ...
  class DataFrame {
    constructor(d) {
      this.d = d;
      this.columns = wrappers_1.toJs(api.grok_DataFrame_Columns(this.d));
    ...
    /** Returns a {@link Column} with the specified name.
         ...
         * @returns {Column} */
    col(name) {
      return wrappers_1.toJs(api.grok_DataFrame_ColumnByName(this.d, name));
    }
    ...
    clone(rowMask = null, columnIds = null, saveSelection = false) {
      return new DataFrame(api.grok_DataFrame_Clone(this.d, wrappers_1.toDart(rowMask), columnIds, saveSelection));
    }
    /** Current row
         * @type {Row} */
    get currentRow() {
    ...
    /** Current column
         * @type {Column} */
    get currentCol() {
      return wrappers_1.toJs(api.grok_DataFrame_Get_CurrentCol(this.d));
    }
    set currentCol(col) {
    ...
    changeColumnType(column, newType, format = null) {
      return wrappers_1.toJs(api.grok_DataFrame_ChangeColumnType(this.d, wrappers_1.toDart(column), newType, format));
    }
    /**
    ...
    getSortedOrder(sortByColumnIds, sortOrders = null, rowMask = null) {
      return api.grok_DataFrame_GetSortedOrder(this.d, sortByColumnIds.map(wrappers_1.toDart), sortOrders, wrappers_1.toDart(rowMask));
    }
    ...
    /** @returns {Observable} */ _event(event) {
      return events_1.__obs(event, this.d);
    }
    ...
    /** @returns {Observable} */ get onDataChanged() {
      return rxjs.concat(this.onValuesChanged, this.onColumnsAdded, this.onColumnsRemoved, this.onRowsAdded, this.onRowsRemoved);
    }
    ...
    /** Id of the dataframe.
         * @returns {string}*/
    get id() {
      return this.tags[const_1.TAGS.ID];
    }
    set id(id) {
      this.tags[const_1.TAGS.ID] = id;
    }
    ...
    constructor(table, idx) {
      ...
      return new Proxy(this, {
        set(target, name, value) {
          if (target.hasOwnProperty(name)) {
            Object.entries(target)[name] = value;
            return true;
          }
  ...
  class Column {
    ...
    static fromStrings(name, list) {
      return wrappers_1.toJs(api.grok_Column_FromStrings(name, list));
    }
    static fromType(type, name, length = 0) {
      return wrappers_1.toJs(api.grok_Column_FromType(type, name, length));
    }
    /** [array] will be not be copied and will be used as column's storage */
    static fromInt32Array(name, array, length = null) {
      return wrappers_1.toJs(api.grok_Column_FromInt32Array(name, array, length));
    }
    /** [array] will be not be copied and will be used as column's storage */
    static fromFloat32Array(name, array, length = null) {
      return wrappers_1.toJs(api.grok_Column_FromFloat32Array(name, array, length));
    }
    ...
    static fromList(type, name, list) {
      return wrappers_1.toJs(api.grok_Column_FromList(type, name, list));
    }
    ...
    static fromBitSet(name, bitset) {
      return wrappers_1.toJs(api.grok_Column_FromBitSet(name, bitset.d));
    }
    ...
    static int(name, length = 0) {
      return Column.fromType(const_1.TYPE.INT, name, length);
    }
    ...
    static float(name, length = 0) {
      return Column.fromType(const_1.TYPE.FLOAT, name, length);
    }
    ...
    static string(name, length = 0) {
      return Column.fromType(const_1.TYPE.STRING, name, length);
    }
    ...
    static bool(name, length = 0) {
      return Column.fromType(const_1.TYPE.BOOL, name, length);
    }
    ...
    static dateTime(name, length = 0) {
      return Column.fromType(const_1.TYPE.DATE_TIME, name, length);
    }
    ...
    static dataFrame(name, length = 0) {
      return Column.fromType(const_1.TYPE.DATA_FRAME, name, length);
    }
    ...
    static qnum(name, length = 0, values = [], exact = true) {
      let col = Column.fromType(const_1.TYPE.QNUM, name, length);
      if (values !== null) {
    ...
    /** Parent table
         * @type {DataFrame} */
    get dataFrame() {
      return wrappers_1.toJs(api.grok_Column_Get_DataFrame(this.d));
    }
    /** Semantic type
         * @type {string} */
    get semType() {
    ...
    /**
         ...
         */
    set(i, x, notify = true) {
      api.grok_Column_SetValue(this.d, i, wrappers_1.toDart(x), notify);
    }
    ...
    *values() {
    ...
    convertTo(newType, format = null) {
      return wrappers_1.toJs(api.grok_Column_ConvertTo(this.d, newType, format));
    }
    /** @returns {string} */
    toString() {
      return api.grok_Object_ToString(this.d);
  ...
  class ColumnList {
    ...
    /** Column with the corresponding name (case-insensitive).
         ...
         * @returns {Column} */
    byName(name) {
      return wrappers_1.toJs(api.grok_ColumnList_ByName(this.d, name));
    }
    ...
    /** Column by index.
         ...
         * @returns {Column} */
    byIndex(index) {
      return wrappers_1.toJs(api.grok_ColumnList_ByIndex(this.d, index));
    }
    /** First column of [semType], or null.
         * @returns {Column} */
    bySemType(semType) {
      let col = api.grok_ColumnList_BySemType(this.d, semType);
      return col == null ? null : wrappers_1.toJs(col);
    }
    ...
    byTags(tags) {
      return utils_1._toIterable(api.grok_ColumnList_ByTags(this.d, tags));
    }
    /** @returns {Iterable.<Column>} */
    get categorical() {
      return utils_1._toIterable(api.grok_ColumnList_Categorical(this.d));
    }
    /** @returns {Iterable.<Column>} */
    get numerical() {
      return utils_1._toIterable(api.grok_ColumnList_Numerical(this.d));
    }
    ...
    /** Adds an empty column of the specified type.
         ...
         * @returns {Column} */
    addNew(name, type) {
      return wrappers_1.toJs(api.grok_ColumnList_AddNew(this.d, name, type));
    }
    /** Adds calculated column.
         ...
         * @returns {Column} */
    addNewCalculated(name, expression, type, treatAsString) {
      return new Promise((resolve, reject) => wrappers_1.toJs(api.grok_ColumnList_AddNewCalculated(this.d, name, expression, type, treatAsString, (c) => resolve(c), (e) => reject(e))));
    }
    /** Adds a string column
         * @param {string} name
         * @returns {Column} */
    addNewString(name) { return this.addNew(name, const_1.TYPE.STRING); }
    /** Adds a new integer column
         * @param {string} name
         * @returns {Column} */
    addNewInt(name) { return this.addNew(name, const_1.TYPE.INT); }
    /** Adds a new float column
         * @param {string} name
         * @returns {Column} */
    addNewFloat(name) { return this.addNew(name, const_1.TYPE.FLOAT); }
    /** Adds a new qualified number column
         * @param {string} name
         * @returns {Column} */
    addNewQnum(name) { return this.addNew(name, const_1.TYPE.QNUM); }
    /** Adds a new datetime column
         * @param {string} name
         * @returns {Column} */
    addNewDateTime(name) { return this.addNew(name, const_1.TYPE.DATE_TIME); }
    /** Adds a new boolean column
         * @param {string} name
         * @returns {Column} */
    addNewBool(name) { return this.addNew(name, const_1.TYPE.BOOL); }
    /** Adds a virtual column.
         * @param {string} name
         * @param {Function} getValue - value constructor function that accepts int index and returns value
         * @param {String} type - column type
         * @returns {Column} */
    addNewVirtual(name, getValue, type = const_1.TYPE.OBJECT) {
      return wrappers_1.toJs(api.grok_ColumnList_AddNewVirtual(this.d, name, getValue, type));
    }
    ...
    /** Iterates over all columns.
         ...
         * */
    [Symbol.iterator]() {
      return utils_1._getIterator(this.d);
    }
    /** @returns {string} */
    toString() {
      return api.grok_Object_ToString(this.d);
  ...
  class RowMatcher {
    ...
    toDataFrame() { return wrappers_1.toJs(api.grok_RowMatcher_ToDataFrame(this.d)); }
  }
  exports.RowMatcher = RowMatcher;
  /**
     * Value matcher.
     * */
  class ValueMatcher {
    ...
    static numerical(pattern) { return new ValueMatcher(api.grok_ValueMatcher_Numerical(pattern)); }
    /** @returns {ValueMatcher} */
    static string(pattern) { return new ValueMatcher(api.grok_ValueMatcher_String(pattern)); }
    /** @returns {ValueMatcher} */
    static dateTime(pattern) { return new ValueMatcher(api.grok_ValueMatcher_DateTime(pattern)); }
    /** @returns {ValueMatcher} */
    static bool(pattern) { return new ValueMatcher(api.grok_ValueMatcher_BoolMatcher(pattern)); }
    get pattern() { return api.grok_ValueMatcher_Get_Pattern(this.d); }
    get operator() { return api.grok_ValueMatcher_Get_Operator(this.d); }
    match(value) { return api.grok_ValueMatcher_Match(this.d, value); }
    validate(value) { return api.grok_ValueMatcher_Validate(this.d, value); }
  }
  ...
  class RowList {
    ...
    *[Symbol.iterator]() {
    ...
    /**
         ...
         * */
    match(query) {
      return wrappers_1.toJs(api.grok_RowList_Match(this.d, query));
    }
    /**
         * @param {BitSet} bitset
  ...
  class Cell {
    ...
    /** Corresponding column.
         * @returns {Column} */
    get column() {
      return wrappers_1.toJs(api.grok_Cell_Get_Column(this.d));
    }
    /** Cell value.
         * @returns {*} */
    get value() {
  ...
  class BitSet {
    ...
    get onChanged() {
      return events_1.observeStream(api.grok_BitSet_Changed(this.d));
    }
    /** Finds the value of similarity between two BitSets.
         ...
         * @returns {number} */
    similarityTo(b, metric = const_2.SIMILARITY_METRIC.TANIMOTO) {
  ...
  class Stats {
    ...
    static fromColumn(col, mask = null) {
      return new Stats(api.grok_Stats_FromColumn(col.d, wrappers_1.toDart(mask)));
    }
    ...
    /** Pearson correlation
         ...
         * @returns {number} */
    corr(otherColumn) { return api.grok_Stats_Corr(this.d, otherColumn.d); }
    /** Spearman correlation
         * @param {Column} otherColumn
         * @returns {number} */
    spearmanCorr(otherColumn) { return api.grok_Stats_SpearmanCorr(this.d, otherColumn.d); }
    /** @returns {string} */
    toString() {
      return api.grok_Object_ToString(this.d);
    }
  ...
  class GroupByBuilder {
    ...
    key(srcColName, resultColName = null) {
      return this.add(const_1.AGG.KEY, srcColName, resultColName);
    }
    ...
    pivot(srcColName, resultColName = null) {
      return this.add(const_1.AGG.PIVOT, srcColName, resultColName);
    }
    ...
    count(resultColName = 'count') {
      return this.add(const_1.AGG.TOTAL_COUNT, null, resultColName);
    }
    ...
    uniqueCount(srcColName, resultColName = null) {
      return this.add(const_1.AGG.UNIQUE_COUNT, srcColName, resultColName);
    }
    ...
    missingValueCount(srcColName, resultColName = null) {
      return this.add(const_1.AGG.MISSING_VALUE_COUNT, srcColName, resultColName);
    }
    /** Adds an aggregation that counts rows, including these will null values.
         * See also {@link count}, {@link valueCount}, {@link uniqueCount}, {@link missingValueCount}
         * Call {@link aggregate} when the query is constructed.
    ...
    valueCount(srcColName, resultColName = null) {
      return this.add(const_1.AGG.VALUE_COUNT, srcColName, resultColName);
    }
    ...
    min(srcColName, resultColName = null) {
      return this.add(const_1.AGG.MIN, srcColName, resultColName);
    }
    ...
    max(srcColName, resultColName = null) {
      return this.add(const_1.AGG.MAX, srcColName, resultColName);
    }
    ...
    sum(srcColName, resultColName = null) {
      return this.add(const_1.AGG.SUM, srcColName, resultColName);
    }
    ...
    med(srcColName, resultColName = null) {
      return this.add(const_1.AGG.MED, srcColName, resultColName);
    }
    ...
    avg(srcColName, resultColName = null) {
      return this.add(const_1.AGG.AVG, srcColName, resultColName);
    }
    ...
    stdev(srcColName, resultColName = null) {
      return this.add(const_1.AGG.STDEV, srcColName, resultColName);
    }
    ...
    variance(srcColName, resultColName = null) {
      return this.add(const_1.AGG.VARIANCE, srcColName, resultColName);
    }
    ...
    q1(srcColName, resultColName = null) {
      return this.add(const_1.AGG.Q1, srcColName, resultColName);
    }
    ...
    q2(srcColName, resultColName = null) {
      return this.add(const_1.AGG.Q2, srcColName, resultColName);
    }
    ...
    q3(srcColName, resultColName = null) {
      return this.add(const_1.AGG.Q3, srcColName, resultColName);
    }
    ...
    first(srcColName, resultColName = null) {
      return this.add(const_1.AGG.FIRST, srcColName, resultColName);
    }
  ...
  exports.QNUM_LESS = 1;
  exports.QNUM_EXACT = 2;
  exports.QNUM_GREATER = 3;
  ...
  class Qnum {
    ...
    /**
         ...
         * @returns {number}
         * */
    static create(value, q = exports.QNUM_EXACT) {
    ...
    static exact(x) {
      return Qnum.create(x, exports.QNUM_EXACT);
    }
    ;
    static less(x) {
      return Qnum.create(x, exports.QNUM_LESS);
    }
    ;
    static greater(x) {
      return Qnum.create(x, exports.QNUM_GREATER);
    }
    /**
