...
import { AGG, TYPE, TAGS } from './const';
...
export class ColumnList {
  ...
  addNewCalculated(name, expression, type, treatAsString) {
    return new Promise((resolve, reject) => toJs(api.grok_ColumnList_AddNewCalculated(this.d, name, expression, type, treatAsString, (c) => resolve(c), (e) => reject(e))));
  }
