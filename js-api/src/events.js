...
define(['require', 'exports', 'rxjs', 'rxjs/operators', './wrappers'], function (require, exports, rxjs, rxjsOperators, wrappers_1) {
  'use strict';
  Object.defineProperty(exports, '__esModule', { value: true });
  exports._sub = exports.EventBus = exports.EventData = exports.StreamSubscription = exports.Events = exports.observeStream = exports.__obs = exports.debounce = void 0;
  rxjs = __importStar(rxjs);
  rxjsOperators = __importStar(rxjsOperators);
  let api = window;
  function debounce(observable, milliseconds = 100) {
  ...
  /**
     ...
     * */
  function observeStream(dartStream) {
    let observable = rxjs.fromEventPattern(function (handler) {
    ...
    get args() {
      ...
      for (const property in x)
        if (x.hasOwnProperty(property))
          result[property] = wrappers_1.toJs(x[property]);
      return result;
    }
  }
