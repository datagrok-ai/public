define(['require', 'exports', './dataframe', './wrappers', './functions'], function (require, exports, dataframe_1, wrappers_1, functions_1) {
  'use strict';
  Object.defineProperty(exports, '__esModule', { value: true });
  exports.Detector = exports.Data = exports.DemoDatasets = exports.Files = void 0;
  let api = window;
  ...
  class Files {
    ...
    openTable(path) {
      return new Promise((resolve, reject) => api.grok_Files_OpenTable(path, (t) => resolve(wrappers_1.toJs(t)), (e) => reject(e)));
    }
    /** Reads all tables from file
         * @param {string} path
         * @returns {Promise<Array<DataFrame>>}*/
    openTables(path) {
      return new Promise((resolve, reject) => api.grok_Files_OpenTables(path, (t) => resolve(t.map(wrappers_1.toJs)), (e) => reject(e)));
    }
  }
  exports.Files = Files;
  ...
  class DemoDatasets {
    ...
    getDemoTable(dataset, rows = 10000, columns = 3) {
      return new dataframe_1.DataFrame(api.grok_TestData(dataset, rows, columns));
    }
    ...
    /** Returns a demo dataset with the specified path (relative to the demo root)
         ...
         * @returns {Promise<DataFrame>}*/
    loadDemoTable(path) {
      return new Promise((resolve, reject) => api.grok_GetDemoTable(path, (t) => resolve(wrappers_1.toJs(t)), (e) => reject(e)));
    }
  }
  exports.DemoDatasets = DemoDatasets;
  ...
  class Data {
    ...
    parseCsv(csv, options) {
      return new dataframe_1.DataFrame(api.grok_ParseCsv(csv, options));
    }
    /**
         ...
         * */
    loadTable(csvUrl) {
      return new Promise((resolve, reject) => api.grok_LoadDataFrame(csvUrl, (t) => resolve(wrappers_1.toJs(t, false)), (e) => reject(e)));
    }
    /**
         * @param {DataFrame} t1
         * @param {DataFrame} t2
    ...
    joinTables(t1, t2, keyColumns1, keyColumns2, valueColumns1, valueColumns2, joinType, inPlace) {
      return new dataframe_1.DataFrame(api.grok_JoinTables(t1.d, t2.d, keyColumns1, keyColumns2, valueColumns1, valueColumns2, joinType, inPlace));
    }
    /**
         ...
         */
    openTable(id) {
      return new Promise((resolve, reject) => api.grok_OpenTable(id, (t) => resolve(new dataframe_1.DataFrame(t)), (e) => reject(e)));
    }
    query(queryName, queryParameters = null, adHoc = false, pollingInterval = 1000) {
      return new Promise((resolve, reject) => api.grok_Query(queryName, queryParameters, adHoc, pollingInterval, (t) => resolve(wrappers_1.toJs(t)), (e) => reject(e)));
    }
    callQuery(queryName, queryParameters = null, adHoc = false, pollingInterval = 1000) {
      return new Promise((resolve, reject) => api.grok_CallQuery(queryName, queryParameters, adHoc, pollingInterval, (c) => resolve(new functions_1.FuncCall(c)), (e) => reject(e)));
    }
