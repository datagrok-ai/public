...
export class Files {
  ...
  openTable(path) {
    return new Promise((resolve, reject) => grok_Files_OpenTable(path, (t) => resolve(toJs(t)), (e) => reject(e)));
  }
  ...
  openTables(path) {
    return new Promise((resolve, reject) => grok_Files_OpenTables(path, (t) => resolve(t.map(toJs)), (e) => reject(e)));
  }
...
export class Data {
  ...
  parseCsv(csv, options) {
    return new DataFrame(grok_ParseCsv(csv, options));
  }
  ...
  linkTables(t1, t2, keyColumns1, keyColumns2, linkTypes) {
    grok_LinkTables(t1.d, t2.d, keyColumns1, keyColumns2, linkTypes);
  };
   ...
   */
  openTable(id) {
    return new Promise((resolve, reject) => grok_OpenTable(id, (t) => resolve(new DataFrame(t)), (e) => reject(e)));
  }
