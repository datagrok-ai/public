define(['require', 'exports', './dataframe', './viewer', './wrappers', './events', './utils'], function (require, exports, dataframe_1, viewer_1, wrappers_1, events_1, utils_1) {
  'use strict';
  Object.defineProperty(exports, '__esModule', { value: true });
  exports.GridCellRenderer = exports.CanvasRenderer = exports.GridCellRenderArgs = exports.GridCellStyle = exports.Grid = exports.GridColumnList = exports.GridColumn = exports.GridCell = exports.Rect = exports.Point = void 0;
  let api = window;
  ...
  class GridCell {
    ...
    get cell() {
      return new dataframe_1.Cell(api.grok_GridCell_Get_Cell(this.d));
    }
  ...
  class GridColumn {
    ...
    get column() {
      ...
      return col === null ? null : new dataframe_1.Column(col);
    }
    /** Index of the column.
         *  @returns {number} */
    get idx() {
  ...
  exports.GridColumnList = GridColumnList;
  /** High-performance, flexible spreadsheet control */
  class Grid extends viewer_1.Viewer {
    constructor(d) {
      super(d);
    }
    /** Grid columns.
    ...
    get onCellRender() {
      return events_1.__obs('d4-grid-cell-render', this.d);
    }
    ...
    onCellPrepare(callback) {
      return events_1._sub(api.grok_Grid_OnCellPrepare(this.d, (dcell) => {
        return callback(new GridCell(dcell));
      }));
    }
    onCellTooltip(callback) {
      return events_1._sub(api.grok_Grid_OnCellTooltip(this.d, (dcell, x, y) => {
    ...
    sort(columns, orders = null) {
      // @ts-ignore
      api.grok_Grid_Sort(this.d, columns.map((c) => c instanceof dataframe_1.Column ? c.d : c), orders);
      return this;
    }
    sortIndexes(indexComparer) {
      let indexes = utils_1._identityInt32(this.table.rowCount);
    ...
    scrollToCell(column, row) {
      api.grok_Grid_ScrollToCell(this.d, wrappers_1.toDart(column), row);
    }
    scrollToPixels(x, y) {
    ...
    /** @returns {RangeSlider} */
    get vertScroll() {
      return wrappers_1.toJs(api.grok_Grid_Get_VertScroll(this.d));
    }
    /** @returns {RangeSlider} */
    get horzScroll() {
      return wrappers_1.toJs(api.grok_Grid_Get_HorzScroll(this.d));
    }
  ...
  class GridCellRenderArgs extends events_1.EventData {
    constructor(d) {
      super(d);
    }
  ...
  exports.GridCellRenderArgs = GridCellRenderArgs;
  ...
  class GridCellRenderer extends CanvasRenderer {
    get name() {
      throw 'Not implemented';
    }
    get cellType() {
