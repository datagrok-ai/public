define(['require', 'exports', './wrappers', './utils'], function (require, exports, wrappers_1, utils_1) {
  'use strict';
  Object.defineProperty(exports, '__esModule', { value: true });
  exports.DockManager = exports.DockContainer = exports.DockNode = void 0;
  let api = window;
  /**
     * Dock node.
  ...
  class DockNode {
    ...
    /** @returns {DockNode} */
    get parent() {
      return wrappers_1.toJs(api.grok_DockNode_Parent(this.d));
    }
    /** @returns {Iterable.<DockNode>} */
    get children() {
      return utils_1._toIterable(api.grok_DockNode_Children(this.d));
    }
  }
  exports.DockNode = DockNode;
  /**
  ...
  class DockManager {
    ...
    get rootNode() {
      return wrappers_1.toJs(api.grok_DockManager_Get_RootNode(this.d));
    }
    /**
    ...
    /**
         ...
         * */
    findNode(element) {
      return wrappers_1.toJs(api.grok_DockManager_FindNode(this.d, element));
    }
  }
