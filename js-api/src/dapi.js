import { Credentials, DataConnection, DataJob, DataQuery, Entity, Group, Model, Project, Script, ScriptEnvironment, TableInfo, User, LogEvent, LogEventType, Package } from './entities';
...
export class Dapi {
  ...
  get entities() {
    return new EntitiesDataSource(api.grok_Dapi_Entities(), (a) => new Entity(a));
  }
  /** Data Queries API endpoint
     *  @type {HttpDataSource<DataQuery>} */
  get queries() {
    return new HttpDataSource(api.grok_Dapi_Queries(), (a) => new DataQuery(a));
  }
  /** Data Connections API endpoint
     *  @type {HttpDataSource<DataConnection>} */
  get connections() {
    return new HttpDataSource(api.grok_Dapi_Connections(), (a) => new DataConnection(a));
  }
  /** Credentials API endpoint
     *  @type {CredentialsDataSource} */
  get credentials() {
    return new CredentialsDataSource(api.grok_Dapi_Credentials(), (a) => new Credentials(a));
  }
  /** Data Jobs API endpoint
     *  @type {HttpDataSource<DataJob>} */
  get jobs() {
    return new HttpDataSource(api.grok_Dapi_Jobs(), (a) => new DataJob(a));
  }
  /** Jupyter Notebooks API endpoint
     *  @type {HttpDataSource<Notebook>} */
  get notebooks() {
    return new HttpDataSource(api.grok_Dapi_Notebooks(), (a) => toJs(a));
  }
  /** Predictive Models API endpoint
     *  @type {HttpDataSource<Model>} */
  get models() {
    return new HttpDataSource(api.grok_Dapi_Models(), (a) => new Model(a));
  }
  /** Packages API endpoint
     *  @type {HttpDataSource<Package>} */
  get packages() {
    return new HttpDataSource(api.grok_Dapi_Packages(), (a) => new Package(a));
  }
  /** View Layouts API endpoint
     *  @type {LayoutsDataSource} */
  get layouts() {
    return new LayoutsDataSource(api.grok_Dapi_Layouts(), (a) => new ViewLayout(a));
  }
  /** Data Table Infos API endpoint
     *  @type {TablesDataSource} */
  get tables() {
    return new TablesDataSource(api.grok_Dapi_Tables(), (a) => new TableInfo(a));
  }
  /** Users API endpoint
     *  @type {UsersDataSource} */
  get users() {
    return new UsersDataSource(api.grok_Dapi_Users(), (a) => new User(a));
  }
  /** Groups API endpoint
     *  @type {GroupsDataSource} */
  get groups() {
    return new GroupsDataSource(api.grok_Dapi_Groups(), (a) => toJs(a));
  }
  ...
  get scripts() {
    return new HttpDataSource(api.grok_Dapi_Scripts(), (a) => new Script(a));
  }
  /** Projects API endpoint
     *  @type {HttpDataSource<Project>} */
  get projects() {
    return new HttpDataSource(api.grok_Dapi_Projects(), (a) => new Project(a));
  }
  /** Environments API endpoint
     *  @type {HttpDataSource<ScriptEnvironment>} */
  get environments() {
    return new HttpDataSource(api.grok_Dapi_Environments(), (a) => new ScriptEnvironment(a));
  }
  ...
  get log() {
    return new HttpDataSource(api.grok_Dapi_Log(), (a) => new LogEvent(a));
  }
  /** Logging API endpoint
     *  @type {HttpDataSource<LogEventType>} */
  get logTypes() {
    return new HttpDataSource(api.grok_Dapi_LogTypes(), (a) => new LogEventType(a));
  }
}
/**
...
export class UsersDataSource extends HttpDataSource {
  ...
  currentSession() {
    return new Promise((resolve, reject) => api.grok_UsersDataSource_CurrentSession(this.s, (q) => resolve(toJs(q)), (e) => reject(e)));
  }
}
export class AdminDataSource {
  ...
  /** Returns information about the services
     *  @returns {Promise<Map>} */
  getServiceInfos() {
    return new Promise((resolve, reject) => api.grok_Dapi_Admin_GetServiceInfos(this.s, (q) => resolve(toJs(q)), (e) => reject(e)));
  }
}
/**
...
export class GroupsDataSource extends HttpDataSource {
  ...
  /** Returns group user
     ...
     *  @returns {Promise<Group>} - Group. */
  getUser(group) {
    return new Promise((resolve, reject) => api.grok_Dapi_Get_GroupUser(group.d, (q) => resolve(toJs(q)), (e) => reject(e)));
  }
...
export class TablesDataSource extends HttpDataSource {
  ...
  getTable(id) {
    return new Promise((resolve, reject) => api.grok_Dapi_TablesDataSource_GetTable(id, (df) => resolve(toJs(df)), (e) => reject(e)));
  }
}
export class Files {
  constructor() {
