...
define(['require', 'exports', './widgets', './wrappers'], function (require, exports, widgets_1, wrappers_1) {
  'use strict';
  Object.defineProperty(exports, '__esModule', { value: true });
  exports._options = exports.LruCache = exports._identityInt32 = exports.timeAsync = exports.time = exports.identity = exports.range = exports._toJson = exports._jsThen = exports._isDartium = exports._getIterator = exports._toIterable = exports.Utils = void 0;
  let api = window;
  class Utils {
  ...
  exports._toIterable = _toIterable;
  function _getIterator(d) {
    let iterator = api.grok_Iterable_Get_Iterator(d);
    return {
      next: function () {
        return api.grok_Iterator_MoveNext(iterator) ?
          { value: wrappers_1.toJs(api.grok_Iterator_Current(iterator)), done: false } :
          { done: true };
      }
    };
  }
  ...
  exports._isDartium = _isDartium;
  function _jsThen(promise, f) {
    promise.then(f);
  }
  exports._jsThen = _jsThen;
  function _toJson(x) {
  ...
  function time(name, f) {
    ...
    // @ts-ignore
    new widgets_1.Balloon().info(`${name}: ${stop - start} ms`);
    return result;
  }
  exports.time = time;
  ...
  function _identityInt32(length) {
    let values = new Int32Array(length);
    for (let i = 0; i < length; i++)
      values[i] = i;
    return values;
  }
  exports._identityInt32 = _identityInt32;
  /**
