define(['require', 'exports', './dataframe', './view', './entities', './wrappers', './widgets', './docking', './const'], function (require, exports, dataframe_1, view_1, entities_1, wrappers_1, widgets_1, docking_1, const_1) {
  'use strict';
  Object.defineProperty(exports, '__esModule', { value: true });
  exports.Settings = exports.Windows = exports.Shell = void 0;
  let api = window;
  /**
  ...
  class Shell {
    ...
    /** Current table, or null.
         *  @type {DataFrame} */
    get t() {
      return new dataframe_1.DataFrame(api.grok_CurrentTable());
    }
    /** Current view
         *  @type {View} */
    get v() {
      return view_1.View.fromDart(api.grok_Get_CurrentView());
    }
    set v(view) {
      // @ts-ignore
    ...
    /** Current project
         *  @type {Project} */
    get project() {
      return new entities_1.Project(api.grok_Project());
    }
    ...
    /** Current user
         *  @type {User} */
    get user() {
      return wrappers_1.toJs(api.grok_User());
    }
    /** Current object (rendered in the property panel) */
    get o() {
      return wrappers_1.toJs(api.grok_Get_CurrentObject(), false);
    }
    set o(x) {
      api.grok_Set_CurrentObject(wrappers_1.toDart(x));
    }
    /** @type {TabControl} */
    get sidebar() {
      return new widgets_1.TabControl(api.grok_Get_Sidebar());
    }
    /** @type {Menu} */
    get topMenu() {
      return new widgets_1.Menu(api.grok_Get_TopMenu());
    }
    /** @type {HTMLDivElement} */
    get topPanel() {
    ...
    dockElement(element, title = null, dockStyle = const_1.DOCK_TYPE.FILL, ratio = 0.5) {
    ...
    /** Opens the view that handles the specified url.
         ...
         * @returns {View} */
    route(url) {
      return view_1.View.fromDart(api.grok_Route(url));
    }
    ...
    add(item) {
      ...
      else if (item instanceof view_1.View)
        this.addView(item);
    ...
    /**
         ...
         * @returns {View}
         */
    addView(v, dockType = const_1.DOCK_TYPE.FILL, width = null) {
    ...
    newView(name = 'view', children, options) {
      if (children == null)
        children = [];
      let view = view_1.View.create(options);
      view.name = name;
    ...
    /** Adds a view for the specified table.
         ...
         * @param {number} width
         * @returns {TableView} */
    addTableView(table, dockType = const_1.DOCK_TYPE.FILL, width = null) {
      return wrappers_1.toJs(api.grok_AddTableView(table.d, dockType, width));
    }
    /**
    ...
    getTableView(tableName) {
      return new view_1.TableView(api.grok_GetTableView(tableName));
    }
    ...
    tableByName(tableName) {
      return wrappers_1.toJs(api.grok_TableByName(tableName));
    }
    /** Returns the value of the specified variable. Search is case-insensitive.
         * @param {string} variableName
         * @returns {Object} */
    getVar(variableName) {
      return wrappers_1.toJs(api.grok_GetVar(variableName));
    }
    ...
    setVar(variableName, variableValue) {
      api.grok_SetVar(variableName, wrappers_1.toDart(variableValue));
      return variableValue;
    }
    /** @returns {DockManager} */
    get dockManager() {
      // @ts-ignore
      return new docking_1.DockManager(api.grok_Get_DockManager());
    }
    ...
    constructor() {
      return new Proxy({}, {
        get: function (target, prop) {
          return wrappers_1.toJs(api.grok_PropMixin_GetPropertyValue(api.grok_Get_Settings(), prop));
        },
        set: function (target, prop, value) {
          ...
          api.grok_PropMixin_SetPropertyValue(api.grok_Get_Settings(), prop, wrappers_1.toDart(value));
          return true;
        }
      });
    }
